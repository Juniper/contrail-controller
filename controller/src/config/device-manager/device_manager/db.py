...
class VirtualMachineInterfaceDM(DBBaseDM):
    ...
    def update(self, obj=None):
        ...
        if self.port_tuple:
            ...
            if not pt:
                pt_obj = PortTupleDM.read_obj(self.port_tuple)
                pt = PortTupleDM.locate(self.port_tuple,pt_obj)
            self.service_instance = pt.service_instance
    # end update
...
class PortTupleDM(DBBaseDM):
    ...
    def update(self, obj=None):
        ...
        self.service_instance = obj['parent_uuid']
        self.update_multiple_refs('virtual_machine_interface', obj)
    # end update
