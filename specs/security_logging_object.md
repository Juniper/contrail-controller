...
* Incorporation of security framework tag-attributes : Deployment, App, Tier and
  ...
  tags.
* SessionEndPoint message will be introdcued instead of existing Flow message.
...
## 3.4 UI changes
Following level of configuration will be requried from UI
...
# 9. Testing
## 9.1 Unit tests
Follwoing test cases need to be verified
* Construction of session end points and its components for different level of 
  attachments
* Association of sessions to client or server based on the packet flows
* Pre-aggrgation of sessions at client/server level. 
## 9.2 Dev tests
## 9.3 System tests
