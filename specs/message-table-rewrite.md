...
Summary of MessageTable schema changes below
- indexed on T2 and partition
- clustering columns T1 and UUID
- SASI index on Source, Messagetype, Module and ObjectTypeName[1..6].
- Rest of the columns are IpAddress, Pid, Category, Level, NodeType, InstanceId, SequenceNum, SandeshType
Details on implementation listed in proposed solution section.
