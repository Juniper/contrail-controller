...
CREATE CUSTOM INDEX column3_index ON "ContrailAnalyticsCql".messagetablev2 ("column3") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column4_index ON "ContrailAnalyticsCql".messagetablev2 ("column4") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column5_index ON "ContrailAnalyticsCql".messagetablev2 ("column5") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column6_index ON "ContrailAnalyticsCql".messagetablev2 ("column6") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column7_index ON "ContrailAnalyticsCql".messagetablev2 ("column7") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column8_index ON "ContrailAnalyticsCql".messagetablev2 ("column8") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column9_index ON "ContrailAnalyticsCql".messagetablev2 ("column9") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column10_index ON "ContrailAnalyticsCql".messagetablev2 ("column10") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
CREATE CUSTOM INDEX column11_index ON "ContrailAnalyticsCql".messagetablev2 ("column11") USING 'org.apache.cassandra.index.sasi.SASIIndex' WITH OPTIONS = {'mode': 'PREFIX'};
```
...
Conclusion: We shall support option (b). There will be separate script to migrate data from old format to new format.
...
contrail-logs --last 100s --verbose --source sangupta-u1404d  --module contrail-collector --message-type SandeshModuleClientTrace
contrail-logs --last 100s --verbose --object-type generator --object-values
contrail-logs --last 100s --verbose --object-type generator --object-id='sangupta-u1404d:Analytics:contrail-collector:0'
contrail-logs --last 100s --verbose --object-type generator --object-id='sangupta-u1404d:Analytics:*'
contrail-logs --last 100s --verbose --object-type generator
contrail-logs --last 100s --verbose --source sangupta-u1404d --object-type generator --object-id='sangupta-u1404d:Analytics:contrail-collector:0'
contrail-logs --last 100s --verbose --source sangupta-u1404d --object-type generator --object-id='sangupta-u1404d:Analytics:*'
