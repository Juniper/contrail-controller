...
# NOTE: all names are addressed by concatenating:
# net.juniper.contrail.pod + '-' + net.juniper.contrail.service
unit_names_dict = {
    'contrail-analytics': [
        'analytics-collector',
        'analytics-api',
        ...
        'analytics-alarm-gen',
        'analytics-topology',
        'analytics-nodemgr'  # net.juniper.contrail
    ],
    'contrail-config': [
        'config-api',
        'config-schema',
        ...
        'config-nodemgr'  # net.juniper.contrail
    ],
    'contrail-control': [
        'control-control',
        'control-dns',
        'control-named',
        'control-nodemgr'  # net.juniper.contrail
    ],
    'contrail-vrouter': [
        'vrouter-agent',
        'vrouter-nodemgr'  # net.juniper.contrail
    ],
    'contrail-database': [
        'analytics-database-cassandra',
        'analytics-database-zookeeper',
        'analytics-database-kafka',
        'database-nodemgr'  # net.juniper.contrail
    ]
}
