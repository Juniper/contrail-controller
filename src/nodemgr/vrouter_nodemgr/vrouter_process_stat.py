            ...
            for file in files:
                if file.endswith(".ini"):
                    ...
                    try:
                        ...
                        self.logger.log(SandeshLogger.get_py_logger_level(SandeshLevel.SYS_ERR), msg + filename)
                        continue
                    ...
                    if name[1] == proc_name:
                        ...
                        if (args[0] == '/usr/bin/contrail-tor-agent'):
                            try:
                                ...
                                self.logger.log(SandeshLogger.get_py_logger_level(SandeshLevel.SYS_ERR), msg + command)
    ...
    def get_vrouter_tor_agent_name(self, conf_file):
        ...
        if conf_file:
            try:
                ...
                self.logger.log(SandeshLogger.get_py_logger_level(SandeshLevel.SYS_ERR), "Error reading file : " + conf_file + " Error : " + str(err))
