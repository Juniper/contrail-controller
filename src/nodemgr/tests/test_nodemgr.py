...
class NodemgrTest(unittest.TestCase):
    ...
    def test_nodemgr(
            self, mock_get_core_files, mock_get_all_process, mock_docker_process_info_mgr,
            mock_is_running_in_kubepod, mock_get_conn_state_cb, mock_send_process_state_db,
            mock_open, mock_remove, mock_glob, mock_tm_time):
        headers = {}
        headers['expected'] = '0'
        headers['pid'] = '123'
        config_obj = Config()
