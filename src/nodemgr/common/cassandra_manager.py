...
class CassandraManager(object):
    ...
    def exec_cmd(self, cmd):
        # unit name is generated as stated in main.py
        unit_name = self._db_owner + '-database-cassandra'
    ...
    def database_periodic(self, event_mgr):
        try:
            ...
            for cassandra_data_dir in cassandra_data_dirs:
                ...
                cdir = None
                if self._db_owner == 'analytics' and os.path.exists(analytics_dir):
                    cdir = analytics_dir
                elif self._db_owner == 'config' and os.path.exists(cassandra_data_dir):
