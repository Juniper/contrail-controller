...
from nodemgr.common.sandesh.process_info.constants import ProcessStateNames
from nodemgr.common.sandesh.process_info.ttypes import (ProcessInfo, ProcessState,
                                                                 ProcessStatus)
