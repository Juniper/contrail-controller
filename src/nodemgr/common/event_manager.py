...
class EventManager(object):
    ...
    def send_process_state_db_base(self, group_names, ProcessInfo):
        ...
        for group in group_names:
            ...
            self.installed_package_version = NodeMgrUtils.get_package_version(self.get_package_name())
            node_status.installed_package_version = self.installed_package_version
            node_status.running_package_version = self.installed_package_version
    ...
    def event_tick_60(self):
        ...
        installed_package_version = NodeMgrUtils.get_package_version(self.get_package_name())
