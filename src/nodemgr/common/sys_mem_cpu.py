...
class SysMemCpuUsageData(object):
    ...
    def get_num_socket(self):
        return _run_cmd('lscpu | grep "Socket(s):" | awk \'{print $2}\'')

    def get_num_cpu(self):
        return _run_cmd('lscpu | grep "^CPU(s):" | awk \'{print $2}\'')

    def get_num_core_per_socket(self):
        return _run_cmd('lscpu | grep "Core(s) per socket:" | awk \'{print $4}\'')

    def get_num_thread_per_core (self):
        return _run_cmd('lscpu | grep "Thread(s) per core:" | awk \'{print $4}\'')
