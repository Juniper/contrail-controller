...
public:
    ...
    static vr_bridge_entry* BridgeMmapAlloc(int size);
    static void BridgeMmapFree();
    static vr_bridge_entry* GetBridgeEntry(int idx);
    static void SetBridgeEntry(vr_route_req *req, bool set);
...
private:
    ...
    static vr_bridge_entry *bridge_table_;
