...
HttpClient::HttpClient(EventManager *evm, std::string s) : 
  TcpServer(evm) , 
  curl_timer_(TimerManager::CreateTimer(*evm->io_service(), s,
              TaskScheduler::GetInstance()->GetTaskId(s), 0)),
  id_(0), work_queue_(TaskScheduler::GetInstance()->GetTaskId(s), 0,
