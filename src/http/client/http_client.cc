...
int HttpConnection::HttpPost(std::string &post_string,
                             std::string &path,  HttpCb cb) {
    std::vector<std::string> hdr_options;
...
void HttpConnection::HttpProcessInternal(std::string body, std::string path,
    ...
    switch (method) {
        ...
        case HTTP_POST:
            ...
            set_post_string(curl_handle_, body.c_str());
        ...
        case HTTP_PUT:
            ...
            set_put_string(curl_handle_, body.c_str());
