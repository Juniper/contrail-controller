...
TEST_F(ConnectionInfoTest, Callback) {
    ...
    EXPECT_EQ("Number of connections:1, Expected:2, Unexpected:0, Missing:1 "
    ...
    EXPECT_EQ(ProcessState::NON_FUNCTIONAL, pstate);
    EXPECT_EQ("Number of connections:1, Expected:3, Unexpected:0, Missing:2 "
    ...
    EXPECT_EQ(ProcessState::NON_FUNCTIONAL, pstate);
    EXPECT_EQ("Number of connections:3, Expected:2, Unexpected:1, Missing:0 "
    ...
    EXPECT_EQ("Number of connections:4, Expected:4, Unexpected:2, Missing:2 "
