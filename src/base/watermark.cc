...
void WaterMarkTuple::GetWaterMarkIndexes(int *hwater_index, int *lwater_index) const {
    *hwater_index = hwater_index_;
    *lwater_index = lwater_index_;
}

void WaterMarkTuple::SetWaterMarkIndexes(int hwater_index, int lwater_index) {
    hwater_index_ = hwater_index;
    lwater_index_ = lwater_index;
}

void WaterMarkTuple::ProcessWaterMarks(size_t in_count, size_t curr_count) {
