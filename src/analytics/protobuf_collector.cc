...
ProtobufCollector::ProtobufCollector(EventManager *evm,
    ...
    const std::vector<int> &cassandra_ports, const DbHandler::TtlMap& ttl_map, const std::string cassandra_name, const std::string cassandra_password) :
    db_initializer_(new DbHandlerInitializer(evm, kDbName, kDbTaskInstance,
        ...
        cassandra_ips, cassandra_ports, ttl_map, cassandra_name, cassandra_password)),
