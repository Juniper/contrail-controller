...
bool
LineParser::ParseDoc(Iterator start, Iterator end, WordListType &v)
{
    using ascii::space;
    using qi::char_;
    using qi::double_;
...
void
LineParser::RemoveStopWrods(WordListType &v)
{
...
std::map<std::string, bool> LineParser::stop_words_ =
    boost::assign::map_list_of ("via", true) ("or", true) ("of", true) ("-",
            true) ("----", true) ("the", true) ("that", true);
...
MakeLinkerHappy()
{
    ...
    bool r = LineParser::ParseDoc(s.begin(), s.end(), words);
