...
namespace analytics {
    ...
    class OutputStreamManager {
     public:
      ...
      // TODO fix namespaces in ifmap/ and throughout the project
      class IFMapConfigListener : public ConfigListener,
                                  public ::IFMapConfigListener {
          // TODO
          // callbacks
      };

      // TODO replace with IFMapConfigListener in the future
