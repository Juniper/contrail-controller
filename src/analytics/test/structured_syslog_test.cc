...
TEST_F(StructuredSyslogStatWalkerTest, Basic) {
    ...
    CsoConfig *cso_config = new CsoConfig(cfgdbConnection);
    structured_syslog::StructuredSyslogConfig *config_obj = new structured_syslog::StructuredSyslogConfig(cso_config);
