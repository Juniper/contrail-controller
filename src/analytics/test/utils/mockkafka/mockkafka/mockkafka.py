...
kafka_version = 'kafka_2.11-1.1.1'
kafka_dl = '/kafka_2.11-1.1.1.tar.gz'
...
def start_kafka(zk_client_port, broker_listen_port, broker_id=0):
    ...
    #    kafka_dl + '?raw=true'
    kafka_download = 'cp ' + '/users/vsjagan/confluent-kafka' + kafka_dl + ' ' + \
            kafka_bdir + kafka_dl 
    ...
    logging.info('Before call_command ') 
    ...
    logging.info('Trying to connect... cmd: %s'  % \
