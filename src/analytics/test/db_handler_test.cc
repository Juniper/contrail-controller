    ...
    for (sit = session_msgs.begin(); sit != session_msgs.end(); sit++) {
        ...
        for (dit = sit->second.begin(); dit != sit->second.end(); dit++) {
...

           {
                ...
                colname->push_back(boost::blank());
                colname->push_back(t2 + ":" + to_string(dit->get_vmi()));
