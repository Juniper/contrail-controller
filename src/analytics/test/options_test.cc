...
TEST_F(OptionsTest, DefaultConfFile) {
    ...
    char *argv[argc];
    char argv_0[] = "options_test";
    char argv_1[] = "--conf_file=controller/src/analytics/contrail-collector.conf controller/src/analytics/contrail-database.conf";
    argv[0] = argv_0;
    argv[1] = argv_1;
    ...
    passed_conf_files.push_back("controller/src/analytics/contrail-database.conf");
...
TEST_F(OptionsTest, CustomConfigFileAndOverrideFromCommandLine) {
    ...
    char argv_9[] = "--CASSANDRA.cassandra_name=cassandra";
