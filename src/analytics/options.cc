...
void Options::Initialize(EventManager &evm,
    ...
    uint32_t default_db_usage_level1_high = 80;
    uint32_t default_db_usage_level1_low = 75;
    uint32_t default_db_usage_level2_high = 70;
    uint32_t default_db_usage_level2_low = 60;
    uint32_t default_pending_compaction_tasks_level0_high = 400;
    uint32_t default_pending_compaction_tasks_level0_low = 300;
    uint32_t default_pending_compaction_tasks_level1_high = 200;
    uint32_t default_pending_compaction_tasks_level1_low = 150;
    uint32_t default_pending_compaction_tasks_level2_high = 100;
    uint32_t default_pending_compaction_tasks_level2_low = 80;
    SandeshLevel::type default_severity_level0 = SandeshLevel::SYS_EMERG;
    SandeshLevel::type default_severity_level1 = SandeshLevel::SYS_ERR;
    SandeshLevel::type default_severity_level2 = SandeshLevel::SYS_DEBUG;
...
void Options::Process(int argc, char *argv[],
        opt::options_description &cmdline_options) {
    uint32_t severity_level0 = 0;
    uint32_t severity_level1 = 0;
    uint32_t severity_level2 = 0;
    ...
    GetOptValue<uint32_t>(var_map, db_write_options_.db_usage_level0_high_,
                          "DATABASE_WRITE_POLICY.db_usage_level0_high");
    GetOptValue<uint32_t>(var_map, db_write_options_.db_usage_level0_low_,
                          "DATABASE_WRITE_POLICY.db_usage_level0_low");
    GetOptValue<uint32_t>(var_map, db_write_options_.db_usage_level1_high_,
                          "DATABASE_WRITE_POLICY.db_usage_level1_high");
    GetOptValue<uint32_t>(var_map, db_write_options_.db_usage_level1_low_,
                          "DATABASE_WRITE_POLICY.db_usage_level1_low");
    GetOptValue<uint32_t>(var_map, db_write_options_.db_usage_level2_high_,
                          "DATABASE_WRITE_POLICY.db_usage_level2_high");
    GetOptValue<uint32_t>(var_map, db_write_options_.db_usage_level2_low_,
                          "DATABASE_WRITE_POLICY.db_usage_level2_low");
    GetOptValue<uint32_t>(var_map, db_write_options_.pending_compaction_tasks_level0_high_,
                          "DATABASE_WRITE_POLICY.pending_compaction_tasks_level0_high");
    GetOptValue<uint32_t>(var_map, db_write_options_.pending_compaction_tasks_level0_low_,
                          "DATABASE_WRITE_POLICY.pending_compaction_tasks_level0_low");
    GetOptValue<uint32_t>(var_map, db_write_options_.pending_compaction_tasks_level1_high_,
                          "DATABASE_WRITE_POLICY.pending_compaction_tasks_level1_high");
    GetOptValue<uint32_t>(var_map, db_write_options_.pending_compaction_tasks_level1_low_,
                          "DATABASE_WRITE_POLICY.pending_compaction_tasks_level1_low");
    GetOptValue<uint32_t>(var_map, db_write_options_.pending_compaction_tasks_level2_high_,
                          "DATABASE_WRITE_POLICY.pending_compaction_tasks_level2_high");
    GetOptValue<uint32_t>(var_map, db_write_options_.pending_compaction_tasks_level2_low_,
                          "DATABASE_WRITE_POLICY.pending_compaction_tasks_level2_low");
    GetOptValue<uint32_t>(var_map, severity_level0,
                          "DATABASE_WRITE_POLICY.severity_level0");
    GetOptValue<uint32_t>(var_map, severity_level1,
                          "DATABASE_WRITE_POLICY.severity_level1");
    GetOptValue<uint32_t>(var_map, severity_level2,
                          "DATABASE_WRITE_POLICY.severity_level2");
    db_write_options_.severity_level0_ = (SandeshLevel::type)severity_level0;
    db_write_options_.severity_level1_ = (SandeshLevel::type)severity_level1;
    db_write_options_.severity_level2_ = (SandeshLevel::type)severity_level2;
