...
void Options::Initialize(EventManager &evm,
    ...
    conf_files.push_back("/etc/contrail/contrail-cassandra.conf");
    ...
    cassandra_config.add_options()
        ("CASSANDRA.name",opt::value<string>()->default_value(""),"Cassandra user name")
        ("CASSANDRA.password",opt::value<string>()->default_value(""),"Cassandra password");
...
void Options::Process(int argc, char *argv[],
    ...
    GetOptValue<string>(var_map, cassandra_name_, "CASSANDRA.name");
    GetOptValue<string>(var_map, cassandra_password_, "CASSANDRA.password");
}
