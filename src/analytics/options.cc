...
void Options::Initialize(EventManager &evm,
    ...
    conf_files.push_back("/etc/contrail/contrail-database.conf");
    ...
    cassandra_config.add_options()
        ("CASSANDRA.cassandra_name",opt::value<string>()->default_value(""),"Cassandra user name")
        ("CASSANDRA.cassandra_password",opt::value<string>()->default_value(""),"Cassandra password");
...
void Options::Process(int argc, char *argv[],
    ...
    GetOptValue<string>(var_map, cassandra_name_, "CASSANDRA.cassandra_name");
