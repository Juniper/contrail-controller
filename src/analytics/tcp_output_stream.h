...
class TCPOutputStream : public OutputStreamHandler {
 public:
    ...
    virtual const struct Stats *stats() const {
        return &stats_;
    }
 ...
 private:
    ...
    // called.
    virtual bool isReadyForDequeue() {
        return session_ == NULL ? false : session_->IsEstablished();
    }
