...
TEST_F(CqlIfTest, SelectFromTableIndexColumnRead) {
    ...
    GenDb::ColumnNameRange empty_crange;
    GenDb::FieldNamesToReadVec empty_fields;
    GenDb::WhereFromIndexVec empty_where;
    std::string actual_qstring(
        cass::cql::impl::ClusteringKeyRangeAndIndexVal2CassSelectFromTable(
    ...
    GenDb::WhereFromIndexVec where_vec = boost::assign::tuple_list_of
        (1, GenDb::Op::EQ, all_values[0])
        (2, GenDb::Op::LE, all_values[1])
        (3, GenDb::Op::GE, all_values[2])
        (4, GenDb::Op::CONTAINS, all_values[3]);
