...
#define sXMPP_STREAM_OPEN            "<?xml version='1.0'?><stream:stream from='dummycl' to='dummyserver' version='1.0' xml:lang='en' xmlns:stream='http://etherx.jabber.org/streams'/>"
#define sXMPP_STREAM_RESP            "<?xml version='1.0'?><stream:stream from='dummyserver' to='dummycl' id='++123' version='1.0' xml:lang='en' xmlns:stream='http://etherx.jabber.org/streams'/>"
