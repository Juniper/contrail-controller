...
TEST_F(XmppStateMachineTest, Idle__EvStart) {
    EvStop();
...
TEST_F(XmppStateMachineTest, Active__OpenTimerExpired) {
    VerifyState(xmsm::ACTIVE);
...
// Event    :EvTcpClose
// NewState :Idle
TEST_F(XmppStateMachineTest, Active__EvTcpClose) {
    VerifyState(xmsm::ACTIVE);
...
// Event    :EvStop
// NewState :Idle
TEST_F(XmppStateMachineTest, Active__EvStop) {
    VerifyState(xmsm::ACTIVE);
...
// Event    :EvStop
// NewState :Idle
TEST_F(XmppStateMachineTest, Active__EvPassiveOpen__EvStop) {
    VerifyState(xmsm::ACTIVE);
