...
//
TcpSession *XmppServer::AllocSession (bool server_session) {
...
TcpServer::Socket *XmppServer::accept_socket() const {
    return (TcpServer::accept_socket());
}

void XmppServer::set_accept_socket() {
