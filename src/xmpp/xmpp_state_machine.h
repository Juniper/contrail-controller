...
typedef enum {
    ...
    OPENCONFIRM_TLSHANDSHAKE_SUCCESS = 2
} XmSubState;
...
public:
    ...
    xmsm::XmSubState SubStateType() const;
    ...
    void set_sub_state(xmsm::XmSubState sub_state);
    xmsm::XmSubState get_sub_state() { return sub_state_; }
