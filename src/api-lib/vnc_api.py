...
class VncApi(object):
    ...
    def __init__(self, username=None, password=None, tenant_name=None,
        ...
        if self._authn_type is '':
            pass
        elif self._authn_type == 'keystone':
            ...
            if 'v2' in self._authn_url:
                ...
                self._authn_body = \
                     '{"auth":{"identity":{' + \
                        ...
                        '}' + \
                     '}'
        elif self._authn_type:
            raise NotImplementedError("The authentucation type '%s' is not "\
                "supported by the VNC API lib" % self._authn_type)
