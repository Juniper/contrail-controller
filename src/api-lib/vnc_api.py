...
class ApiServerSession(object):
    ...
    def roundrobin(self):
        ...
        if self.active_session[0] in session_hosts:
            last_used_index = session_hosts(self.active_session[0])
        else:
        ...
        self.active_session = (active_host, self.api_server_sessions[active_host])
    ...
    def crud(self, method, url, *args, **kwargs):
        active_host, active_session = self.roundrobin()
