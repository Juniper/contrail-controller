    ...
    void Initialize() {
        ReactionMap ipam_react =
            map_list_of<string, PropagateList>
                ...
                ("virtual-network-network-ipam", list_of("self").convert_to_container<PropagateList>());
        ...
        ReactionMap virt_dns_rec_react =
            map_list_of<string, PropagateList>
                ("self", list_of("self").convert_to_container<PropagateList>())
                ("virtual-DNS-virtual-DNS-record", list_of("self").convert_to_container<PropagateList>());
