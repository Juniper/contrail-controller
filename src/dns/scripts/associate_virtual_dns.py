...
class AssociateVirtualDns(object):
    ...
    def _parse_args(self, args_str):
        ...
        parser.add_argument("--ipam_dns_method", choices=['none', 'default-dns-server', 'tenant-dns-server', 'virtual-dns-server'], help = "Type of Ipam DNS method", required=True)
        parser.add_argument("--vdns_fqname", help = "Fully qualified Virtual DNS Name", required=True)
        parser.add_argument("--tenant_dns_servers", nargs='+', help = "List of IPs DNS Servers", required=True)
