...
class AddVirtualDnsRecord(object):
    ...
    def _parse_args(self, args_str):
        ...
        parser.add_argument("--name", help = "Virtual DNS Record Name", required=True)
        parser.add_argument("--vdns_fqname", help = "Fully qualified Virtal Dns Name", required=True)
        parser.add_argument("--rec_name", help = "DNS Host name", required=True)
        parser.add_argument("--rec_type", choices=['A', 'AAAA', 'CNAME', 'PTR', 'NS'], help = "DNS Record Type", required=True)
        parser.add_argument("--rec_class", choices=['IN'], help = "DNS Record class", required=True)
        parser.add_argument("--rec_data", help = "Data for DNS Record", required=True)
        parser.add_argument("--rec_ttl", type = int, help = "Time to Live for DNS record", required=True)
