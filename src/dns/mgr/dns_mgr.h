...
public:
    ...
    static const uint32_t KMinBindRecordsSend = 20;
    static const uint32_t KMaxBindRecordsSend = 500;
    static const uint32_t kPendingRecordReScheduleTime = 500; // milliseconds
