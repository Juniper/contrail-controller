...
func createContrailConfigObject (fqNameTable *FQNameTableType, tp, name, parent_type string, fq_name []string) (*ContrailConfigObject, error) {
    u, err := uuid.NewUUID()
    if err != nil {
        return nil, err
    }
...
func NewConfigObject (fqNameTable *FQNameTableType, uuidTable *UUIDTableType, tp, name, parent string, fqname []string) (*ContrailConfigObject, error) {
    obj, err := createContrailConfigObject(fqNameTable, tp, name, parent, fqname)
    if err != nil {
        return nil, err
    }
...
func (c *ContrailConfigObject) UpdateDB(uuidTable *UUIDTableType) error {
