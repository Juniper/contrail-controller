...
class AnalyticsTest(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def test_00_table_source_module_list_with_password(self):
        '''
        ...
        self.verify_source_module(vizd_obj)
        return True
    #end test_00_table_source_module_list

    #@unittest.skip('verify redis-uve restart')
    def test_01_redis_uve_restart_with_password(self):
    ...
    def verify_source_module(self, vizd_obj):
