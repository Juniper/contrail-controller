...
class TestAlarmGen(unittest.TestCase, TestChecker):
	...
	clear_alarm_tests = [
            TestCase (
		name = "case1 clear alarm in Soak_Active",
		initial_state = UVEAlarmState.Soak_Active,
		timer = 10,
		expected_output_state = UVEAlarmState.Idle
            ),
            TestCase (
		name = "case2 clear alarm in Active",
