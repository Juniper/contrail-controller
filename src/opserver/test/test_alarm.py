...
class TestAGKeyInfo(unittest.TestCase):
    ...
    def test_00_update_by_types_add(self):
        input_data = {'xx': 'data'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
    ...
    def test_01_update_by_types_remove(self):
        input_data = {'xx': 'data'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
        ...
        orig.update_by_types(input_data.keys(), {})
    ...
    def test_02_update_by_types_change(self):
        input_data = {'xx': 'data'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
    ...
    def test_03_update_by_types_no_change(self):
        input_data = {'xx': None}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), {})
        self.init_exp_dict()
    ...
    def test_04_update_by_types_commit_failed_once(self):
        input_data = {'xx': 'data'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
    ...
    def test_05_update_by_types_diff_type_seperate_commit(self):
        input_data = {'xx': 'data'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
        ...
        orig.update_by_types(input_data1.keys(), input_data1)
    ...
    def test_06_update_by_types_diff_type_same_commit(self):
        input_data = {'xx': 'data', 'yy':'data1'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
        self.set_exp_pending(input_data)
    ...
    def test_07_update_by_types_diff_type_seperate_commit_one_failed(self):
        input_data = {'xx': 'data'}
        orig= AGKeyInfo(1)
        orig.update_by_types(input_data.keys(), input_data)
        self.init_exp_dict()
