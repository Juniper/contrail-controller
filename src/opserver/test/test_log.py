...
class LogQuerierTest(unittest.TestCase):
    ...
    #@unittest.skip("skip test_7_multiple_modules_query")
    def test_7_multiple_modules_query(self):
        global test_num
        global query_list
        query_list = []
        test_num = 7
