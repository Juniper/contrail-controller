...
class FlowQuerierTest(unittest.TestCase):
    ...
    def test_1_noarg_query(self):
        ...
        expected_result_str = '{"table": "FlowRecordTable", "dir": 1, "select_fields": ["UuidKey", "vrouter", "setup_time", "teardown_time", "sourcevn", "destvn", "sourceip", "destip", "protocol", "sport", "dport", "action", "direction_ing", "agg-bytes", "agg-packets", "sg_rule_uuid", "nw_ace_uuid", "vrouter_ip", "other_vrouter_ip", "vmi_uuid", "drop_reason", "analyzer_name", "sec_analyzer_name", "mirror_bytes", "mirror_packets", "sec_mirror_bytes", "sec_mirror_packets"]}'
