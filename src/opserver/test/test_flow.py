...
result_1 = [
{u'vmi_uuid': u'caa07fcb-ae79-441b-bc90-fa735846f137', u'sg_rule_uuid': u'18be4115-48dd-4623-8b0e-113a1a65d527', u'agg-packets': 2024, u'dport': 0, u'UuidKey': u'60487e4e-ae33-4dbd-8105-052d831f36dd', u'vrouter': u'a6s10', u'direction_ing': 1, u'sport': 17409, u'destip': u'1.1.1.4', u'nw_ace_uuid': u'00000000-0000-0000-0000-000000000001', u'agg-bytes': 198352, u'other_vrouter_ip': u'10.84.13.10', u'teardown_time': None, u'action': u'pass', u'protocol': 1, u'setup_time': 1442595479379251, u'sourceip': u'1.1.1.3', u'vrouter_ip': u'10.84.13.10', u'destvn': u'default-domain:admin:vn1', u'sourcevn': u'default-domain:admin:vn1'}
]
...
class FlowQuerierTest(unittest.TestCase):
    ...
    def test_1_noarg_query(self):
        ...
        flexmock(querier).should_receive('output').replace_with(lambda x: self.custom_output(x))
        argv = sys.argv
        sys.argv = "contrail-flows".split()
        querier.run()
        sys.argv = argv

        expected_result_str = '{"table": "FlowRecordTable", "start_time": "now-10m", "end_time": "now", "dir": 1, "select_fields": ["UuidKey", "vrouter", "setup_time", "teardown_time", "sourcevn", "destvn", "sourceip", "destip", "protocol", "sport", "dport", "action", "direction_ing", "agg-bytes", "agg-packets", "sg_rule_uuid", "nw_ace_uuid", "vrouter_ip", "other_vrouter_ip", "vmi_uuid"]}'
