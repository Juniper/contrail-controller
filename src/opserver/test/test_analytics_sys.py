...
class AnalyticsTest(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    @mock.patch.object(OpServer, 'get_resource_list')
    @mock.patch.object(OpServer, 'is_role_cloud_admin')
    def test_16_rbac(self, mock_is_role_cloud_admin, mock_get_resource_list):
        ...
        mock_get_resource_list.return_value=set(["default-domain:vn0"])
