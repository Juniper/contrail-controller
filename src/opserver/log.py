...
class LogQuerier(object):
    ...
    def parse_args(self):
        ...
        parser.add_argument("--source", nargs="*",
            help="Logs from space seperated list of sources")
        parser.add_argument("--node-type", help="Logs from node type",
            choices=NodeTypeNames.values())
        parser.add_argument("--module", nargs="*",
            help="Logs from space seperated list of modules", choices=ModuleNames.values())
        ...
        parser.add_argument("--message-type", nargs="*",
            help="Logs of space seperated message types")
