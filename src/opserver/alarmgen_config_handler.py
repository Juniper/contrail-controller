            ...
            try:
                ...
                try:
                    ...
                    if operation == 'CREATE' or operation == 'UPDATE':
                        ...
                        assert(0)
                    table_alarm_map[table] = {alarm_fqname:operation}
        return table_alarm_map
        ...
        if operation == 'CREATE' or operation == 'UPDATE':
            if config_type == 'alarm':
                ...
                if alarm_config is None:
                    table_alarm_map = self._update_alarm_config_table(
                    ...
                    if add_uve_keys:
                        table_alarm_map.update(self._update_alarm_config_table(
            ...
            assert(0)
        if table_alarm_map:
            self._alarm_config_change_callback(table_alarm_map)
