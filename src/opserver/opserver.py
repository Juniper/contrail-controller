    ...
    def update_where_clause(self, request, obj_list, name, op=7, prefix=None):
        ...
        if 'where' in request.json:
            ...
            if len(where_clause_list) == 1:
                if where_clause_list[0][0]['name'] == 'name':
        ...
        for obj in obj_list:
            ...
            if len(name_where_clause) == 0 or only_default_clause:
                ...
                for (clause, and_query) in name_where_clause:
                    ...
                    elif and_query["name"] == name and and_query["op"] == 1:
        ...
        if len(where_clause_list) == 0:
            ...
            for existing_clause in where_clause_list:
                for new_clause in new_clause_list:
                    if existing_clause == []:
                        request.json['where'].append([new_clause[0]])
                    else:
                        request.json['where'].append([existing_clause[0], new_clause[0]])
