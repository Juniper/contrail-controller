...
class OpServer(object):
    ...
    def __init__(self):
        ...
        self._analytics_db = AnalyticsDb(self._logger,
            self._args.cassandra_server_list, self._args.redis_query_port)
    ...
    def process_purge_request(self):
        ...
        if (res == None):
            self._analytics_db.set_analytics_db_purge_status(purge_id,
                            purge_input)
            ...
            return bottle.HTTPResponse(json.dumps(res), _ERRORS[errno.EBADMSG],
                                       {'Content-type': 'application/json'})
    ...
    def db_purge_operation(self, purge_input, purge_id):
        ...
        self._analytics_db.delete_db_purge_status(purge_id)
