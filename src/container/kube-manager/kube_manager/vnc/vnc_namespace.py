...
class VncNamespace(VncCommon):
    ...
    def _create_vn_vn_policy(self, policy_name,
        ...
        policy_obj = self._vnc_lib.network_policy_read(fq_name=policy.fq_name)
        NetworkPolicyKM.locate(policy_obj.uuid, policy_obj)
        return policy_obj
    ...
    def _update_security_groups(self, ns_name, proj_obj):
        ...
        sg = SecurityGroupKM.locate(sg_obj.get_uuid(), sg_obj)
        return sg
    ...
    def vnc_namespace_add(self, namespace_id, name, labels):
        ...
        try:
            ...
            pass
        proj_obj = self._vnc_lib.project_read(fq_name=proj_fq_name)
        project = ProjectKM.locate(proj_obj.uuid, proj_obj)
