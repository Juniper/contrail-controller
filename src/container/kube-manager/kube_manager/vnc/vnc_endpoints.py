...
class VncEndpoints(object):
        ...
        for subset in subsets:
            ...
            for endpoint in endpoints:
                ...
                if pod and pod.get('uid'):
                    pods_in_event.append(pod.get('uid'))
    ...
    def vnc_endpoint_add(self, uid, name, namespace, event):
        ...
        add_pod_members = set(cur_pod_ids) - set(prev_pod_ids)
        ...
        del_pod_members = set(prev_pod_ids) - set(cur_pod_ids)
