...
class VncApiMock(object):
    ...
    def __init__(self, admin_user, admin_password, admin_tenant,
        ...
        if (admin_user != VncApiMock.admin_user
                or admin_password != VncApiMock.admin_password
                or admin_tenant != VncApiMock.admin_tenant
                or vnc_endpoint_ip != VncApiMock.vnc_endpoint_ip
                or vnc_endpoint_port != VncApiMock.vnc_endpoint_port
                or auth_token_url != VncApiMock.auth_token_url):
            raise RuntimeError()
    ...
    def init():
        ...
        VncApiMock.admin_user = "admin"
        VncApiMock.admin_password = "qwerty"
        VncApiMock.admin_tenant = "default"
        VncApiMock.vnc_endpoint_ip = "10.10.0.3"
        VncApiMock.vnc_endpoint_port = "8080"
        VncApiMock.auth_token_url = "token"
    ...
    def object_from_dict(res_type, obj_dict):
        ...
        return obj_cls.from_dict(**obj_dict)
