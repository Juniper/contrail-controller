...
class ContrailParams():
    ...
    - mode      : Only MESOS or K8S supported for now 
    ...
    def __init__(self):
        ...
        self.poll_timeout = Consts.VROUTER_POLL_TIMEOUT
        self.poll_retries = Consts.VROUTER_POLL_RETRIES
...
class Params():
    ...
    - cni_params       : Contains CNI specific arguements
    ...
    def get_common_params(self, json_input=None):
        ...
        if json_input:
            ...
            self.cni_params.get_params(self.container_id, json_input.get('cni'))
        return

    def log(self):
        logger.debug('Params container-id = ' + self.container_id +
                     ' container-ifname = ' + self.container_ifname +
                     ' container-netns = ' + self.container_netns)
        self.cni_params.log()
