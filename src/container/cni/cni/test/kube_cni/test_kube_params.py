...
import importlib
kube_params = importlib.import_module("cni.kube-cni.kube_params")
...
class K8SParamsTest(unittest.TestCase):
    ...
    def test_init(self):
        ...
        docker.client.Client = Mock(return_value=DockerClientMock())
        ...
        docker.client.Client = Mock(return_value=None)
