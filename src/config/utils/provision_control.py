    ...
    def __init__(self, args_str=None):
        ...
        if self._args.router_asn and not self._args.oper:
            ...
            if self._args.graceful_restart_time:
                gr_params.set_graceful_restart_time(int(self._args.graceful_restart_time))
            if self._args.long_lived_graceful_restart_time:
                gr_params.set_long_lived_graceful_restart_time(int(self._args.long_lived_graceful_restart_time))
            if self._args.end_of_rib_receive_time:
                gr_params.set_end_of_rib_receive_time(int(self._args.end_of_rib_receive_time))
            if gr_params != GracefulRestartType():
