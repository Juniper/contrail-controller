...
class ControlProvisioner(object):
    ...
    def gr_time_type(self, value):
        ...
        if time < 0 or time > 600:
            raise argparse.ArgumentTypeError("graceful_restart_time %s must be in range (0..600)" % value)
        return time
    ...
    def eor_receive_time_type(self, value):
        time = int(value)
        if time < 0 or time > 16777215:
            raise argparse.ArgumentTypeError("end_of_rib_receive_time %s must be in range (0..16777215)" % value)
        return time
    ...
    def _parse_args(self, args_str):
        ...
        parser.add_argument(
            ...
            help="Graceful Restart Time in seconds (0..600)",
        ...
        parser.add_argument(
            ...
            help="EndOfRib receive timeout in seconds (0..16777215)",
