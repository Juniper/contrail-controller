...
class ControlProvisioner(object):
    def __init__(self, args_str = None):
        ...
        if self._args.oper == 'add':
            bp_obj.add_bgp_router('contrail', self._args.host_name, self._args.host_ip, self._args.router_asn)
    ...
    def _parse_args(self, args_str):
        ...
        parser.add_argument("--host_name", help = "hostname name of control-node")
        parser.add_argument("--host_ip", help = "IP address of control-node")
        parser.add_argument("--router_asn", help = "AS Number the control-node is in")
        parser.add_argument("--api_server_ip", help = "IP address of api server")
        parser.add_argument("--api_server_port", help = "Port of api server")
        parser.add_argument("--oper", default = 'add', help = "Provision operation to be done(add or del)")
