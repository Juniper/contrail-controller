    ...
    def __init__(self, args_str=None):
        ...
        if self._args.router_asn and not self._args.oper:
            ...
            if self._args.set_graceful_restart_parameters:
                ...
                gr_params.set_graceful_restart_enable(
                    self._args.graceful_restart_enable)
                gr_params.set_graceful_restart_bgp_helper_enable(
                    self._args.graceful_restart_bgp_helper_enable)
                gr_params.set_graceful_restart_xmpp_helper_enable(
