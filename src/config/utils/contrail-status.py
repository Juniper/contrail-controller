...
CONTRAIL_SERVICE_CUSTOMER_NODETYPE = { 'redis-server' : ['webui', 'analytics'],
...
def service_check_customer(svc):
    if svc in CONTRAIL_SERVICE_CUSTOMER_NODETYPE.keys():
        for customer in CONTRAIL_SERVICE_CUSTOMER_NODETYPE[svc]:
