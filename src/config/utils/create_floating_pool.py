...
class VncProvisioner(object):
    ...
    def _parse_args(self, args_str):
        ...
        defaults = {
            'public_vn_name': 'default-domain:default-project:default-virtual-network',
            'floating_ip_pool_name': 'fip_pool',
            'api_server_ip' : '127.0.0.1',
            'api_server_port' : '8082',
        }
        ...
        parser.add_argument("--public_vn_name", help = "Colon separated fully qualified name")
        parser.add_argument("--floating_ip_pool_name", help = "Name of the floating IP pool")
