...
class AlarmProvisioner(object):
        ...
        for alarm_name, value in self._args.alarm_list.iteritems():
            ...
            for and_list in value['or_list']:
                ...
                for input_exp in and_list['and_list']:
                    ...
                    if 'variables' is input_exp.keys():
                        variables=input_exp['variables']
                    else:
                        variables=None
                    exp = AlarmExpression(
                                operation=operation,
            ...
            id_perms = IdPermsType(creator='system', description=value['description'])
    ...
    def _parse_args(self, args_str):
        ...
        if (self._args.oper != 'add' and self._args.oper != 'del'):
