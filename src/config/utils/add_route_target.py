...
class MxProvisioner(object):
    ...
    def _parse_args(self, args_str):
        ...
        defaults = {
            'routing_instance_name': 'default-domain:default-project:ip-fabric:__default__',
        ...
        parser.add_argument("--routing_instance_name", help = "Colon separated fully qualified name")
        parser.add_argument("--route_target_number", help = "Route Target for MX interaction")
