...
function print_usage()
{
	...
	echo "		Comma separated list of keyspaces to be skipped"
	echo "EXAMPLE"
	echo "	$me -b /var/lib/cassandra/data -s /root/data.ss -n 1403068337967 -k DISCOVERY_SERVER,ContrailAnalytics"
	exit
}
if [ $# -eq  0 ]
then
