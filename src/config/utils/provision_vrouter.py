...
class VrouterProvisioner(object):
    def __init__(self, args_str = None):
        ...
        rt_inst_obj = self._vnc_lib.routing_instance_read(fq_name = ['default-domain', 'default-project',
    ...
    def _parse_args(self, args_str):
        ...
        parser.add_argument("--host_name", help = "hostname name of compute-node")
        parser.add_argument("--host_ip", help = "IP address of compute-node")
        parser.add_argument("--control_names", help = "List of control-node names compute node connects to")
    ...
    def add_vrouter(self):
        ...
        vrouter_exists = True
        try:
            vrouter_obj = self._vnc_lib.virtual_router_read(fq_name = vrouter_obj.get_fq_name())
