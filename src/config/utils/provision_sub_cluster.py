...
#python provision_sub_cluster.py --host_name issu-vm3 --host_ip 10.87.64.53 --api_server_ip 10.87.64.55 --api_server_port 8082 --oper add --sub_cluster_asn 64513 --openstack_ip 10.87.64.55 --admin_user admin --admin_password c0ntrail123 --admin_tenant_name admin 

#python provision_control.py --host_name issu-vm4 --host_ip 10.87.64.54 --api_server_ip 10.87.64.55 --api_server_port 8082   --admin_user admin --admin_password c0ntrail123 --admin_tenant_name admin --no_ibgp_auto_mesh  --sub_cluster_host_name issu-vm4 --router_asn 64513 --oper add

#python provision_vrouter.py --host_name issu-vm2 --host_ip 10.87.64.52 --api_server_ip 10.87.64.55 --api_server_port 8082   --admin_user admin --admin_password c0ntrail123 --admin_tenant_name admin  --sub_cluster_host_name issu-vm4 --oper add --openstack_ip 10.87.64.55
...
class SubClusterProvisioner(object):
    ...
    def _parse_args(self, args_str):
        '''
        Eg. python provision_sub_cluster.py --host_name a3s30.contrail.juniper.net
                                        --host_ip 10.1.1.1
        ...
        parser.add_argument(
            "--host_name", help="hostname name of sub cluster node", required=True)
        parser.add_argument("--host_ip", help="IP address of sub cluster node", required=True)
        parser.add_argument(
    ...
    def del_sub_cluster(self):
        #gsc_obj = self._global_system_config_obj
        sub_cluster_obj = SubCluster(self._args.host_name)
