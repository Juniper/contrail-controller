...
# --api_server_ip 10.87.64.55 --api_server_port 8082   --admin_user
# admin --admin_password c0ntrail123 --admin_tenant_name admin
...
class SubClusterProvisioner(object):
    ...
    def _parse_args(self, args_str):
        '''
        Eg. python provision_sub_cluster.py --sub_cluster_name a3s30.contrail.juniper.net
        ...
        parser.add_argument(
            "--sub_cluster_name", help="hostname name of sub cluster node", required=True)
        parser.add_argument(
    ...
    def add_sub_cluster(self):
        ...
        sub_cluster_obj = SubCluster(
            self._args.sub_cluster_name, #gsc_obj,
