...
class PNFProvisioner(object):
    ...
    def add_service_appliance_set(self):    
        ...
        try:
            sas_obj = self._vnc_lib.service_appliance_set_read(fq_name=sa_set_fq_name)
        ...
        if self._args.virtualization_type is not None:
            sas_obj.set_service_appliance_set_virtualization_type(self._args.virtualization_type)
        kvp_array = []
        try:
        ...
        print "Created Service Appliance Set " + sa_set_uuid
    # end add_pnf
    ...
    def del_service_appliance_set(self):
        ...
        try:
            ...
            print "Error: Service Appliance Set does not exist %s" % self._args.name
        else:
    ...
    def add_service_template(self):
        ...
        try:
            ...
            print "Created Service Template " + st_uuid    
        else:
        ...
        try:
            ...
            svc_properties.set_service_virtualization_type(self._args.virtualization_type)
            ...
            print "Warning: Service template could not be fully updated " + st_uuid
        else:
    ...
    def add_service_appliance(self):
        ...
        try:
            ...
            print "Warning: Some attributes of Service Appliance missing " + appliance_name
        ...
        try:
            ...
            print "Error: Left PNF interface does not exist %s " % self._args.pnf_left_intf
            sys.exit(-1)
        except AttributeError:
        ...
        try:
            ...
            print "Error: Right PNF interface does not exist %s " % self._args.pnf_right_intf
            sys.exit(-1)
        except AttributeError:
    ...
    def add_service_instance(self):
        ...
        try:
            ...
            props = ServiceInstanceType(service_virtualization_type=self._args.virtualization_type)
            si_obj.set_service_instance_properties(props)
        except AttributeError:
            print "Warning: Some attributes of Service Instance missing " + si_name
    ...
    def add_port_tuple(self):
        ...
        try:
            left_lr_fq_name = ['default-domain','admin',self._args.left_lr_name]
            right_lr_fq_name = ['default-domain','admin',self._args.right_lr_name]
            left_lr_obj = self._vnc_lib.logical_router_read(fq_name=left_lr_fq_name)
            right_lr_obj = self._vnc_lib.logical_router_read(fq_name=right_lr_fq_name)
...
# end class PNFProvisioner


def main(args_str=None):
    PNFProvisioner(args_str)
# end main
