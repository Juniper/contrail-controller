...
class ParserModule(object):
    ...
    def parse_juniper_device_data(self, device_data, regex_str):
        cf_interfaces_list = device_data['configured_interfaces_info']['config_parsed']['configuration']['interfaces']['interface']
        rt_interfaces_list = device_data['runtime_interfaces_info']['parsed_output']['interface-information']['physical-interface']
