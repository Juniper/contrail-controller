...
class FabricFilterUtils(object):
    ...
    def onboard_fabric(self, job_ctx):
        ...
        try:
            ...
            fabric_obj = self.onboard_fabric_obj(vnc_api, fabric_info, True,
                                                 job_template_fqname)
            return {
                'status': 'success',
    ...
    def onboard_brownfield_fabric(self, job_ctx):
        ...
        try:
            ...
            vnc_api = JobVncApi.vnc_init(job_ctx)
            fabric_info, job_template_fqname = FabricFilterUtils.\
                validate_job_ctx(vnc_api, job_ctx, True)
            fabric_obj = self.onboard_fabric_obj(vnc_api, fabric_info, False,
                                                 job_template_fqname)
            return {
                'status': 'success',
                'fabric_uuid': fabric_obj.uuid,
    ...
    def onboard_fabric_obj(self, vnc_api, fabric_info, ztp, job_template_fqname):
        """
        :param vnc_api: <vnc_api.VncApi>
    ...
    def assign_roles(self, job_ctx, vnc_api=None):
        ...
        :param vnc_api: Optional VNC api object
        :return: Dictionary
            if success, returns
                {
                    'status': 'success',
