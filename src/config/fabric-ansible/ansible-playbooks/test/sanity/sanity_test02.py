...
class SanityTest02(SanityBase):
    ...
    def __init__(self, cfg):
        ...
        self._image_version = self._swift_params['image_version']
        self._image_family_name = self._swift_params['image_family_name']
        self._image_vendor_name = self._swift_params['image_vendor_name']
        self._device_family_name = self._swift_params['device_family_name']
        self._device_vendor_name = self._swift_params['device_vendor_name']
