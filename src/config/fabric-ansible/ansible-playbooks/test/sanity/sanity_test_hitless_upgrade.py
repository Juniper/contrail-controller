...
sys.path.append('../..')
sys.modules['ansible.module_utils.fabric_utils'] = __import__('sanity_test03')
...
class SanityTest03(SanityBase):
    ...
    def test_maintenance_mode(self):
        ...
        try:
            ...
            fabric_uuid = self._api.fabric_read(fq_name=fabric_fq_name).uuid
...
if __name__ == "__main__":
    SanityTest03(config.load('config/test_config.yml',
