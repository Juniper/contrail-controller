...
class TestFabricVncDbModule(TestFabricModule):
    ...
    def test_vnc_read(self):
       ...
       flexmock(fake_vnc_lib).should_receive('physical_router_read').and_return(fake_router)
       flexmock(fake_vnc_lib).should_receive('obj_to_dict').and_return(fake_router_obj)
    ...
    def test_vnc_create(self):
       ...
       flexmock(fake_vnc_lib).should_receive('physical_router_create').and_return(fake_router_uuid)
    ...
    def test_vnc_update(self):
       ...
       flexmock(fake_vnc_lib).should_receive('physical_router_update').and_return(fake_router_obj)
       flexmock(fake_vnc_lib).should_receive('id_to_fq_name').and_return('MX-240')
