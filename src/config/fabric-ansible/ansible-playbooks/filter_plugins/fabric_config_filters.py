...
class FilterModule(object):
    ...
    def _load_role_to_feature_mapping(self):
        ...
        self.feature_based_plugin_roles = set(
            [r.lower() for r in feature_based_plugin_roles])
    ...
    def _render_feature_based_config(self):
        if (not self.is_delete and 'features' not in self.abstract_config)\
                or not self.feature_based_list:
            return
