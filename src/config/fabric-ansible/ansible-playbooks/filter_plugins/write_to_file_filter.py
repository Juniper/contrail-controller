...
class FilterModule(object):
    ...
    def report_percentage_completion(self, exec_id, unique_pb_id, percentage):
        write_to_file_log = "\n"
        try:
    ...
    def report_pb_output(self, exec_id, unique_pb_id, pb_output):
        write_to_file_log = "\n"
        try:
            write_to_file_log = "Attempting to create or open file.. \n"
            with open("/tmp/"+exec_id, "a") as f:
    ...
    def report_end_of_playbook(self, exec_id, unique_pb_id):
        write_to_file_log = "\n"
        try:
            write_to_file_log = "Attempting to create or open file.. \n"
            with open("/tmp/"+exec_id, "a") as f:
    ...
    def report_device_info(self, exec_id, unique_pb_id, device_data):
        write_to_file_log = "\n"
        try:
            write_to_file_log = "Attempting to create or open file.. \n"
            with open("/tmp/"+exec_id, "a") as f:
