...
class FilterModule(object):
    ...
    def topology_discovery(self, job_ctx, prouter_fqname, prouter_vendor_name,
    ...
    def validate_lldp_neighbors_payload(self, payload):
        with open('/opt/contrail/fabric_ansible_playbooks/device_parsers/device_operation_schema/topology_discovery_schema.json') as f:
    ...
    # group vnc functions
    @validate_payload
    def _create_neighbor_links(self, job_ctx, lldp_neighbors_payload, prouter_fqname, validator_method):
