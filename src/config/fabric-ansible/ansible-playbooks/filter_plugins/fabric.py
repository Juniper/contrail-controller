...
class FilterModule(object):
    ...
    def _verify_physical_roles(self, device_obj, remote_device_obj):
        # this function verifies that local prouter and the remote
        # prouter are not of the same leaf or same spine roles in
        ...
        if (local_physical_role == 'spine' and
            remote_physical_role == 'leaf') or (
                        remote_physical_role == 'spine'and
                        local_physical_role == 'leaf'):
            return True
        _task_log("Not creating instance ips as both"
