...
class FilterModule(object):
    ...
    def _read_obj(self, vnc_api, obj_name, obj_uuid=None,
                  fq_name=None, fields=None):
        try:
            return getattr(vnc_api, obj_name +"_read")(
                id=obj_uuid,
                fq_name=fq_name,
                fields=fields)
        except NoIdError:
            _task_done(
                '{} {} not found'.format(obj_name, fq_name or obj_uuid)
            )
        return None
    # end _read_obj
    ...
    def _get_pnf_service_refs(self, vnc_api, device_names):
        ...
        for sa_ref in sa_refs or []:
            ...
            sa_obj = self._read_obj(vnc_api, "service_appliance",
                                        obj_uuid=sa_uuid,
    ...
    def _validate_fabric_deletion(self, vnc_api, fabric_obj):
        ...
        for device_ref in fabric_obj.get_physical_router_back_refs() \
            ...
            device_obj = self._read_obj(vnc_api, "physical_router",
