...
class FilterModule(object):
    ...
    def _onboard_fabric(self, vnc_api, fabric_info, job_template_fqname):
        ...
        if fabric_info.get('vlan_vn_uniqueness_check') is not None:
            self._add_fabric_vlan_vn_uniqueness_check(
                vnc_api, fabric_obj, fabric_info.get('vlan_vn_uniqueness_check'))
    ...
    def _add_fabric_vlan_vn_uniqueness_check(vnc_api, fab, check):
        ...
        fab.set_vlan_vn_uniqueness_check(check)
        vnc_api.fabric_update(fab)
