...
class FilterModule(object):
    ...
    def device_import(self, job_ctx, prouter_name, prouter_vendor_name,
    ...
    def validate_interfaces_payload(self, payload):
        with open('/opt/contrail/fabric_ansible_playbooks/device_parsers/device_operation_schema/device_import_schema.json') as f:
            parser_output_schema = json.load(f)
        jsonschema.validate(payload, parser_output_schema)
    ...
    # group vnc functions
    @validate_payload
    def _create_interfaces_and_update_dataplane_ip(self, job_ctx, interfaces_payload, prouter_name, validator_method):
