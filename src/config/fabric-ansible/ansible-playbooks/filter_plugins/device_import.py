...
class FilterModule(object):
    ...
    def _create_interfaces_and_update_dataplane_ip(self, auth_token, interfaces_payload, prouter_name, validator_method):
        ...
        phy_intfs_success_names = self._create_physical_interfaces(vnc_lib, vnc_physical_interfaces_list)
        log_intfs_success_names = self._create_logical_interfaces(vnc_lib, vnc_logical_interfaces_list)
