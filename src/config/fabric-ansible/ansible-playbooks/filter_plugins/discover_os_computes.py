...
class FilterModule(object):
    ...
    def get_mapping_ip_to_hostname(self, vnc_api, fabric_uuid):
        ...
        self._logger.info("Found the following IP to Hostname mapping dictionary:  %s" % ip_to_hostname)
    ...
    @staticmethod
    def get_ip_address_juniper(device_command_output):
        """
    ...
    @staticmethod
    def get_dev_neighbors_details_juniper(device_command_output):
        """
    ...
    @staticmethod
    def get_system_description_juniper(device_neighbor_details):
        """
    ...
    def create_os_node(self, vnc_api, devices_command_output, fabric_uuid, cc_node_obj):
        ...
        each network device.Device that should be created as a node in Autodiscovery process must have "node_type"
        ...
        for device_command_output in devices_command_output['results']:
            device_ip_address = FilterModule.get_ip_address_juniper(device_command_output)
            device_hostname = FilterModule.get_hostname(ip_to_hostname, device_ip_address)
            devices_neighbors_details = FilterModule.get_dev_neighbors_details_juniper(device_command_output)
            for device_neighbor_details in devices_neighbors_details:
                system_description = FilterModule.get_system_description_juniper(device_neighbor_details)
