...
class FilterModule(object):
    ...
    def filters(self):
        return {
            ...
            'hitless_validate': self.hitless_validate
        }
    # end filters
    ...
    def hitless_validate(self, job_ctx, device_uuid_list):
        try:
            FilterLog.instance("HitlessUpgradeFilter")
            self.job_input = FilterModule._validate_job_ctx(job_ctx)
            self.fabric_uuid = self.job_input['fabric_uuid']
            ...
            results = self._hitless_validate()
            return results
        except Exception as ex:
    ...
    def _hitless_validate(self):
        ...
        for mm_dev in mm_dev_list:
            ...
            if physical_role == 'spine':
                ...
                if not found:
                    missing_roles.append(physical_role)
