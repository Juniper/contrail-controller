...
class PhysicalRouterCache(object):
    ...
    def __init__(self, pr, remote_vnc_api):
        ...
        user_credentials = remote_vnc_api.get_device_credentials(
            obj_uuid=pr.uuid,
            admin_password=FilterModule.remote_vnc_params.get(
                "admin_password"))
...
class FilterModule(object):
    ...
    def migrate_fabric_data(self, job_ctxt):
        ...
        try:
            ...
            FilterModule.remote_vnc_params = vnc_params
    ...
    @staticmethod
    def _get_fabric_credentials(remote_vnc_api, fabric):
    ...
    def _build_onboard_fabric_input(self, remote_vnc_api, fabric):
        ...
        device_credentials = FilterModule._get_fabric_credentials(
