...
class PhysicalRouterCache(object):
    ...
    def __init__(self, pr, remote_vnc_api, remote_vnc_admin_pwd):
        ...
        user_credentials = remote_vnc_api.get_device_credentials(
            uuid=pr.uuid, obj_type='physical_router',
        ...
        self.pr_json = {
            ...
            "physical_router_underlay_managed": True
...
class FilterModule(object):
    ...
    def _get_fabric_credentials(self, remote_vnc_api, fabric):
        credentials = remote_vnc_api.get_device_credentials(
            uuid=fabric.uuid, obj_type='fabric',
            admin_password=self.remote_vnc_params.get("admin_password"))
        return credentials
    ...
    def _build_onboard_fabric_input(self, remote_vnc_api, fabric):
        ...
        device_credentials = self._get_fabric_credentials(
            remote_vnc_api, fabric)
        job_input_json = {
    ...
    def _export_physical_router(self, remote_vnc_api, pr_uuid, fabric_fqname):
        ...
        pr_cache = PhysicalRouterCache(
            pr, remote_vnc_api, self.remote_vnc_params.get('admin_password'))
