    ...
    "job-templates": [
        {
            "job-template": {
                ...
                "job_template_input_schema": json.dumps({
                    "$schema": "http://json-schema.org/draft-06/schema#",
                    "additionalProperties": False,
                    "properties": {
                        "advanced_parameters": {
                ...
                'job_template_output_schema': json.dumps({
                    "$schema": "http://json-schema.org/draft-06/schema#",
                    "properties": {
                        "message": {
...
mock_upgrade_plan_result = {
    ...
    'report': "\n*************************** Summary ***************************\n\nTotal estimated duration is 2:00:00.\n\nNote that this time estimate may vary depending on network speeds and system capabilities.\nThe following batches of devices will be upgraded in the order listed:\n\nBatch 1:\n  device_5  17.1.1 --> 17.1.2  \n  device_7  17.1.1 --> 17.1.2  \n  device_3  17.1.1 --> 17.1.2  \n  device_8  17.1.1 --> 17.1.2  \n\nBatch 2:\n  device_6  17.1.1 --> 17.1.2  \n  device_2  17.1.1 --> 17.1.2  \n\nBatch 3:\n  device_4  17.1.1 --> 17.1.2  \n\nBatch 4:\n  device_1  17.1.1 --> 17.1.2  \n\n\n*************************** Details ***************************\n\nDetailed information for the devices to be upgraded is listed below:\n\n  - device_1\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e511\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.1\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : mx\n    physical role    : spine\n    routing bridging roles: []\n    role             : spine\n    vpg list         : []\n    vpg peers        : []\n    batch            : Batch 4\n    is hitless?      : True\n\n  - device_2\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e512\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.2\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : qfx\n    physical role    : leaf\n    routing bridging roles: []\n    role             : leaf\n    vpg list         : [u'dfb0cd32-46ca-4996-b155-806878d4e521']\n    vpg peers        : [u'dfb0cd32-46ca-4996-b155-806878d4e513']\n    batch            : Batch 2\n    is hitless?      : True\n\n  - device_3\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e513\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.3\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : qfx\n    physical role    : leaf\n    routing bridging roles: []\n    role             : leaf\n    vpg list         : [u'dfb0cd32-46ca-4996-b155-806878d4e521']\n    vpg peers        : [u'dfb0cd32-46ca-4996-b155-806878d4e512']\n    batch            : Batch 1\n    is hitless?      : True\n\n  - device_4\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e514\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.4\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : mx\n    physical role    : spine\n    routing bridging roles: []\n    role             : spine\n    vpg list         : []\n    vpg peers        : []\n    batch            : Batch 3\n    is hitless?      : True\n\n  - device_5\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e515\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.5\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : qfx\n    physical role    : leaf\n    routing bridging roles: []\n    role             : leaf\n    vpg list         : [u'dfb0cd32-46ca-4996-b155-806878d4e522']\n    vpg peers        : [u'dfb0cd32-46ca-4996-b155-806878d4e516']\n    batch            : Batch 1\n    is hitless?      : True\n\n  - device_6\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e516\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.6\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : qfx\n    physical role    : leaf\n    routing bridging roles: []\n    role             : leaf\n    vpg list         : [u'dfb0cd32-46ca-4996-b155-806878d4e522']\n    vpg peers        : [u'dfb0cd32-46ca-4996-b155-806878d4e515']\n    batch            : Batch 2\n    is hitless?      : True\n\n  - device_7\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e517\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.7\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : qfx\n    physical role    : leaf\n    routing bridging roles: []\n    role             : leaf\n    vpg list         : []\n    vpg peers        : []\n    batch            : Batch 1\n    is hitless?      : True\n\n  - device_8\n    uuid             : dfb0cd32-46ca-4996-b155-806878d4e518\n    vendor           : juniper\n    family           : qfx\n    product          : qfx-10000\n    serial number    : 12345\n    management ip    : 1.1.1.8\n    username         : root\n    password         : ** hidden **\n    new image version: 17.1.2\n    current image version: 17.1.1\n    image family     : qfx\n    physical role    : leaf\n    routing bridging roles: []\n    role             : leaf\n    vpg list         : []\n    vpg peers        : []\n    batch            : Batch 1\n    is hitless?      : True\n",
    'role_device_groups': {
        'spine': ['dfb0cd32-46ca-4996-b155-806878d4e514',
                  'dfb0cd32-46ca-4996-b155-806878d4e511'],
        'leaf': ['dfb0cd32-46ca-4996-b155-806878d4e515',
    ...
    'batches': [{
        'device_names': ['device_5', 'device_7', 'device_3', 'device_8'],
        'name': 'Batch 1',
        'device_list': ['dfb0cd32-46ca-4996-b155-806878d4e515',
                        'dfb0cd32-46ca-4996-b155-806878d4e517',
                        'dfb0cd32-46ca-4996-b155-806878d4e513',
                        'dfb0cd32-46ca-4996-b155-806878d4e518']
    }, {
        'device_names': ['device_6', 'device_2'],
        'name': 'Batch 2',
        'device_list': ['dfb0cd32-46ca-4996-b155-806878d4e516',
                        'dfb0cd32-46ca-4996-b155-806878d4e512']
    }, {
        ...
        'dfb0cd32-46ca-4996-b155-806878d4e515': {
            ...
            'vpg_info': {
                'buddies': [{
                    ...
                    'uuid': 'dfb0cd32-46ca-4996-b155-806878d4e516',
                    'mgmt_ip': '1.1.1.6',
                    'password': 'p\xc7\xbaU\xfa[\xfbD\x0ci\xa3\x19\x8d\x9c\x8bit\x18\x15u\x84\xc6\x0e\xb9 \xea\xba\xbbuM\xb3\x90',
            ...
            'basic': {
                ...
                'device_management_ip': '1.1.1.5',
                'device_username': 'root',
                'device_password': 'p\xc7\xbaU\xfa[\xfbD\x0ci\xa3\x19\x8d\x9c\x8bit\x18\x15u\x84\xc6\x0e\xb9 \xea\xba\xbbuM\xb3\x90'
            },
            'err_msgs': []
        },
...
class TestHitlessUpgradeFilters(test_case.JobTestCase):
    ...
    def init_test(self):
        self.mockFabric()
        self.mockJobTemplate("hitless_upgrade_strategy_template")
    ...
    def test_get_hitless_upgrade_plan(self):
        ...
        upgrade_plan = hitless_filter.get_hitless_upgrade_plan(mock_job_ctx,
                        mock_image_upgrade_list)
        self.assertEqual(upgrade_plan, mock_upgrade_plan_result)
    ...
    def test_get_next_batch(self):
        ...
        next_batch = hitless_filter.get_next_batch(mock_job_ctx,
                                                   mock_upgrade_plan,
                                                   DEV_UUID1)
        self.assertEqual(next_batch, mock_next_batch_result)

    def test_get_all_devices(self):
        hitless_filter = FilterModule()
        all_devices = hitless_filter.get_all_devices(mock_job_ctx,
                                                     mock_upgrade_plan)
        self.assertEqual(all_devices, mock_all_devices_result)

    def test_get_device_info(self):
        hitless_filter = FilterModule()
        device_info = hitless_filter.get_device_info(mock_job_ctx,
                                                     DEV_UUID1)
        self.assertEqual(device_info, mock_device_info_result)
        ...
        try:
            ...
            for jt in templates:
                if fqname == jt['job-template']['fq_name'][-1]:
                    ...
                    self._vnc_lib.job_template_create(job_template_obj)
        except Exception as ex:
...
"""
Notes:
- Added json.loads(schema) to job_manager/job_utils.py in build dir
- Added sys.path.append to hitless_upgrade_filters.py in build dir
  - sys.path.append("../fabric-ansible/ansible-playbooks/module_utils")
"""
