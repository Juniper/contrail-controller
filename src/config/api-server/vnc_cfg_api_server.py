...
class VncApiServer(object):
    ...
    def http_resource_create(self, obj_type):
        ...
        def stateful_create():
            ...
            if not ok:
                ...
                self.config_log(err_msg[1], level=SandeshLevel.SYS_ERR)
   ...
   # end
    ...
    def _db_init_entries(self):
        ...
        _, pm = self.create_singleton_entry(PolicyManagement())
        _, aps = self.create_singleton_entry(ApplicationPolicySet(
