...
class VncApiServer(object):
    ...
    def __init__(self, args_str=None):
        ...
        self.vnc_ifmap_server = VncIfmapServer(self)
        gevent.spawn(self.vnc_ifmap_server.run_http, '0.0.0.0', 8443,
                     workers=self._args.max_requests)
        gevent.spawn(self.vnc_ifmap_server.run_https, '0.0.0.0', 8444)
