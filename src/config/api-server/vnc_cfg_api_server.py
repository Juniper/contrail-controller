...
class VncApiServer(object):
   ...
   # end
    ...
    def _db_init_entries(self):
        ...
        self.create_singleton_entry(GlobalSystemConfig(
        ...
        self.create_singleton_entry(ApplicationPolicySet(
            parent_obj=pm_obj, all_applications=True))
    ...
    def create_singleton_entry(self, singleton_obj):
        s_obj = singleton_obj
