...
class Subnet(object):
    ...
    @classmethod
    def delete_cls(cls, subnet_name, notified=True, rm_all=False):
        # deletes the index allocator
        cls._db_conn.subnet_delete_allocator(subnet_name, notified, rm_all)
    # end delete_cls
...
class AddrMgmt(object):
    ...
    def net_update_notify(self, obj_id):
        ...
        for key in set(subnet_allocators.keys()) - set(subnets_fq_names):
    ...
    def net_delete_req(self, obj_dict):
        ...
        Subnet.delete_cls(vn_fq_name_str, notified=False, rm_all=True)
    ...
    def net_delete_notify(self, obj_id, obj_dict):
        vn_fq_name = obj_dict['fq_name']
        vn_fq_name_str = ':'.join(vn_fq_name)
        Subnet.delete_cls(vn_fq_name_str, rm_all=True)
