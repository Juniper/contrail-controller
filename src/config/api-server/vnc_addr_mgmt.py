...
class AddrMgmt(object):
    ...
    def _create_ipam_subnet_objs(self, ipam_fq_name_str, ipam_uuid, ipam_dict,
                                 should_persist):
    ...
    def ipam_create_req(self, obj_dict):
        ...
        if subnet_method is not None and subnet_method == 'flat-subnet':
            self._create_ipam_subnet_objs(ipam_fq_name_str, ipam_uuid, obj_dict,
                                          should_persist=True)
    # end ipam_create_req
        ...
        if 'ipam_subnet_method' in ipam_dict:
            if ipam_dict['ipam_subnet_method'] is not None:
                if (ipam_dict['ipam_subnet_method'] == 'flat-subnet'):
                    ...
                    self._create_ipam_subnet_objs(ipam_fq_name_str, ipam_uuid,
                                                  ipam_dict,
                                                  should_persist=False)
    ...
    def ipam_update_notify(self, obj_ids):
        ...
        ipam_fq_name_str = ':'.join(ipam_dict['fq_name'])
        ipam_uuid = obj_ids['uuid']
        self._create_ipam_subnet_objs(ipam_fq_name_str, ipam_uuid, ipam_dict,
                                     should_persist=False)
