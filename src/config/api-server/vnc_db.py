...
class VncServerKombuClient(VncKombuClient):
    ...
    def dbe_publish(self, oper, obj_type, obj_id, obj_dict=None):
        req_id = get_trace_id()
        ...
        if obj_dict is not None:
            ...
            if 'fq_name' in obj_dict:
                oper_info['fq_name'] = obj_dict['fq_name']
...
class VncDbClient(object):
    ...
    def dbe_update(self, obj_type, obj_uuid, new_obj_dict):
        ...
        self._msgbus.dbe_publish('UPDATE', obj_type, obj_uuid)
    ...
    def dbe_delete(self, obj_type, obj_uuid, obj_dict):
        ...
        # publish to message bus (rabbitmq)
        self._msgbus.dbe_publish('DELETE', obj_type, obj_uuid, obj_dict)
