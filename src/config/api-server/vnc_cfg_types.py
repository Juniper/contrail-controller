...
class VirtualMachineInterfaceServer(Resource, VirtualMachineInterface):
    ...
    def pre_dbe_update(cls, id, fq_name, obj_dict, db_conn):
        ...
        if (old_vnic_type  != new_vnic_type):
            return (False, (500, "Vnic_type can not be modified"))
...
class VirtualNetworkServer(Resource, VirtualNetwork):
    ...
    def _check_provider_details(cls, obj_dict, db_conn):
        ...
        if seg_id <=0 or seg_id > 4094:
            return (False, "Segmenation id must be in between 1-4094")
    ...
    def pre_dbe_update(cls, id, fq_name, obj_dict, db_conn):
        ...
        try:
            (read_ok, vmi_result) = db_conn.dbe_read('virtual-network', vn_id, 
                                               obj_fields=['vmi_refs'])
        except cfgm_common.exceptions.NoIdError as e:
            return (False, (404, str(e)))
        if not read_ok:
            return (False, (500, vmi_result))
