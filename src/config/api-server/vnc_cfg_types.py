...
class ResourceDbMixin(object):
    ...
    @classmethod
    def get_post_dbe_delete_args(cls, id, obj_dict, db_conn):
        return True, {}
...
class FloatingIpServer(Resource, FloatingIp):
    ...
    @classmethod
    def get_post_dbe_delete_args(cls, id, obj_dict, db_conn):
        return  cls.addr_mgmt.get_ip_free_args(obj_dict['fq_name'][:-2])
    # end get_post_dbe_delete_args
...
class AliasIpServer(Resource, AliasIp):
    ...
    @classmethod
    def get_post_dbe_delete_args(cls, id, obj_dict, db_conn):
        return  cls.addr_mgmt.get_ip_free_args(obj_dict['virtual_network_refs'][0]['to'])
    # end get_post_dbe_delete_args
