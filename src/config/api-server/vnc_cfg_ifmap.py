        ...
        def wrapper1(func):
            def wrapper2(self, obj_type, obj_ids, obj_dict):
                ...
                try:
                    ...
                    msg = 'RBAC(%s): missing perms2 for obj %s, name %s:%s' % (oper, obj_uuid, obj_type, fq_name)
                    self.config_log(msg, level=SandeshLevel.SYS_NOTICE)
                ...
                try:
                    ...
                    msg = 'RBAC(%s): missing perms2 in dict obj %s, name %s:%s' % (oper, obj_uuid, obj_type, fq_name)
                    self.config_log(msg, level=SandeshLevel.SYS_NOTICE)
                    return (ok, result)
