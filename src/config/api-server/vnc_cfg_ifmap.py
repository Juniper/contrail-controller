...
class VncCassandraClient(VncCassandraClientGen):
    ...
    def _cassandra_init(self, server_list):
        ...
        uuid_ks_name = '%s_%s' %(self._db_prefix, VncCassandraClient._UUID_KEYSPACE_NAME)
        ...
        useragent_ks_name = '%s_%s' %(self._db_prefix, VncCassandraClient._USERAGENT_KEYSPACE_NAME)
