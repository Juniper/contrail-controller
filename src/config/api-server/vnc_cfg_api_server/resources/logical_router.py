...
class LogicalRouterServer(ResourceMixin, LogicalRouter):
    ...
    def pre_dbe_create(cls, tenant_name, obj_dict, db_conn):
        ...
        cls.create_job_transaction(
            cls.server, db_conn,
            "Logical Router {} Create".format(obj_dict['display_name']),
    ...
    def pre_dbe_update(cls, id, fq_name, obj_dict, db_conn, **kwargs):
        ...
        cls.create_job_transaction(
            cls.server, db_conn,
            "Logical Router {} Update".format(obj_dict['display_name']),
            pr_refs=obj_dict.get('physical_router_refs', []) +
    ...
    def pre_dbe_delete(cls, id, obj_dict, db_conn):
        ...
        cls.create_job_transaction(
            cls.server, db_conn,
            "Logical Router {} Delete".format(obj_dict['display_name']),
            pr_refs=obj_dict.get('physical_router_refs', []))
