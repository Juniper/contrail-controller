...
class VirtualMachineInterfaceServer(ResourceMixin, VirtualMachineInterface):
    ...
    @classmethod
    def _check_unique_vn_vlan_in_vpg(cls, db_conn, api_server,
                                     vpg_uuid, vn_uuid,
                                     vlan_id, validation):
    ...
    @classmethod
    def _add_unique_vn_vlan_in_vpg(cls, db_conn, api_server,
                                   vpg_uuid, vn_uuid,
                                   vlan_id, validation):
    ...
    @classmethod
    def _check_add_one_untagged_vlan(cls, db_conn, api_server,
                                     vpg_uuid, vlan_id, is_untagged,
                                     validation):
    ...
    @classmethod
    def _check_same_vn_vlan_exists(cls, db_conn, api_server,
    ...
    @classmethod
    def _check_serviceprovider_fabric(cls, db_conn, api_server,
                                      zk_vpg_lock_path, vpg_uuid,
                                      vn_uuid, vlan_id, is_untagged_vlan):
    ...
    @classmethod
    def _check_enterprise_fabric(cls, db_conn, api_server,
                                 zk_vpg_lock_path, zk_fabric_lock_path,
