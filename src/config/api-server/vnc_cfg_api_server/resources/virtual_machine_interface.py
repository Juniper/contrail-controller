...
class VirtualMachineInterfaceServer(ResourceMixin, VirtualMachineInterface):
    ...
    def pre_dbe_create(cls, tenant_name, obj_dict, db_conn):
        ...
        if kvps:
            ...
            ok, (vlan_id, is_untagged_vlan, links) = cls.get_vlan_id(obj_dict)
            if not ok:
                return False, (400, "Cannot get vlan_id")
            if links:
    ...
    def pre_dbe_update(cls, id, fq_name, obj_dict, db_conn,
        ...
        if kvps:
            ...
            if vnic_type == 'baremetal':
                ok, (vlan_id, is_untagged_vlan, links) = cls.get_vlan_id(obj_dict)
                if not ok:
                    return False, (400, 'Cannot get vlan_id'), zk_update_kwargs
    ...
    def _delete_serviceprovider_validations_znodes(cls, obj_dict, db_conn, vpg_uuid):
        ...
        ok, (vlan_id, is_untagged_vlan, links) = cls.get_vlan_id(obj_dict)
        if not ok:
            return ok, (400, "Cannot get vlan_id")
