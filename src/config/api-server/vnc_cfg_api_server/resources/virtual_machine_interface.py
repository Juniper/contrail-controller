    ...
    def _check_vlanid_vn_mapping(cls, all_vpgs, vn_uuid, vlan_id):
        ...
        if vpg_uuid_list:
            ...
            for vpg in vpgs:
                ...
                vmi_uuid_list = [ref['uuid'] for ref in all_vmis]
                if vmi_uuid_list:
                    ...
                    for vmi in vmis:
                        ...
                        if vn_uuid in vn_uuids:
                            # The VN of current VMI has already been used
                            # in fabric.
                            ...
                            kvps = bindings.get('key_value_pair') or []
                            kvp_dict = cls._kvp_to_dict(kvps)
                            tor_port_vlan_id = kvp_dict.get('tor_port_vlan_id',
                                                            0)
                            ...
                            if vlan_id_in_db != vlan_id:
                                msg = 'One VN can only be assigned only one '\
                                      'VLAN ID in a Enterprise style Fabric'
                                return (False, (400, msg))
        return True, ''
