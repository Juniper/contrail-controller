            ...
            if pi_type and (
                ...
                return (False, (400, "Cannot set physical interface type: "
                                ...
                                % (obj_dict.get('physical_interface_type'),
                                   pi_type)))
        elif 'physical_interface_type' in obj_dict:
            if pi_type:
                return (False, (400, "Cannot set physical interface type: "
                                     "%s on already existing %s "
                                     "type interface "
