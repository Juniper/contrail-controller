...
class EventDispatcher(object):
    ...
    def _subscribe_client_queue(cls, client_queue, resource_type):
        if not cls._watchers.get(resource_type, None):
            cls._watchers.update({resource_type: ResourceWatcher()})
        watcher = cls._watchers.get(resource_type)
    ...
    def dispatch(self):
        while True:
            ...
            self.process_notification(
                ...
                [q for q in self._watchers.get(resource_type).queues])
    # end dispatch
