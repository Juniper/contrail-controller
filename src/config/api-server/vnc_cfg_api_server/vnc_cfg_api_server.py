...
class VncApiServer(object):
   ...
   # end
    ...
    def _get_hbs_network(self, vn_uuid, vn_k8s_str, namespace):
        ...
        hbs_nw['metadata']['annotations']['opencontrail.org/network'] = hbs_class._get_network(vn_fq_name)
    ...
    def _get_hbs_ds(self, hbs_info):
        ...
        if hbs_info['vnmgmt']['fq_name']:
            ds_template['metadata']['annotations']['opencontrail.org/networks'] = \
                        hbs_class._get_network(hbs_info['vnmgmt']['fq_name'])
    ...
    def hbs_get(self):
        ...
        namespace_template = hbs_class._get_hbs_namespace(hbs_info['namespace'])
