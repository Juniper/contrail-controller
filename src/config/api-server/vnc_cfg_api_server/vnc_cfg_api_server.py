        ...
        try:
            ...
            if obj_type == 'physical_router':
                ...
                device_credentials.append({'username': result.get('physical_router_user_credentials').get('username'),
                                           'password': result.get('physical_router_user_credentials').get('password')})
            ...
            if obj_type == 'fabric':
                ...
                for dev_cred in result['fabric_credentials']['device_credential']:
                    device_credentials.append({'username': dev_cred.get('credential').get('username'), 'password': dev_cred.get('credential').get('password')})
