   ...
   # end
    ...
    def _load_extensions(self):
        try:
            ...
            resync_extension_manager = None
            if self._args.auth != 'no-auth':
                resync_extension_manager = ExtensionManager(
                ...
                self._extension_mgrs['resync'] = resync_extension_manager
            self._extension_mgrs['resourceApi'] = ExtensionManager(
                ...
                api_server_port=self._args.listen_port,
                conf_sections=conf_sections, sandesh=self._sandesh,
                resync_extension_manager=resync_extension_manager)
