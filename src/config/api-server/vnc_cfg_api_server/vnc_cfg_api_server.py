...
class VncApiServer(object):
    ...
    def job_mgr_signal_handler(self, signalnum, frame):
        ...
        if resp.status_code == 200:
            ...
            for PRObjectLog in PRouterOnboardingLog:
                ...
                prouter_uve_name = device_fqname + ":" + self.fabric_job_uve_name
        ...
        try:
            ...
            if self.device_list:
                for device_id in self.device_list:
                    device_fqname = request_params.get('device_json').get(device_id).get('device_fqname')
    ...
    def read_fabric_data(self, request_params):
        ...
        if request_params.get('input').get('fabric_uuid'):
            ...
            if "device_deletion_template" in request_params.get('job_template_fq_name'):
