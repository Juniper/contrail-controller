...
class TestExecuteJob(test_case.ApiServerTestCase):
    ...
    def test_get_device_credentials(self):
        ...
        dev_creds = self._vnc_lib.get_device_credentials(obj_uuid=fabric_uuid, admin_password='c0ntrail123')
        ...
        dev_creds = self._vnc_lib.get_device_credentials(obj_uuid=pr_uuid, admin_password='c0ntrail123')
        self.assertIsNotNone(dev_creds)
