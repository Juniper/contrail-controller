...
class TestVirtualPortGroup(TestVirtualPortGroupBase):
    ...
    def _test_sp_add_new_pi_to_vmi(
        ...
        tagged_validation_path = os.path.join(
            ...
            % (vpg_obj.uuid, vn1_obj.uuid, vlan_1))
        ...
        untagged_validation_path = os.path.join(
            _DEFAULT_ZK_SERVICE_PROVIDER_FABRIC_VALIDATION_PATH_PREFIX,
            'virtual-port-group:%s/untagged' % vpg_obj.uuid)
    ...
    def _test_sp_update_vlan_in_vmi_in_same_vpg(
        ...
        tagged_validation_path = os.path.join(
            _DEFAULT_ZK_SERVICE_PROVIDER_FABRIC_VALIDATION_PATH_PREFIX,
            ('virtual-port-group:%s/virtual-network:%s/vlan:%s')
            % (vpg_obj.uuid, vn1_obj.uuid, vlan_3))
        # Read Znodes
        ...
        tagged_validation_path = os.path.join(
            _DEFAULT_ZK_SERVICE_PROVIDER_FABRIC_VALIDATION_PATH_PREFIX,
            ('virtual-port-group:%s/virtual-network:%s/vlan:%s')
            % (vpg_obj.uuid, vn2_obj.uuid, vlan_4))
        # Read Znode
