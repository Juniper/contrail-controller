...
class TestVirtualPortGroup(TestVirtualPortGroupBase):
    ...
    def test_single_vn_in_vpg_for_enterprise(self):
        proj_obj, fabric_obj, pr_obj = self._create_prerequisites()
    ...
    def test_same_vlan_for_same_vn_across_fabric_in_enterprise(self):
        proj_obj, fabric_obj, pr_obj = self._create_prerequisites()
    ...
    def test_different_vlan_for_same_vn_across_fabric_in_enterprise(self):
        proj_obj, fabric_obj, pr_obj = self._create_prerequisites()
        ...
        # Unlike test_same_vlan_for_same_vn_across_fabric_in_enterprise, we
    ...
    def test_two_vns_with_same_vlan_in_vpg_for_service_provider(self):
        proj_obj, fabric_obj, pr_obj = self._create_prerequisites(
            enterprise_style_flag=False)
    ...
    def test_two_vns_with_different_vlan_in_vpg_for_service_provider(self):
        proj_obj, fabric_obj, pr_obj = self._create_prerequisites(
            enterprise_style_flag=False)
