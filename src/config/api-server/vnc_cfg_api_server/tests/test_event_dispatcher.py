...
def TestPack(unittest.TestCase):
    def test_pack(self):
...
def TestRegisterClient(unittest.TestCase):
    def setUp(self):
...
def TestNotifyEventDispatcher(unittest.TestCase):
    def setUp(self):
        self._dispatcher = EventDispatcher()
...
def TestDispatch(unittest.TestCase):
    def setUp(self):
        self._dispatcher = EventDispatcher()
...
def TestInitialize(unittest.TestCase):
    def setUp(self):
        self._dispatcher = EventDispatcher()
        mockVncDBClient = flexmock(
