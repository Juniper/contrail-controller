...
# start class TestLogicalInterface
class TestLogicalInterface(test_case.ApiServerTestCase):
    ...
    def test_logical_interface_create_qfx_l2(self):
        ...
        regex_msg = "Vlan ids \[1, 2, 4094\] are not allowed on " \
                    "QFX logical interface"\
                    " type: l2"
        self.assertRaisesRegexp(PermissionDenied, regex_msg,
    ...
    def test_logical_interface_update_qfx_l2(self):
        ...
        regex_msg = "Vlan ids \[1, 2, 4094\] are not " \
                    "allowed on QFX logical interface"\
                    " type: l2"
