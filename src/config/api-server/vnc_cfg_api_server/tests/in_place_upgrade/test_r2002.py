...
class TestInPlaceUpgradeR2002(test_case.InPlaceUpgradeTestCase):
    ...
    def test_instance_ip_create(self):
        prop_map = {
            ...
            'instance_ip_mode': None,
            'secondary_ip_tracking_ip': None,
            'subnet_uuid': None,
            'instance_ip_subscriber_tag': None,
            'instance_ip_secondary': None,
            'instance_ip_local_ip': None,
            'service_instance_ip': None,
            'service_health_check_ip': None,
            'instance_ip_subnet': SubnetType(ip_prefix='10.100.0.0',
                                             ip_prefix_len=16),
            'annotations': {},
    ...
    def test_virtual_dns_record_create(self):
        domain = Domain(name='custom')
        self.api.domain_create(domain)

        virtual_dns = VirtualDns('inplaceupgrade', parent_obj=domain)
