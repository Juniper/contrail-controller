...
class TestInPlaceUpgradeR2002(test_case.InPlaceUpgradeTestCase):
    ...
    def test_device_chassis_basic_crud(self):
        prop_map = {'name': 'dc-%s' % self.id(),
                    'annotations': {"key": "val"},
                    'device_chassis_type': 'some_string',
    ...
    def test_device_functional_group(self):
        ...
        dfg = self.set_properties(DeviceFunctionalGroup(), prop_map)
    ...
    def test_hardware_inventory_basic_crud(self):
        prop_map = {'name': 'hi-%s' % self.id(),
                    'annotations': {"key": "val"},
                    'display_name': 'some_string',
                    'hardware_inventory_inventory_info': 'some_string'}
    ...
    def test_physical_router_basic_crud(self):
        prop_map = {'name': 'pr-%s' % self.id(),
                    'annotations': {"key": "val"},
                    'display_name': 'some_string',
                    'physical_router_autonomous_system': ':class:`.AutonomousSystemsType`',
                    'physical_router_dataplane_ip': 'some_string',
                    'physical_router_device_family': 'some_string',
                    'physical_router_dhcp_parameters': ':class:`.DnsmasqLeaseParameters`',
                    'physical_router_encryption_type': 'some_string',
    ...
    def test_storm_control_profile_basic_crud(self):
        prop_map = {'name': 'scp-%s' % self.id(),
                    'annotations': {"key": "val"},
                    'display_name': 'some_string',
                    'storm_control_parameters': ':class:`.StormControlParameters`'}
    ...
    def test_sflow_profile_basic_crud(self):
        prop_map = {'name': 'sfp-%s' % self.id(),
                    'annotations': {"key": "val"},
                    'display_name': 'some_string',
                    'sflow_parameters': ':class:`.SflowParameters`',
    ...
    def test_routing_instance_service_chain_info(self):
        prop_map = {'name': 'ri-%s' % self.id(),
                    'annotations': {"key": "val"},
                    'default_ce_protocol': ':class:`.DefaultProtocolType`',
                    'display_name': 'some_string',
                    'evpn_ipv6_service_chain_information': ':class:`.ServiceChainInfo`',
                    'evpn_service_chain_information': ':class:`.ServiceChainInfo`',
                    'ipv6_service_chain_information': ':class:`.ServiceChainInfo`',
                    'routing_instance_fabric_snat': False,
                    'routing_instance_has_pnf': False,
                    'routing_instance_is_default': False,
                    'service_chain_information': ':class:`.ServiceChainInfo`',
