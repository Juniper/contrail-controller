    ...
    def validate_request(self, request):
        ...
        for rule in rule_list:
            if (rule['rule_object'] == '*'):
                ...
                if (rule['rule_field'] != '') and (rule['rule_field'] is not None):
        ...
        if len(field_rule_list) != 0:
           ...
           if obj_dict.keys() is None:
            ...
            return self._match_rule(rule, roles, api_op)
        else:
