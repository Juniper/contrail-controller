...
class TestPermissions(test_case.ApiServerTestCase):
    ...
    def test_api_access(self):
        ...
        print
        print '####### API ACCESS (update field restricted to admin) ##############'
        ...
        print 'alice: try deleting VN .. should fail'
        ...
        print "Bob should'nt be able to create VN in alice project because only\n "
        print 'owner (alice) has write permission in her project'
        ...
        print
        print '######### READ (SHARED WITH ANOTHER TENANT) ############'
        ...
        print
        print '########### READ (DISABLE READ SHARING) ##################'
        print 'Disable share in virtual networks for others'
        set_perms(vn, share = [])
        alice.vnc_lib.virtual_network_update(vn)
