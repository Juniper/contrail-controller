...
class TestVncCfgApiServer(test_case.ApiServerTestCase):
    ...
    def test_allocate_vn_id_on_create_notification(self):
        ...
        with test_common.flexmocks([(mock_zk, 'alloc_vn_id', lambda x: None)]):
            self._vnc_lib.virtual_network_create(vn_obj)
        gevent.sleep(0.1)
    ...
    def test_deallocate_vn_id_on_delete_notification(self):
        ...
        with test_common.flexmocks([(mock_zk, 'free_vn_id', lambda x: None)]):
            self._vnc_lib.virtual_network_delete(id=vn_obj.uuid)
        gevent.sleep(0.1)
    ...
    def test_deallocate_sg_id_on_delete_notification(self):
        ...
        with test_common.flexmocks([(mock_zk, 'free_sg_id', lambda x: None)]):
            self._vnc_lib.security_group_delete(id=sg_obj.uuid)
        gevent.sleep(0.1)
