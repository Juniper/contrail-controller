...
class TestLogicalRouter(test_case.ApiServerTestCase):
    ...
    def get_internal_lr_vn(self, uuid):
    ...
    def test_vxlan_routing_for_internal_vn(self):
        ...
        int_vn_name = self.get_internal_lr_vn(lr_uuid)
        ...
        try:
            ...
            logger.debug('FAIL - Project cant be udpated with vxlan_routing when LR exists')
            assert(False)
