...
class TestIpAlloc(test_case.ApiServerTestCase):
    ...
    def test_subnet_alloc_unit(self):
        ...
        ipam_sn_v4 = IpamSubnetType(subnet=SubnetType('11.1.1.0', 24), alloc_unit=3)
        ...
        ipam_sn_v6 = IpamSubnetType(subnet=SubnetType('fd14::', 120), alloc_unit=3)
        ...
        vn.del_network_ipam(ipam)
        # Create subnets
        #ipam_sn_v4 = IpamSubnetType(subnet=SubnetType('11.1.1.0', 24), addr_from_start=True, alloc_unit=4)
        ipam_sn_v4 = IpamSubnetType(subnet=SubnetType('11.1.1.0', 24), alloc_unit=4)
        ipam_sn_v6 = IpamSubnetType(subnet=SubnetType('fd14::', 120), alloc_unit=4)
