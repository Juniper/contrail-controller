...
sys.path.insert(0, os.path.realpath('../../../../build/debug/pysandesh/gen_py/sandesh_ctrl/ttypes'))
sys.path.insert(0, os.path.realpath('../../../../build/debug/sandesh/library/python'))
sys.path.insert(0, os.path.realpath('../../../../build/debug/cfgm/api-server/vnc_cfg_api_server'))
...
class DemoFixture(fixtures.Fixture):
    ...
    def setUp(self):
        ...
        proj_1_fixt = self.useFixture(gen.vnc_api_test_gen.ProjectTestFixtureGen(self._vnc_lib, 'proj-3', dom_fixt)) 
        proj_2_fixt = self.useFixture(gen.vnc_api_test_gen.ProjectTestFixtureGen(self._vnc_lib, 'proj-4', dom_fixt)) 
...
if __name__ == '__main__':
    '''
       ...
       PYTHONPATH=build/debug/cfgm/api-server:build/debug/cfgm/api-server/vnc_cfg_api_server:build/debug/api-lib:build/debug/api-lib/vnc_api python  src/cfgm/api-server/tests/test_crud_basic_sys.py
    '''
    c = ConfigParams ()
    c.set_defaults ()
    try:
