...
class TestFw(test_case.ApiServerTestCase):
    ...
    def test_tag_basic_sanity(self):
        ...
        self._vnc_lib.set_tag(vn_obj, 'global:deployment=Production')
    ...
    def test_firewall_rule_using_ep_ag_tag(self):
        ...
        with ExpectedException(BadRequest) as e:
            self._vnc_lib.set_tag(ag_obj, 'global:deployment=%s' % tag_value)
        self._vnc_lib.set_tag(ag_obj, 'global:label=RedVlan')
    ...
    def test_firewall_rule_service(self):
        ...
        # update service (negative and positive)
