...
class ResourceApiDriver(vnc_plugin_base.ResourceApi):
    ...
    def _update_subnet_id(self, new_refs, old_refs):
            ...
            if ipam_refs:
                for ipam_ref in ipam_refs:
                    ...
                    for ipam_subnet in ipam_subnets:
                        ...
                        subnet_name = vn_dict['uuid'] + ' ' + str(network))
    ...
    def post_virtual_network_create(self, vn_dict):
        self._update_subnet_id(vn_dict.get('network_ipam_refs'), None)
