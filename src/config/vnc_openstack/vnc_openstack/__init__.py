...
class OpenstackDriver(vnc_plugin_base.Resync):
    ...
    def ks_project_get(self, id=None, name=None):
        self._get_keystone_conn()
        return self._ks_project_get(id, name)

    def sync_project_to_vnc(self, id=None, name=None):
        self._get_keystone_conn()
        return self._sync_project_to_vnc(id, name)
