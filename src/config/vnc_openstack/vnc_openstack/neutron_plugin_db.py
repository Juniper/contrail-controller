...
class DBInterface(object):
    ...
    # TODO(Pawel Zadrozny): finish removing
    def tags_remove(self, context, parent_id, tags):
        # 1. Get taggable object
        # 2. Remove tag references and update object
        pass

    # TODO(Pawel Zadrozny): finish removing all
    def tags_remove_all(self, context, parent_id):
        # 1. Get taggable object
        # 2. Remove all tag references and update object
        pass
