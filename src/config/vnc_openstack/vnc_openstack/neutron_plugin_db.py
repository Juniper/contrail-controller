...
class DBInterface(object):
    ...
    def _floatingip_neutron_to_vnc(self, context, fip_q, oper):
        if oper == CREATE:
            ...
            try:
                ...
                self._raise_contrail_exception(404, FloatingIPNotFound(floatingip_id=fip_q['id']))
    ...
    def floatingip_delete(self, fip_id):
        try:
            ...
            self._raise_contrail_exception(404, FloatingIPNotFound(floatingip_id=fip_id))
