        ...
        if ip_back_refs:
            for ip_back_ref in ip_back_refs:
                ...
                if ip_obj.get_service_instance_ip():
                    primary_ip = False
                    si_ref = ip_obj.get_service_instance_back_refs()[0]
                    try:
                        si_obj = self._vnc_lib.service_instance_read(
                            id=si_ref['uuid'])
                    except NoIdError:
                    ...
                    st_ref = si_obj.service_template_refs[0]
                    try:
                    ...
                    # To support v1 service-instances
                    if st_obj.service_template_properties.version == 1:
                        primary_ip = True
