...
class DBInterface(object):
    ...
    def _network_vnc_to_neutron(self, net_obj, net_repr='SHOW', context=None):
        ...
        if net_obj.is_shared or (net_obj.perms2 and self._shared_with_tenant(context, net_obj.perms2.share)):
        ...
        for net_obj in all_net_objs:
            ...
            if net_obj.is_shared is None:
                is_shared = False
                             ...
                             net_obj.perms2 and self._shared_with_tenant(context, net_obj.perms2.share)):
                is_shared = True
            else:
                is_shared = False
