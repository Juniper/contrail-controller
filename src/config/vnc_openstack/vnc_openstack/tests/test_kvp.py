...
class NetworkKVPTest(test_case.ResourceDriverTestCase):
    ...
    def test_network_create(self):
        ...
        self._vnc_lib.ref_update('virtual-network', net_obj.uuid, 'network-ipam', None, self._ipam_obj.get_fq_name(), 'ADD', VnSubnetsType([ipam_sn_3]))
        ...
        self._vnc_lib.ref_update('virtual-network', net_obj.uuid, 'network-ipam', None, self._ipam_obj.get_fq_name(), 'DELETE')
        kvp = self._vnc_lib.kv_retrieve()
