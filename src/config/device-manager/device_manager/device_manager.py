...
class DeviceManager(object):
    REACTION_MAP = {
        ...
        'service_endpoint': {
            ...
            'service_connection_module': ['service_object'],
            'service_object': [],
        },
        'service_connection_module': {
            'self': ['service_endpoint',
                     'service_object'],
            'service_endpoint': ['service_object'],
            'service_object': [],
        },
        'service_object': {
            'self': ['service_connection_module',
                     'service_endpoint'],
            'service_endpoint': ['physical_router'],
            'service_connection_module': ['physical_router'],
        },
        'network_device_config': {
            'self': ['physical_router'],
            'physical_router': [],
