...
class AnsibleRoleCommon(AnsibleConf):
    ...
    def add_routing_instance(self, ri_conf):
        ...
        if ri_conf.get("encapsulation_priorities"):
            encapsulation_priorities = \
              ri_conf.get("encapsulation_priorities")
        else:
           encapsulation_priorities.append("MPLSoGRE")
        ...
        if not is_l2:
            ...
            elif encapsulation_priorities in ["MPLSoGRE", "MPLSoUDP"]:
