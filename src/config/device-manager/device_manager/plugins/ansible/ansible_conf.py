...
class AnsibleConf(AnsibleBase):
    ...
    def update_system(self):
        ...
        if self.physical_router.user_credentials:
            credentials = Credentials(
                user_name=self.physical_router.user_credentials.username,
                password=self.physical_router.user_credentials.password)
    ...
    def has_conf(self):
        return self.system or self.interfaces_config
    # end has_conf
