        ...
        for sindex, sep_uuid in \
            ...
            for scm_id in sep.service_connection_modules:
                ...
                if scm is None:
                    ...
                    continue
                if not scm.annotations:
                    self._logger.info("SCM info is NULL for node=%s, sep=%s" %
                                      (self.physical_router.name, sep.name))
                    continue
                ...
                if peer_seps is not None:
                    ...
                    for peer_sep_uuid  in peer_seps:
                        ...
                        if peer_pr_entry is not None:
                            ...
                            peer_router_lpbk_id = \
                            peer_pr_entry.physical_router_loopback_ip
                ...
                if service_type == 'fabric-interface' and \
                   service_fabric == False:
                    ps_config = None
                    self.add_e2_phy_logical_interface(self, li.name,
                    ...
                    self.add_e2_services_l2ckt_config_xml(self, node_role,
