...
class JuniperConf(DeviceConf):
    ...
    def dv_send(self, conf, default_operation="merge",
                     operation="replace"):
    ...
    def send_conf(self, is_delete=False):
        ...
        return self.dv_send(conf, default_operation, operation)
    # end send_conf
