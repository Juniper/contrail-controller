...
class SecurityGroupFeature(FeatureBase):
    ...
    def __init__(self, logger, physical_router, configs):
        ...
        super(SecurityGroupFeature, self).__init__(logger, physical_router,
                                                  configs)
    # end __init__
    ...
    def _attach_acls(self, interface, unit):
        ...
        for vpg_uuid in pr.virtual_port_groups or []:
            print "XXX Interface config -for"
...
#        Will remove after review. part of the orginal code in ansible_role_common. But is 
#        it valid. Couldnt make it work. We read the sg list from VPG already.
#        if interface.li_uuid:
#            interface = db.LogicalInterfaceDM.find_by_name_or_uuid(interface.li_uuid)
#            if interface:
