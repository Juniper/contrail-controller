...
class VnInterconnectFeature(FeatureBase):
    ...
    def _build_ri_config(self, vn, ri_obj, vn_list, is_master_int_vn):
        gevent.idle()
        ...
        lr_obj = db.LogicalRouterDM.get(vn.logical_router)
        ...
        if not is_master_int_vn:
            ...
            ri = RoutingInstance(
                name=ri_name, description=ri_description, virtual_network_mode='l3',
    ...
    def feature_config(self, **kwargs):
        ...
        for internal_vn, vn_list in list(vn_map.items()):
            ...
            ri = self._build_ri_config(vn_obj, ri_obj, vn_list,
                                       is_master_int_vn)
