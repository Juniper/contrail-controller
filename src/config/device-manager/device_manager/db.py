...
class FeatureFlagDM(DBBaseDM, FeatureFlagBase):
    _dict = {}
    _dict['release_version'] = '_default_'
    _dict['feature_flags'] = {}
    _dict['callbacks'] = {}
    ...
    def update(self, obj=None):
        ...
        if old_fflag and \
           (old_fflag.get('feature_flag_version') != new_fflag.get('feature_flag_version')):
            self._logger.error('Cannot change version of %s from %s to %s' %
                                (obj['fq_name'], old_fflag.get('feature_flag_version'),
    ...
    def uve_send(self):
        ...
        if fflag:
           fflag_trace = UveFeatureFlagConfig(name=fflag.get('feature_name'),
           ...
           fflag_msg = UveFeatureFlagConfigTrace(data=fflag_trace, sandesh=DBBaseDM._sandesh)
