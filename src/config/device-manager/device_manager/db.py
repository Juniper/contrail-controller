...
class PhysicalRouterDM(DBBaseDM):
    ...
    def set_associated_port_tuple(self, pt_uuid):
        self.port_tuples.append(pt_uuid)

    def remove_associated_port_tuple(self, pt_uuid):
    ...
    def get_sa_obj(self):
        ...
        if si_obj.service_template is not None:
            ...
            if svc_tmpl_obj.service_appliance_set is not None:
                ...
                if svc_appliance_set_obj.service_appliances is not None:
                    svc_appliance_obj =  ServiceApplianceDM.get(svc_appliance_set_obj.service_appliances[0])
    ...
    def build_pt_pr_map(self):
        ...
        if sa_obj is not None:
            for pi in sa_obj.physical_interfaces or []:
                 pi_obj = PhysicalInterfaceDM.get(pi['uuid'])
