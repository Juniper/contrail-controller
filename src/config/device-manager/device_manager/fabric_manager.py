...
class FabricManager(object):
    ...
    # Internal function to create virtual network
    def _create_ipv6_ll_ipam_virtual_network(self, vnc_api, network_name):
        # create internal ipv6 link local subnet
        nw_fq_name = ['default-domain', 'default-project', network_name]
        ipam_fq_name = ['default-domain', 'default-project', 'ipv6_link_local']
        subnets = VnSubnetsType([(IpamSubnetType(subnet =
                                                 SubnetType('fe80::', 64),
                      default_gateway = 'fe80::1', addr_from_start = True,
        ...
        """
        self._logger.error('creating virtual network %s' % network_name)
    ...
    # end _create_ipv6_ll_ipam_virtual_network
    ...
    def _load_init_data(self):
        ...
        # add internal IPV6 VN and attach to IPV6 link local IPAM
        self._create_ipv6_ll_ipam_virtual_network(
                                            self._vnc_api,
