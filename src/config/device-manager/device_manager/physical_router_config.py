...
class PhysicalRouterConfig(object):
    ...
    '''
     ...
     supported_highest_enapsulation_priority: highest encapsulation configured but supported by device
    '''
    ...
    def add_routing_instance(self, ri_conf):
        ...
        supported_highest_enapsulation_priority = \
                  ri_conf.get("supported_highest_enapsulation_priority") or "VXLAN"
        ...
        if not is_l2:
            ...
            if supported_highest_enapsulation_priority == "VXLAN":
                ri.set_instance_type("virtual-switch")
            elif supported_highest_enapsulation_priority == "MPLSoGRE":
