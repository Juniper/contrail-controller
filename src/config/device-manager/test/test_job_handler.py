...
class TestJobHandler(unittest.TestCase):
    ...
    def test_job_executed_successfully(self):
        ...
        self.vnc_api_obj.job_status_http_get.return_value = self.JOB_SUCCESS
        ...
        self.assertEqual(self.vnc_api_obj.job_status_http_get.call_count, 1)
    ...
    def test_job_stays_in_progress_then_completes(self):
        ...
        self.assertFalse(self.job_handler.is_job_done())
        self.vnc_api_obj.execute_job.return_value = {'job_execution_id': 'job-1'}
        self.vnc_api_obj.job_status_http_get.side_effect = side_effect
        ...
        self.assertEqual(self.vnc_api_obj.job_status_http_get.call_count, 3)
        self.assertTrue(self.job_handler.is_job_done())
        self.assertEqual(self.job_handler.get_job_status(), JobStatus.COMPLETE)
        self.assertEqual(self.sleep_mock.call_args_list,
    ...
    def test_job_failed(self):
        self.assertFalse(self.job_handler.is_job_done())
        self.vnc_api_obj.execute_job.return_value = {'job_execution_id': 'job-1'}
        self.vnc_api_obj.job_status_http_get.side_effect = [self.JOB_IN_PROGRESS,
                                                   self.JOB_FAILURE]
        ...
        self.assertEqual(self.vnc_api_obj.job_status_http_get.call_count, 2)
        self.assertTrue(self.job_handler.is_job_done())
    ...
    def test_execute_job_throws(self):
        ...
        self.vnc_api_obj.job_status_http_get.assert_not_called()
        self.assertTrue(self.job_handler.is_job_done())
        self.assertEqual(self.job_handler.get_job_status(), JobStatus.FAILED)
    ...
    def test_check_status_throws(self):
        self.assertFalse(self.job_handler.is_job_done())
        self.vnc_api_obj.execute_job.return_value = {'job_execution_id': 'job-1'}
        self.vnc_api_obj.job_status_http_get.side_effect = requests.exceptions.HTTPError()
    ...
    def test_max_retries_done(self):
        ...
        self.assertEqual(self.vnc_api_obj.job_status_http_get.call_count, 6)
        self.assertTrue(self.job_handler.is_job_done())
        self.assertEqual(self.job_handler.get_job_status(), JobStatus.FAILED)
        self.assertEqual(self.sleep_mock.call_args_list,
                         [mock.call(self.TIMEOUT),
