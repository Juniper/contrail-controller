...
class TestAnsibleUnderlayIpClosDM(TestAnsibleCommonDM):
    ...
    def test_dm_ansible_underlay_ip_clos(self):
        ...
        np1, rc1 = self.create_node_profile('node-profile-1', device_family='junos-qfx',
            role_mappings=[
            AttrDict(
                {'physical_role': 'spine',
                 'rb_roles': ['crb-gateway']}
            )], job_template=jt1)
        np2, rc2 = self.create_node_profile('node-profile-2', device_family='junos-qfx',
            role_mappings=[
            AttrDict(
                {'physical_role': 'leaf',
                 'rb_roles': ['crb-access']}
        ...
        bgp_router1, pr1 = self.create_router('router1', pr1_mgmtip, role='spine',
        ...
        bgp_router2, pr2 = self.create_router('router2', pr2_mgmtip, role='leaf',
                                            ignore_bgp=False, fabric=fabric,
                                            node_profile=np2,
