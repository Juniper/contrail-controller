...
class TestInfraDM(TestCommonDM):
    ...
    def test_dm_unsupported_device(self):
        ...
        bgp_router, pr = self.create_router('router1' + self.id(), '199.199.199.199', product=self.product)
    ...
    def test_dm_plugins(self):
        ...
        bgp_router, pr = self.create_router('router100' + self.id(), '1.1.1.1', product=self.product)
