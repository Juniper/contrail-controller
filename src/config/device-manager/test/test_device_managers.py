...
class TestDeviceJobManager(AbstractTestDMManagers):
    ...
    def test_job_manager_cassandra_n_rabbit(self, kombu_transport):
    ...
    def test_job_manager_etcd(self, kombu_transport):
...
class TestDeviceZtpManager(AbstractTestDMManagers):
    ...
    @mock.patch('kombu.transport.pyamqp.Transport', autospec=True)
    def test_ztp_manager_rabbit(self, kombu_transport):
        self.args.notification_driver = 'rabbit'
        self.args.db_driver = 'cassandra'
        self.amqp_mocked_calls = []
        amqp_client = self._mock_amqp_mock(
    ...
    @mock.patch('kombu.transport.etcd.Transport', autospec=True)
    def test_ztp_manager_etcd(self, kombu_transport):
        self.args.notification_driver = 'etcd'
        self.args.db_driver = 'etcd'
        self.amqp_mocked_calls = []
        amqp_client = self._mock_amqp_mock(
