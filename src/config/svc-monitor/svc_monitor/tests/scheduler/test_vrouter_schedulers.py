...
class TestChanceScheduler(unittest.TestCase):

    def setUp(self):
        super(TestChanceScheduler, self).setUp()
        ...
        self.scheduler = \
            scheduler.ChanceScheduler(self.vnc_mock, mock.MagicMock())

    def tearDown(self):
        self.analytics_patch.stop()
        self.vnc_patch.stop()
        super(TestChanceScheduler, self).tearDown()
    ...
    def test_random_scheduling(self):
        ...
        with mock.patch.object(scheduler.ChanceScheduler, '_get_candidates',
