...
def vr_vnc_read(fq_name=None, fq_name_str=None, id=None, ifmap_id=None):
    pass
...
def si_vnc_read(fq_name=None, fq_name_str=None, id=None, ifmap_id=None):
    pass
...
def res_vnc_read(fq_name=None, fq_name_str=None, id=None, ifmap_id=None):
    pass
