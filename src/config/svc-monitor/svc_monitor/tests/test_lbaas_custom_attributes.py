...
class CustomAttributeTest(unittest.TestCase):
    def test_false_custom_attributes(self):
        ...
        resp_dict = validator.validate_custom_attributes(fake_config, 'global', custom_attributes_dict)
    ...
    def test_mixed_custom_attributes(self):
        ...
        resp_dict = validator.validate_custom_attributes(fake_config, 'default', custom_attributes_dict)
