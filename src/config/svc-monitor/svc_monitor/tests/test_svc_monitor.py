...
class SvcMonitorTest(unittest.TestCase):
    ...
    def test_svc_monitor_init(self):
        ...
        self.assertTrue(self._svc_monitor.notifier._db_resync_done)

    def test_svc_monitor_cgitb(self):
        self._svc_monitor.notifier._vnc_subscribe_callback(si_add_info)
    ...
    def test_svc_monitor_sas(self):
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(sas_add_info)
        self._svc_monitor.notifier._vnc_subscribe_callback(sa_add_info)
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(sa_del_info)
        self._svc_monitor.notifier._vnc_subscribe_callback(sas_del_info)
    ...
    def test_svc_monitor_pool_add(self):
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(pool_add_info)
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(member_add_info)

        vip_obj = self.add_vip("Test-vip", "vip", proj_obj, pool_obj)
        vip = config_db.VirtualIpSM.get('vip')
        self._svc_monitor.notifier._vnc_subscribe_callback(vip_add_info)
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(member_del_info)
        self._svc_monitor.notifier._vnc_subscribe_callback(vip_del_info)
        self._svc_monitor.notifier._vnc_subscribe_callback(pool_del_info)
        self._svc_monitor.notifier._vnc_subscribe_callback(sa_del_info)
        self._svc_monitor.notifier._vnc_subscribe_callback(sas_del_info)
    ...
    def test_svc_monitor_pool_update(self):
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(pool_update_info)
        self.validate_pool(self._svc_monitor.loadbalancer_agent._loadbalancer_driver['Test-SAS']._pools['pool'], pool)

        self._return_obj['loadbalancer_member']['loadbalancer_member_properties']['weight'] = '999'
        self._svc_monitor.notifier._vnc_subscribe_callback(member_update_info)
        self.validate_pool(self._svc_monitor.loadbalancer_agent._loadbalancer_driver['Test-SAS']._pools['pool'], pool)
        self.validate_pool_member(self._svc_monitor.loadbalancer_agent._loadbalancer_driver['Test-SAS']._members['member'],  member)
    ...
    def test_svc_monitor_vm_service_delete(self):
        ...
        self._svc_monitor.vm_manager = mock.MagicMock()
        self._svc_monitor.notifier._vnc_subscribe_callback(si_del_info)
    ...
    def test_svc_monitor_vm_delayed_vn_add(self):
        ...
        self._svc_monitor.vm_manager = mock.MagicMock()
        self._svc_monitor.notifier._vnc_subscribe_callback(vn_add_info)
        self._svc_monitor.vm_manager.create_service.assert_called_with(st, si)
        self.assertTrue(si.launch_count==1)
        match_str = "SI %s creation success" % (':').join(si.fq_name)
        ServiceMonitorLogger.info.assert_any_call(match_str)
    ...
    def test_svc_monitor_non_service_vmi_service_health_check(self):
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(vmi_update_info)
    ...
    def test_svc_monitor_vmi_add(self):
        ...
        self._svc_monitor.notifier._vnc_subscribe_callback(vmi_add_info)
    ...
    def test_svc_monitor_vmi_del(self):
        ...
        config_db.VirtualMachineInterfaceSM._object_db.object_read = self.object_db_vmi_read
        self._svc_monitor.notifier._vnc_subscribe_callback(vmi_del_info)
