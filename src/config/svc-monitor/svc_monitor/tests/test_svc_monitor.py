...
class SvcMonitorTest(unittest.TestCase):
    def setUp(self):
        ...
        VncCassandraClient._cf_dict = \
            {'service_instance_table':None, 'pool_table':None, 'loadbalancer_table': None}
    ...
    def test_svc_monitor_vm_delayed_vn_add(self):
        ...
        config_db.VirtualNetworkSM._object_db.object_read = self.cassandra_vn_read
        self._svc_monitor.vm_manager = mock.MagicMock()
    ...
    def test_svc_monitor_vmi_add(self):
        ...
        config_db.VirtualMachineInterfaceSM._object_db.object_read = self.cassandra_vmi_read
