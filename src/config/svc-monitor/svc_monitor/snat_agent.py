...
class SNATAgent(Agent):
    ...
    def _create_snat_vn(self, project_obj, vn_name, vn_subnet):
        ...
        ipam_uuid = self._cassandra.fq_name_to_uuid('network-ipam',
                                                    ipam_fq_name)
        ipam_obj = NetworkIpam()
        ipam_obj.uuid = ipam_uuid
        ipam_obj.fq_name = ipam_fq_name
    ...
    def _delete_snat_instance(self, router_obj):
        ...
        # Delete route table
        if rt_obj and rt_obj.virtual_network_back_refs:
