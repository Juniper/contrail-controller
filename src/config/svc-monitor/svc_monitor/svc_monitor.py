...
class SvcMonitor(object):
    ...
    def _delete_svc_instance_netns(self, vm_uuid, proj_name, si_fq_str=None):
        ...
        for vr in vm_obj.get_virtual_router_back_refs() or []:
            ...
            self._svc_syslog("UPDATE: Virtual router update in delete")
    ...
    def _delmsg_project_service_instance(self, funcname, idents):
        ...
        self._svc_syslog("Processed %s %s" % (funcname, idents))
    # end _delmsg_project_service_instance

    def _delmsg_service_instance_service_template(self, funcname, idents):
        si_fq_str = idents['service-instance']
    ...
    def _delmsg_virtual_machine_service_instance(self, funcname, idents):
    ...
    def _delmsg_virtual_machine_interface_route_table(self, funcname, idents):
    ...
    def _addmsg_virtual_machine_interface_virtual_machine(self, funcname, idents):
        ...
        self._svc_syslog("Processing %s %s" % (funcname, idents))
    ...
    def _addmsg_service_instance_service_template(self, funcname, idents):
    ...
    def _addmsg_service_instance_properties(self, funcname, idents):
        si_fq_str = idents['service-instance']
    ...
    def _addmsg_project_virtual_network(self, funcname, idents):
