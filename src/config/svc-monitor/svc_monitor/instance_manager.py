...
class InstanceManager(object):
    ...
    def _set_static_routes(self, nic, si):
        ...
        InterfaceRouteTableSM.locate(rt_obj.uuid, rt_obj.to_dict())
        return rt_obj
    ...
    def link_si_to_vm(self, si, st, instance_index, vm_uuid):
        ...
        VirtualMachineSM.locate(vm_obj.uuid, vm_obj.to_dict())
    ...
    def create_service_vn(self, vn_name, vn_subnet, vn_subnet6,
        ...
        VirtualNetworkSM.locate(vn_obj.uuid, vn_obj.to_dict())
    ...
    def _check_create_netns_vm(self, instance_index, si, st, vm):
        ...
        if not vm:
            ...
            vm = VirtualMachineSM.locate(vm_obj.uuid, vm_obj.to_dict())
    ...
    def _create_svc_vm_port(self, nic, instance_name, si, st,
        ...
        VirtualMachineInterfaceSM.locate(vmi_obj.uuid, vmi_obj.to_dict())
