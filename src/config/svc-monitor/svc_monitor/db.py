...
class ServiceMonitorDB(object):
    ...
    def _cass_driver(self, args):
        return ServiceMonitorCass(args, self._db_logger.log)

    def _etcd_driver(self, args):
        #self._db_logger.log("VncObjectEtcdClient arguments: {}".format(vnc_db))
        return ServiceMonitorEtcd(args, self._db_logger.log)
...
class ServiceMonitorEtcd(VncObjectEtcdClient):
    ...
    def __init__(self, args, logger):
        ...
        super(ServiceMonitorEtcd, self).__init__(logger=self._db_logger.log,
                                                 prefix=self._prefix, **vnc_db)
