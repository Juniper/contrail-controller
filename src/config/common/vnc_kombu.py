...
class VncKombuClientBase(object):
    ...
    def _start(self, client_name):
        ...
        self._publisher_greenlet = vnc_greenlets.launch_greenlet(client_name, self._publisher)
        self._connection_monitor_greenlet = vnc_greenlets.launch_greenlet\
                      (client_name + '_ConnMon',\
