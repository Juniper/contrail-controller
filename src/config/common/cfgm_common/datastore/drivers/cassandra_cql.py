...
TABLE_PROPERTIES = {
    ...
    # TODO(sahid): Options set to make the CFs configured as they was
    # used with thrift connector.
...
class Iter(six.Iterator):
    def __init__(self, result, columns,
        ...
        # the columns already discovered during interation of the
...
class CassandraDriverCQL(datastore_api.CassandraDriver):
    ...
    def BatchClass(self):
        ...
        # type form pycassa which is what legacy is using. It also add
        # check related to performance like having a batch executed
        # for different partition key or executing for a same
