...
class Client(object):
    ...
    def __init__(self, analytics_api_ip, analytics_api_port, args=None, data={}):
        self.data = data
        ...
        self._args = args
        #self._analytics_api_ssl_params = analytics_api_ssl_params #Aadarsh
        self.index = -1
            ...
            try:
                ...
                if (self._args.analytics_api_ssl_enable):
                    ...
                    if (self._args.analytics_api_insecure_enable):
                        ...
                        resp = requests.get(url, cert=self._cert, verify=self._args.analytics_api_ssl_ca_cert)
                else:
