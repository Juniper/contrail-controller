...
#from schema_transformer.resources.routing_instance import DBBaseST.get_obj_type_map().get('routing_instance')
#from schema_transformer.resources.virtual_machine import DBBaseST.get_obj_type_map().get('virtual_machine')
#from schema_transformer.resources.port_tuple import DBBaseST.get_obj_type_map().get('port_tuple')
...
class ServiceChain(DBBaseST):
    ...
    def update_ipams(self, vn2_name):
        ...
        if self.left_vn == vn2_name:
            vn1 = DBBaseST.get_obj_type_map().get('virtual_network').get(self.right_vn)
        if self.right_vn == vn2_name:
            vn1 = DBBaseST.get_obj_type_map().get('virtual_network').get(self.left_vn)

        vn2 = DBBaseST.get_obj_type_map().get('virtual_network').get(vn2_name)
        if vn1 is None or vn2 is None:
            return

        for service in self.service_list:
            service_name = vn1.get_service_name(self.name, service)
            service_ri = DBBaseST.get_obj_type_map().get('routing_instance').get(service_name)
    ...
    def _get_vm_pt_info(self, vm_pt, mode):
        # From a DBBaseST.get_obj_type_map().get('virtual_machine') or DBBaseST.get_obj_type_map().get('port_tuple') object, create a vm_info
        ...
        for interface_name in vm_pt.virtual_machine_interfaces:
            interface = DBBaseST.get_obj_type_map().get('virtual_machine_interface').get(interface_name)
            if not interface:
                continue
    ...
    def check_create(self):
        ...
        ret_dict = {}
        for service in self.service_list:
            si = DBBaseST.get_obj_type_map().get('service_instance').get(service)
            if si is None:
            ...
            for service_vm in vm_list:
                vm_obj = DBBaseST.get_obj_type_map().get('virtual_machine').get(service_vm)
                if vm_obj is None:
            ...
            for pt in pt_list:
                pt_obj = DBBaseST.get_obj_type_map().get('port_tuple').get(pt)
                if pt_obj is None:
    ...
    def _create(self, si_info):
        ...
        vn1_obj = DBBaseST.get_obj_type_map().get('virtual_network').locate(self.left_vn)
        vn2_obj = DBBaseST.get_obj_type_map().get('virtual_network').locate(self.right_vn)
        ...
        for service in self.service_list:
            ...
            ri_obj = DBBaseST.get_obj_type_map().get('routing_instance').create(service_name1, vn1_obj, has_pnf)
            service_ri1 = DBBaseST.get_obj_type_map().get('routing_instance').locate(service_name1, ri_obj)
            ...
            if service_ri2 is not None:
                ...
                rt_obj = DBBaseST.get_obj_type_map().get('route_target').get(vn1_obj.get_route_target())
            ...
            if not nat_service:
                ri_obj = DBBaseST.get_obj_type_map().get('routing_instance').create(service_name2, vn2_obj, has_pnf)
                service_ri2 = DBBaseST.get_obj_type_map().get('routing_instance').locate(service_name2, ri_obj)
                if service_ri2 is None:
        ...
        if service_ri2:
            ...
            if not multi_policy_enabled:
                ...
                # add primary ri's target to service ri
                rt_obj = DBBaseST.get_obj_type_map().get('route_target').get(vn2_obj.get_route_target())
    ...
    def destroy(self):
        ...
        vn1_obj = DBBaseST.get_obj_type_map().get('virtual_network').get(self.left_vn)
        vn2_obj = DBBaseST.get_obj_type_map().get('virtual_network').get(self.right_vn)

        for service in self.service_list:
            if vn1_obj:
                service_name1 = vn1_obj.get_service_name(self.name, service)
                DBBaseST.get_obj_type_map().get('routing_instance').delete(service_name1, True)
            if vn2_obj:
                service_name2 = vn2_obj.get_service_name(self.name, service)
                DBBaseST.get_obj_type_map().get('routing_instance').delete(service_name2, True)
        # end for service
    # end destroy
