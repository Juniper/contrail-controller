...
from db import schema_transformer_db_factory
from st_amqp import st_amqp_factory
...
class SchemaTransformer(object):
    ...
    def __init__(self, st_logger=None, args=None):
        ...
        # Initialize amqp
        self._vnc_amqp = st_amqp_factory(self.logger, self.REACTION_MAP, self._args, self.timer_obj)
