        ...
        try:
            try:
                ...
                if rinst_obj.parent_uuid != self.obj.uuid:
                    ...
                    ri_copy = copy.deepcopy(rinst_obj)
                    ...
                    if (rinst_obj.get_routing_instance_is_default() !=
                        ri_copy.get_routing_instance_is_default() or
                        not compare_refs(rinst_obj.get_route_target_refs(),
                                         ri_copy.get_route_target_refs())):
