...
from cfgm_common.uve.cfgm_cpuinfo.ttypes import NodeStatusUVE, \
    NodeStatus
from db import DBBaseST, SchemaTransformerDB
...
class SchemaTransformer(object):
    _REACTION_MAP = {
        'virtual_machine_interface': {
            'self': ['virtual-machine', 'virtual_network'],
    ...
    def _vnc_subscribe_callback(self, oper_info):
        ...
        #TBD - Handle other dependent objects
...
def parse_args(args_str):
    '''
    Eg. python schema_transformer.py  --rabbit_server localhost
                         -- rabbit_port 5672
                         -- rabbit_user guest
...
def run_schema_transformer(args):
    schema_transformer = SchemaTransformer(args)
