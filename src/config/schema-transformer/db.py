...
class SchemaTransformerDB(VncObjectDBClient):
    ...
    def get_rtgt_max_id(cls, asn):
        max_rtgt_id = cls._BGP_RTGT_MAX_ID_TYPE0
        if (asn > 0xFFFF):
            max_rtgt_id = cls._BGP_RTGT_MAX_ID_TYPE1_2
        return max_rtgt_id
    ...
    def __init__(self, manager, zkclient):
        ...
        def _init_index_allocators():
            ...
            self._rt_allocator = IndexAllocator(
                ...
                self._BGP_RTGT_MAX_ID_TYPE0, common._BGP_RTGT_MIN_ID_TYPE0)
            self._rt_allocator_4 = IndexAllocator(
                zkclient, self._zk_path_pfx+common.BGP_RTGT_ALLOC_PATH_TYPE1_2,
                self._BGP_RTGT_MAX_ID_TYPE1_2, common._BGP_RTGT_MIN_ID_TYPE1_2)
