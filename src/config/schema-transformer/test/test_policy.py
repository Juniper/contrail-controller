...
class TestPolicy(STTestCase, VerifyPolicy):
    ...
    def test_provider_network(self):
        ...
        Verify:
            ...
            8. Check db_resync sets is_provider_network property
               of provider-VN as True (simulating upgrade case)
            9. Check non provider VNs can be added to
               provider VN
            10. Check the provider-VN can be added to a VN
            11. Check non provider-VN can not be added to a VN
            12. Check many VNs can be linked to the provider-VN
            13. Check (provider-vn -> any-VN),DENY acl rule is added to
               the provider-VN
            14. Check (VN -> provider-VN),DENY acl rule is added to
               the VN
            15. Adding a (VN -> provider-VN),PASS acl rule at VN removes
        ...
        self.assertRaises(RefsExistError,
        ...
        self.assertRaises(RefsExistError, self._vnc_lib.virtual_network_create, vn4_obj1)
