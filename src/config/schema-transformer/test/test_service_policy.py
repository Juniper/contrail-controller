...
class TestServicePolicy(STTestCase, VerifyServicePolicy):
    ...
    def test_vrf_assign_rules(self):
        ...
        self.check_vrf_assign_table(vmi_fq_name=left_vmi.fq_name, src_port=prule[0].dst_ports,
                                    dst_port=prule[0].src_ports)
        self.check_vrf_assign_table(vmi_fq_name=right_vmi.fq_name, src_port=prule[0].src_ports,
