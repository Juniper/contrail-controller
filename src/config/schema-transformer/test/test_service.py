...
#class TestRouteTable(test_case.STTestCase):
    ...
    def check_security_group_id(self, sg_fq_name, verify_sg_id = None):
        ...
        if verify_sg_id is not None and sg_id != verify_sg_id: 
    ...
    def _security_group_rule_build(self, rule_info, sg_uuid):
        ...
        if ip_prefix:
            ...
            try:
                ...
                raise Exception('SecurityGroupNotFound %s' % sg_id)
    ...
    def test_sg(self):
        ...
        '''
        # failed test, why? acl stills holds old sg_id
        sg1_obj.set_security_group_id(100)
        self._security_group_update(sg1_obj)
        ...
        sg2_obj.set_security_group_id(100)
        self._security_group_update(sg2_obj)
        self.check_security_group_id(sg2_obj.get_fq_name(), 100)

        #sg id '0' is allowed
        sg1_obj.set_security_group_id(0)
        self._security_group_update(sg1_obj)
        self.check_security_group_id(sg1_obj.get_fq_name(), 0)

        # -ve security group id allowed
        sg1_obj.set_security_group_id(-100)
        self._security_group_update(sg1_obj)
        self.check_security_group_id(sg1_obj.get_fq_name(), -100)
