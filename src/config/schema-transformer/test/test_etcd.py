...
class TestSchemaTransformerEtcd(unittest.TestCase):
    ...
    def test_create_schema_transformer_etcd_instance(self):
        ...
        self.assertIsInstance(
            schema_transformer_etcd._client, VncEtcd)
        self.assertIsInstance(
            schema_transformer_etcd._client._client, etcd3.Etcd3Client)
    ...
    def test_empty_list_service_chain_uuid(self):
        kv_data = []
        schema_transformer_etcd = _schema_transformer_etcd_factory()
        schema_transformer_etcd._client._client.get_prefix = mock.MagicMock()
        schema_transformer_etcd._client._client.get_prefix.return_value = kv_data
        self.assertEqual(
    ...
    def test_list_service_chain_uuid_elements_encapsulated(self, etcd_client):
        ...
        schema_transformer_etcd._client._client.get_prefix = mock.MagicMock()
        schema_transformer_etcd._client._client.get_prefix.return_value = kv_data
        schema_transformer_etcd._client._client.put = mock.MagicMock
    ...
    def test_remove_service_chain_uuid(self, etcd_client):
        ...
        schema_transformer_etcd._client._client.delete = mock.MagicMock(
