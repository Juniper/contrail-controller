...
from vnc_api.gen.resource_xsd import SequenceType, VirtualNetworkPolicyType
from vnc_api.gen.resource_xsd import AclEntriesType, AclRuleType
from vnc_api.gen.resource_xsd import ActionListType, InstanceTargetType
