...
class TestRouteTarget(STTestCase, VerifyRouteTarget):
    ...
    def test_route_target_id_collision(self):
        ...
        DEPRECATED_BASE_RTGT = "/".join(filter(
            lambda x: x not in ["type0", "type1_2"],
            db_checker.BASE_RTGT_ID_ZK_PATH.split("/")))
        ...
        # create node in ZK
        zkc.create_node(node_collision_path, "6a77156f-e062-4d6b-b228-05a173b612e3")
