...
class BgpRouterST(DBBaseST):
    ...
    def skip_fabric_bgp_router_peering_add(self, router):
        ...
        # Ignore peering if self-bgp-router and peer-bgp-router are not RR, and
        # there is RR in the cluster
        if self.cluster_id is None and router.cluster_id is None:
            return True
