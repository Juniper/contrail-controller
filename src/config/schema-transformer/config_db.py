...
class VirtualNetworkST(DBBaseST):
    ...
    def update(self, do_refresh=True):
        if do_refresh:
            ret = self.update_vnc_obj()
        else:
            ret = self.ref_fields + self.prop_fields
        ...
        for policy_name in NetworkPolicyST.get_internal_policies(self.name):
            self.add_policy(policy_name) or ret
...
class SecurityGroupST(DBBaseST):
    ...
    def handle_st_object_req(self):
        ...
        resp.properties = [
            ...
            sandesh.PropList('configured_id', str(self.configured_security_group_id))
...
class BgpAsAServiceST(DBBaseST):
    ...
    def handle_st_object_req(self):
        ...
        resp.properties = [
            sandesh.PropList('ip_address', self.bgpaas_ip_address),
            sandesh.PropList('asn', str(self.asn))
        ]
        return resp
    # end handle_st_object_req
...
class VirtualMachineInterfaceST(DBBaseST):
    ...
    def set_properties(self):
        ...
        if interface_mirror != self.interface_mirror:
            self.interface_mirror = interface_mirros
            ret = True
        return ret
    # end set_properties
...
class InstanceIpST(DBBaseST):
    ...
    def handle_st_object_req(self):
        ...
        resp.properties = [
            sandesh.PropList('address', self.instance_ip_address),
...
class FloatingIpST(DBBaseST):
    ...
    def handle_st_object_req(self):
        ...
        resp.properties = [
            sandesh.PropList('address', self.floating_ip_address),
        ]
        return resp
    # end handle_st_object_req
# end FloatingIpST
...
class AliasIpST(DBBaseST):
    ...
    def handle_st_object_req(self):
        ...
        resp.properties = [
            sandesh.PropList('address', self.alias_ip_address),
        ]
        return resp
    # end handle_st_object_req
# end AliasIpST
...
class VirtualMachineST(DBBaseST):
    ...
    ref_fields = ['virtual_machine_interface', 'service_instance']
    def __init__(self, name, obj=None):
        self.name = name
        self.virtual_machine_interfaces = set()
