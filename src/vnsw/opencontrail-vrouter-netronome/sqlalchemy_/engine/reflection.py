...
class Inspector(object):
    ...
    :class:`~sqlalchemy_.engine.interfaces.Dialect`, providing a
    ...
    :func:`.inspect` function::
        ...
        from sqlalchemy_ import inspect, create_engine
    ...
    Where above, the :class:`~sqlalchemy_.engine.interfaces.Dialect` may opt
    ...
    def __init__(self, bind):
        ...
        :param bind: a :class:`~sqlalchemy_.engine.Connectable`,
          which is typically an instance of
          :class:`~sqlalchemy_.engine.Engine` or
          :class:`~sqlalchemy_.engine.Connection`.
    ...
    def from_engine(cls, bind):
        ...
        :class:`~sqlalchemy_.engine.interfaces.Dialect` is given a chance to
    ...
    def get_columns(self, table_name, schema=None, **kw):
        ...
        type
          :class:`~sqlalchemy_.types.TypeEngine`
    ...
    def reflecttable(self, table, include_columns, exclude_columns=()):
        ...
        table reflection.  Direct usage is like::
            ...
            from sqlalchemy_ import create_engine, MetaData, Table
            from sqlalchemy_.engine import reflection
        ...
        :param table: a :class:`~sqlalchemy_.schema.Table` instance.
