...
:func:`~sqlalchemy_.engine.create_engine`.  Current available options are
...
from sqlalchemy_.engine import base, threadlocal, url
from sqlalchemy_ import util, exc, event
from sqlalchemy_ import pool as poollib
...
class MockEngineStrategy(EngineStrategy):
    ...
    class MockConnection(base.Connectable):
        ...
        def create(self, entity, **kwargs):
            ...
            from sqlalchemy_.engine import ddl
