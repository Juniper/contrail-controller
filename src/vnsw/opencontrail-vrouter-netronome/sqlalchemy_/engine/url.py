...
"""Provides the :class:`~sqlalchemy_.engine.url.URL` class which encapsulates
information about a database connection specification.

The URL object is created automatically when
:func:`~sqlalchemy_.engine.create_engine` is called with a string
...
class URL(object):
    ...
    :func:`~sqlalchemy_.create_engine` call.  The fields of the URL are parsed
    ...
    :param drivername: the name of the database backend.
      This name will correspond to a module in sqlalchemy_/databases
