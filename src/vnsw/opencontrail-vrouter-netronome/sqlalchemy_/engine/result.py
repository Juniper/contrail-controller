...
try:
    ...
    # __setstate__.
    from sqlalchemy_.cresultproxy import safe_rowproxy_reconstructor
...
try:
    from sqlalchemy_.cresultproxy import BaseRowProxy
except ImportError:
...
class ResultProxy(object):
    ...
    def inserted_primary_key(self):
        ...
        Raises :class:`~sqlalchemy_.exc.InvalidRequestError` if the executed
