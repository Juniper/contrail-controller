...
class Connection(Connectable):
    ...
    def invalidate(self, exception=None):
        ...
        :class:`~sqlalchemy_.exc.InvalidRequestError`.
...
class Engine(Connectable, log.Identified):
    """
    Connects a :class:`~sqlalchemy_.pool.Pool` and
    :class:`~sqlalchemy_.engine.interfaces.Dialect` together to provide a
    source of database connectivity and behavior.

    An :class:`.Engine` object is instantiated publicly using the
    :func:`~sqlalchemy_.create_engine` function.
    ...
    @property
    def name(self):
        """String name of the :class:`~sqlalchemy_.engine.interfaces.Dialect`
    ...
    @property
    def driver(self):
        """Driver name of the :class:`~sqlalchemy_.engine.interfaces.Dialect`
        in use by this :class:`Engine`."""
