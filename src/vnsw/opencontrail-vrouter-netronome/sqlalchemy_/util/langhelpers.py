...
""" % metadata
    ...
    decorated.__module__ = "sqlalchemy_" + location.rsplit(".", 1)[0]
...
class dependencies(object):
    ...
    E.g.::
        ...
        @util.dependencies(
            "sqlalchemy_.sql.widget",
            "sqlalchemy_.engine.default"
        );
...
class classproperty(property):
    ...
    :class:`~.sqlalchemy_.ext.declarative.declared_attr`
...
_SQLA_RE = re.compile(r'sqlalchemy_/([a-z_]+/){0,2}[a-z_]+\.py')
