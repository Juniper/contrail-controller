...
import itertools
from sqlalchemy_.sql.visitors import Visitable
...
class FromClause(Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    @util.dependencies("sqlalchemy_.sql.functions")
    ...
    def outerjoin(self, right, onclause=None):
        ...
        E.g.::
            ...
            from sqlalchemy_ import outerjoin
    ...
    @util.dependencies("sqlalchemy_.sql.util")
    ...
    def corresponding_column(self, column, require_embedded=False):
        ...
        :class:`~sqlalchemy_.schema.Column` via a common ancestor
        column.
...
class Join(FromClause):
    ...
    def select(self, whereclause=None, **kwargs):
        ...
        ``j``, is::
            ...
            from sqlalchemy_ import select
    ...
    def alias(self, sqlutil, name=None, flat=False):
        ...
        ``j``, is::
            ...
            from sqlalchemy_ import select, alias
            j = alias(
...
class TableClause(Immutable, FromClause):
    ...
    def __init__(self, name, *columns):
        ...
        .. versionchanged:: 1.0.0 :func:`.expression.table` can now
           be imported from the plain ``sqlalchemy_`` namespace like any
           other SQL element.
    ...
    @util.dependencies("sqlalchemy_.sql.dml")
...
class SelectBase(Executable, FromClause):
    ...
    def cte(self, name=None, recursive=False):
        ...
        Example 1, non recursive::
            ...
            from sqlalchemy_ import (Table, Column, String, Integer,
