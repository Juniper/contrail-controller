...
def between(expr, lower_bound, upper_bound, symmetric=False):
    ...
    E.g.::
        ...
        from sqlalchemy_ import between
...
def literal(value, type_=None):
    ...
    such as a :class:`~sqlalchemy_.schema.Column` object.  Use this function
    ...
    :param type\_: an optional :class:`~sqlalchemy_.types.TypeEngine` which
...
def type_coerce(expression, type_):
    ...
    E.g.::
        ...
        from sqlalchemy_ import type_coerce
...
def outparam(key, type_=None):
    ...
    :class:`~sqlalchemy_.engine.ResultProxy` object via its ``out_parameters``
    ...
    def compile(self, default, bind=None, dialect=None, **kw):
        ...
        :param compile_kwargs: optional dictionary of additional parameters
            ...
            for the case of passing the ``literal_binds`` flag through::
                ...
                from sqlalchemy_.sql import table, column, select
...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    of :class:`.ColumnElement`::
        ...
        >>> column('a') + column('b')
        <sqlalchemy_.sql.expression.BinaryExpression object at 0x101029dd0>
...
class BindParameter(ColumnElement):
    ...
    :func:`.bindparam` function, as in::
        ...
        from sqlalchemy_ import bindparam
...
class TextClause(Executable, ClauseElement):
    ...
    @util.dependencies('sqlalchemy_.sql.selectable')
    def columns(self, selectable, *cols, **types):
        ...
        of a "selectable"::
            ...
            from sqlalchemy_.sql import column, text
...
class Tuple(ClauseList, ColumnElement):
    ...
    def __init__(self, *clauses, **kw):
        ...
        Main usage is to produce a composite IN construct::
            ...
            from sqlalchemy_ import tuple_
        ...
        .. warning::
            ...
            a subclass of :class:`~sqlalchemy_.exc.DBAPIError` when such
...
class Case(ColumnElement):
    ...
    def __init__(self, whens, value=None, else_=None):
        ...
        as in::
            ...
            from sqlalchemy_ import case, literal_column
...
def literal_column(text, type_=None):
    ...
    :param type\_: an optional :class:`~sqlalchemy_.types.TypeEngine`
      object which will
...
class Cast(ColumnElement):
    ...
    as in::
        ...
        from sqlalchemy_ import cast, Numeric
...
class UnaryExpression(ColumnElement):
    ...
    def _create_nullsfirst(cls, column):
        ...
        should be handled when they are encountered during ordering::
            ...
            from sqlalchemy_ import desc, nullsfirst
    ...
    def _create_nullslast(cls, column):
        ...
        should be handled when they are encountered during ordering::
            ...
            from sqlalchemy_ import desc, nullslast
    ...
    def _create_distinct(cls, expr):
        ...
        as in::
            ...
            from sqlalchemy_ import distinct, func
...
class FunctionFilter(ColumnElement):
    ...
    def over(self, partition_by=None, order_by=None):
        ...
        is shorthand for::
            ...
            from sqlalchemy_ import over, funcfilter
...
class ColumnClause(Immutable, ColumnElement):
    ...
    :func:`.column` function, as in::
        ...
        from sqlalchemy_ import column
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        a working table construct with minimal boilerplate::
            ...
            from sqlalchemy_ import table, column, select
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    an unconditionally quoted name::
        ...
        from sqlalchemy_.sql.elements import quoted_name
