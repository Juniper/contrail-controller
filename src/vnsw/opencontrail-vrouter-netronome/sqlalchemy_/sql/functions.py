...
class FunctionElement(Executable, ColumnElement, FromClause):
    ...
    def columns(self):
        ...
        desired columns::
            ...
            from sqlalchemy_.sql import column
    ...
    def filter(self, *criterion):
        ...
        is shorthand for::
            ...
            from sqlalchemy_ import funcfilter
...
"""Generate SQL function expressions.
   ...
   :class:`~sqlalchemy_.types.Unicode` as the type:
...
class GenericFunction(util.with_metaclass(_GenericMeta, Function)):
    ...
    be available immediately::
        ...
        from sqlalchemy_.sql.functions import GenericFunction
        from sqlalchemy_.types import DateTime
