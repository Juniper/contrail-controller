...
class DDL(DDLElement):
    ...
    Examples::
      ...
      from sqlalchemy_ import event, DDL
...
class CreateColumn(_DDLCompiles):
    ...
    compiler extension documented in :ref:`sqlalchemy_.ext.compiler_toplevel`
    ...
    is found::
        ...
        from sqlalchemy_ import schema
    ...
    The above construct can be applied to a :class:`.Table` as follows::
        ...
        from sqlalchemy_ import Table, Metadata, Column, Integer, String
        from sqlalchemy_ import schema
    ...
    on Postgresql::
        ...
        from sqlalchemy_.schema import CreateColumn
