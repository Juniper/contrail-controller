...
class ValuesBase(UpdateBase):
    ...
    def values(self, *args, **kwargs):
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         with the
         :paramref:`~sqlalchemy_.sql.expression.update.preserve_parameter_order`
         parameter.
...
class Insert(ValuesBase):
    ...
    def __init__(self,
        ...
        :class:`~sqlalchemy_.schema.Column` objects or their string
...
class Update(ValuesBase):
    ...
    def __init__(self,
        ...
        E.g.::
            ...
            from sqlalchemy_ import update
        ...
        :param preserve_parameter_order: if True, the update statement is
          ...
          .. seealso::
            ...
            :ref:`updates_order_parameters` - full example of the
            :paramref:`~sqlalchemy_.sql.expression.update.preserve_parameter_order` flag
