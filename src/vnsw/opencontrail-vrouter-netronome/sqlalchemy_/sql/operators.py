...
class Operators(object):
    ...
    :meth:`~sqlalchemy_.sql.operators.Operators.operate` and
    :meth:`~sqlalchemy_.sql.operators.Operators.reverse_operate`, as well as
    :meth:`~sqlalchemy_.sql.operators.Operators.__and__`,
    :meth:`~sqlalchemy_.sql.operators.Operators.__or__`,
    :meth:`~sqlalchemy_.sql.operators.Operators.__invert__`.
...
class custom_op(object):
    ...
    to represent the "factorial" operation::
        ...
        from sqlalchemy_.sql import UnaryExpression
        from sqlalchemy_.sql import operators
        from sqlalchemy_ import Numeric
...
class ColumnOperators(Operators):
    ...
    :mod:`sqlalchemy_.expression.operators`.   For example
    the ``__eq__`` function::
