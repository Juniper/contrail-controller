...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        @util.dependencies('sqlalchemy_.sql.default_comparator')
    ...
    def with_variant(self, type_, dialect_name):
        ...
        e.g.::
            ...
            from sqlalchemy_.dialects import mysql
    ...
    @util.dependencies("sqlalchemy_.engine.default")
    def _default_dialect(self, default):
        if self.__class__.__module__.startswith("sqlalchemy_.dialects"):
...
class UserDefinedType(util.with_metaclass(VisitableCheckKWArg, TypeEngine)):
    ...
    more appropriate::
      ...
      import sqlalchemy_.types as types
