...
class DisconnectionError(SQLAlchemyError):
    ...
    the pool gives up and raises :class:`~sqlalchemy_.exc.InvalidRequestError`
...
class NoInspectionAvailable(InvalidRequestError):
    """A subject passed to :func:`sqlalchemy_.inspection.inspect` produced
...
class DontWrapMixin(object):
    ...
    E.g.::
        ...
        from sqlalchemy_.exc import DontWrapMixin
...
class StatementError(SQLAlchemyError):
    ...
    def __str__(self):
        from sqlalchemy_.sql import util
