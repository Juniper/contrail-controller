...
class PoolListener(object):
    ...
    All of the standard connection :class:`~sqlalchemy_.pool.Pool` types can
...
class ConnectionProxy(object):
    ...
    The proxy is installed into an :class:`~sqlalchemy_.engine.Engine` via
    the ``proxy`` argument::
