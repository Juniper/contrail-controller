...
Any SQLAlchemy query structure, either based on sqlalchemy_.sql.*
or sqlalchemy_.orm.* can be used.  The mappers, Tables, Columns, Session
...
Usage is nearly the same as that of the standard Python pickle module::
    ...
    from sqlalchemy_.ext.serializer import loads, dumps
