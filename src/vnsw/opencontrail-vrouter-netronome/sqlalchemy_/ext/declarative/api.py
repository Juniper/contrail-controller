...
def synonym_for(name, map_column=False):
    ...
    A decorator version of :func:`~sqlalchemy_.orm.synonym`. The function being
...
def comparable_using(comparator_factory):
    ...
    :func:`~sqlalchemy_.orm.comparable_property` that passes
...
def declarative_base(bind=None, metadata=None, mapper=None, cls=object,
    ...
    appropriate :class:`~sqlalchemy_.schema.Table` objects and makes
    the appropriate :func:`~sqlalchemy_.orm.mapper` calls based on the
    information provided declaratively in the class and any subclasses
    of the class.

    :param bind: An optional
      :class:`~sqlalchemy_.engine.Connectable`, will be assigned
      the ``bind`` attribute on the :class:`~sqlalchemy_.schema.MetaData`
      instance.

    :param metadata:
      An optional :class:`~sqlalchemy_.schema.MetaData` instance.  All
      :class:`~sqlalchemy_.schema.Table` objects implicitly declared by
      subclasses of the base will share this MetaData.  A MetaData instance
      will be created if none is provided.  The
      :class:`~sqlalchemy_.schema.MetaData` instance will be available via the
      `metadata` attribute of the generated declarative base class.

    :param mapper:
      An optional callable, defaults to :func:`~sqlalchemy_.orm.mapper`. Will
    ...
    :param constructor:
      Defaults to
      :func:`~sqlalchemy_.ext.declarative._declarative_constructor`, an
...
def as_declarative(**kw):
    ...
    to be converted in-place to a "declarative" base::
        ...
        from sqlalchemy_.ext.declarative import as_declarative
...
class ConcreteBase(object):
    ...
    Example::
        ...
        from sqlalchemy_.ext.declarative import ConcreteBase
...
class AbstractConcreteBase(ConcreteBase):
    ...
    Example::
        ...
        from sqlalchemy_.ext.declarative import AbstractConcreteBase
...
class DeferredReflection(object):
    ...
    objects created so far.   Classes can define it as such::
        ...
        from sqlalchemy_.ext.declarative import DeferredReflection
