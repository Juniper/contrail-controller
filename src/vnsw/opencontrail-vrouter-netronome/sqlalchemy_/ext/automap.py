...
"""Define an extension to the :mod:`sqlalchemy_.ext.declarative` system
which automatically generates mapped classes and relationships from a database
schema, typically though not necessarily one which is reflected.

.. versionadded:: 0.9.1 Added :mod:`sqlalchemy_.ext.automap`.
...
asking it to reflect the schema and produce mappings::
    ...
    from sqlalchemy_.ext.automap import automap_base
...
explicit table declaration::
    ...
    from sqlalchemy_ import create_engine, MetaData, Table, Column, ForeignKey
    engine = create_engine("sqlite:///mydatabase.db")
...
The :mod:`.sqlalchemy_.ext.automap` extension allows classes to be defined
...
:mod:`.sqlalchemy_.ext.automap` is tasked with producing mapped classes and
...
options along to all one-to-many relationships::
    ...
    from sqlalchemy_.ext.automap import generate_relationship
...
:mod:`.sqlalchemy_.ext.automap` will generate many-to-many relationships, e.g.
...
:mod:`.sqlalchemy_.ext.automap` will not generate any relationships between
...
defines table metadata::
    ...
    from sqlalchemy_.ext.automap import automap_base
    from sqlalchemy_ import Column, Integer, String, ForeignKey
