...
The :mod:`~sqlalchemy_.ext.hybrid` extension provides a special form of
...
as the class itself::
    ...
    from sqlalchemy_ import Column, Integer
    from sqlalchemy_.ext.declarative import declarative_base
    from sqlalchemy_.orm import Session, aliased
    from sqlalchemy_.ext.hybrid import hybrid_property, hybrid_method
...
:mod:`~sqlalchemy_.ext.hybrid` decorators define the
...
mapping which relates a ``User`` to a ``SavingsAccount``::
    ...
    from sqlalchemy_ import Column, Integer, ForeignKey, Numeric, String
    from sqlalchemy_.orm import relationship
    from sqlalchemy_.ext.declarative import declarative_base
    from sqlalchemy_.ext.hybrid import hybrid_property
...
named ``word_insensitive``::
    ...
    from sqlalchemy_.ext.hybrid import Comparator, hybrid_property
    from sqlalchemy_ import func, Column, Integer, String
...
into a hierarchical tree pattern::
    ...
    from sqlalchemy_ import Column, Integer, ForeignKey
    from sqlalchemy_.orm import relationship
    from sqlalchemy_.ext.declarative import declarative_base
    Base = declarative_base()
...
filtered based on the given criterion::
    ...
    from sqlalchemy_.ext.hybrid import Comparator
...
class hybrid_method(interfaces.InspectionAttrInfo):
    ...
    def __init__(self, func, expr=None):
        ...
        Usage is typically via decorator::
            ...
            from sqlalchemy_.ext.hybrid import hybrid_method
