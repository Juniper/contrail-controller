...
class DDLEvents(event.Events):
    ...
    Example using the ``after_create`` event::
        ...
        from sqlalchemy_ import Table, Column, Metadata, Integer
    ...
    def column_reflect(self, inspector, table, column_info):
        ...
        board, e.g.::
            ...
            from sqlalchemy_.schema import Table
            from sqlalchemy_ import event
...
class PoolEvents(event.Events):
    ...
    def checkout(self, dbapi_connection, connection_record, connection_proxy):
        ...
        If you raise a :class:`~sqlalchemy_.exc.DisconnectionError`, the current
...
class ConnectionEvents(event.Events):
    ...
    class or instance, such as an :class:`.Engine`, e.g.::
        ...
        from sqlalchemy_ import event, create_engine
    ...
    def handle_error(self, exception_context):
        ...
        * exception re-writing
        ...
        :class:`sqlalchemy_.exc.StatementError`,
