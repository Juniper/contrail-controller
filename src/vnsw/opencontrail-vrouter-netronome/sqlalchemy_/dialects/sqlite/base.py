...
:class:`~sqlalchemy_.types.DateTime` and related types provide date formatting
...
to be ``INTEGER`` when compiled against SQLite::
    ...
    from sqlalchemy_ import BigInteger
    from sqlalchemy_.ext.compiler import compiles
...
.. seealso::
    ...
    :ref:`sqlalchemy_.ext.compiler_toplevel`
...
new connections through the usage of events::
    ...
    from sqlalchemy_.engine import Engine
    from sqlalchemy_ import event
...
to filter these out::
    ...
    from sqlalchemy_ import create_engine
...
%(second)02d.%(microsecond)06d"
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from sqlalchemy_.dialects.sqlite import DATETIME
...
class DATE(_DateTimeMixin, sqltypes.Date):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from sqlalchemy_.dialects.sqlite import DATE
...
class TIME(_DateTimeMixin, sqltypes.Time):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from sqlalchemy_.dialects.sqlite import TIME
