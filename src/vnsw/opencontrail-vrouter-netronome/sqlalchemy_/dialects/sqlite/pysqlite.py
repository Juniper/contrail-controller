...
DBAPI module may be provided to :func:`~sqlalchemy_.create_engine()` to control
this explicitly::
...
as ``False``::
    ...
    from sqlalchemy_.pool import StaticPool
    engine = create_engine('sqlite://',
...
needed within multiple threads for this case::
    ...
    from sqlalchemy_.pool import SingletonThreadPool
...
ourselves. This is achieved using two event listeners::
    ...
    from sqlalchemy_ import create_engine, event
...
from sqlalchemy_.dialects.sqlite.base import SQLiteDialect, DATETIME, DATE
from sqlalchemy_ import exc, pool
from sqlalchemy_ import types as sqltypes
from sqlalchemy_ import util
