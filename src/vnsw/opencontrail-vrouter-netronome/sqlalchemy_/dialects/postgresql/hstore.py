...
class HSTORE(sqltypes.Concatenable, sqltypes.TypeEngine):
    ...
    * Concatenation::
    ...
    When the :mod:`sqlalchemy_.ext.mutable` extension is not used, the ORM
...
class hstore(sqlfunc.GenericFunction):
    ...
    E.g.::
        ...
        from sqlalchemy_.dialects.postgresql import array, hstore
