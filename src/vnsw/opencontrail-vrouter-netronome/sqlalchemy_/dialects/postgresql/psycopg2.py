...
* ``server_side_cursors``: Enable the usage of "server side cursors" for SQL
  ...
  :class:`~sqlalchemy_.engine.ResultProxy` uses special row-buffering
...
``sqlalchemy_.dialects.postgresql`` logger::

    import logging
    logging.getLogger('sqlalchemy_.dialects.postgresql').setLevel(logging.INFO)
...
logger = logging.getLogger('sqlalchemy_.dialects.postgresql')
