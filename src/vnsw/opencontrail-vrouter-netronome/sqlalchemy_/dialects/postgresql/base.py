...
use the :func:`~sqlalchemy_.schema.Sequence` construct::
...
:func:`~sqlalchemy_.sql.expression.insert()` construct is executed using
...
The :mod:`~sqlalchemy_.dialects.postgresql.psycopg2` and
:mod:`~sqlalchemy_.dialects.postgresql.pg8000` dialects also offer the
...
reflection process as follows::
    ...
    >>> from sqlalchemy_ import Table, MetaData, create_engine
    ...
    ...
    <sqlalchemy_.engine.result.ResultProxy object at 0x101612ed0>
...
:meth:`.MetaData.reflect`::
    ...
    ...
    <sqlalchemy_.engine.result.ResultProxy object at 0x1016126d0>
...
The :class:`.postgresql.TSVECTOR` type can provide for explicit CAST::
    ...
    from sqlalchemy_.dialects.postgresql import TSVECTOR
    from sqlalchemy_ import select, cast
...
of :class:`.PGInspector`, which offers additional methods::
    ...
    from sqlalchemy_ import create_engine, inspect
...
from sqlalchemy_.types import INTEGER, BIGINT, SMALLINT, VARCHAR, \
...
class array(expression.Tuple):
    ...
    This is used to produce ARRAY literals in SQL expressions, e.g.::
        ...
        from sqlalchemy_.dialects.postgresql import array
        from sqlalchemy_.dialects import postgresql
        from sqlalchemy_ import select, func
    ...
    class Comparator(sqltypes.Concatenable.Comparator):
        ...
        def any(self, other, operator=operators.eq):
            ...
            E.g.::
                ...
                from sqlalchemy_.sql import operators
