...
:ref:`sqlalchemy_.ext.compiler_toplevel` system, as per the recipe below::

    from sqlalchemy_.sql.expression import Cast
...
them ignored on a MySQL backend, use a custom compile rule::
    ...
    from sqlalchemy_.ext.compiler import compiles
    from sqlalchemy_.schema import ForeignKeyConstraint
...
:class:`~sqlalchemy_.ForeignKeyConstraint` at reflection time::
...
``nullable=False``.   The following example illustrates::
    ...
    from sqlalchemy_ import MetaData, Integer, Table, Column, text
    from sqlalchemy_.dialects.mysql import TIMESTAMP
