...
def polymorphic_union(table_map, typecolname,
    ...
    :param aliasname: name of the :func:`~sqlalchemy_.sql.expression.alias()`
     construct generated.
...
class AliasedClass(object):
    ...
    The ORM equivalent of a :func:`sqlalchemy_.sql.expression.alias`
    construct, this object mimics the mapped class using a
    __getattr__ scheme and maintains a reference to a
    real :class:`~sqlalchemy_.sql.expression.Alias` object.
    ...
    using :func:`.inspect`::
        ...
        from sqlalchemy_ import inspect
...
class AliasedInsp(InspectionAttr):
    ...
    :func:`.inspect` function::
        ...
        from sqlalchemy_ import inspect
        from sqlalchemy_.orm import aliased
...
def join(left, right, onclause=None, isouter=False, join_to_left=None):
    ...
    :meth:`.Query.select_from` method, as in::
        ...
        from sqlalchemy_.orm import join
        session.query(User).\\
...
def randomize_unitofwork():
    ...
    """
    from sqlalchemy_.orm import unitofwork, session, mapper, dependency
    from sqlalchemy_.util import topological
    from sqlalchemy_.testing.util import RandomSet
