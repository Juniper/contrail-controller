...
class _SessionClassMethods(object):
    ...
    @classmethod
    @util.dependencies("sqlalchemy_.orm.util")
...
class Session(_SessionClassMethods):
    ...
    def __init__(self, bind=None, autoflush=True, expire_on_commit=True,
        ...
        :param \class_: Specify an alternate class other than
           ``sqlalchemy_.orm.session.Session`` which should be used by the
    ...
    def commit(self):
        ...
        :exc:`~sqlalchemy_.exc.InvalidRequestError`.
    ...
    def prepare(self):
        ...
        :exc:`~sqlalchemy_.exc.InvalidRequestError` is raised.
    ...
    def get_bind(self, mapper=None, clause=None):
        ...
        6. No bind can be found, :exc:`~sqlalchemy_.exc.UnboundExecutionError`
           is raised.
    ...
    def refresh(self, instance, attribute_names=None, lockmode=None):
        ...
        :param lockmode: Passed to the :class:`~sqlalchemy_.orm.query.Query`
          as used by :meth:`~sqlalchemy_.orm.query.Query.with_lockmode`.
