...
def create_session(bind=None, **kwargs):
    ...
    :param bind: optional, a single Connectable to use for all
      ...
      :class:`~sqlalchemy_.orm.session.Session`.

    :param \*\*kwargs: optional, passed through to the
      :class:`.Session` constructor.

    :returns: an :class:`~sqlalchemy_.orm.session.Session` instance
    ...
    Usage::
      ...
      >>> from sqlalchemy_.orm import create_session
...
def __go(lcls):
    ...
    _sa_util.dependencies.resolve_all("sqlalchemy_.orm")
