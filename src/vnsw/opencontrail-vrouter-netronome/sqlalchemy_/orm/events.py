...
from sqlalchemy_.util.compat import inspect_getargspec
...
class InstanceEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    @classmethod
    @util.dependencies("sqlalchemy_.orm")
...
class MapperEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    :param retval=False: when True, the user-defined event function
       ...
       * ``sqlalchemy_.orm.interfaces.EXT_CONTINUE`` - continue event
         processing normally.
       * ``sqlalchemy_.orm.interfaces.EXT_STOP`` - cancel all subsequent
    ...
    def before_configured(self):
        ...
        mapped classes.  It is only invoked for all mappings as a whole::
            ...
            from sqlalchemy_.orm import mapper
...
class SessionEvents(event.Events):
    ...
    e.g.::
        ...
        from sqlalchemy_ import event
        from sqlalchemy_.orm import sessionmaker
