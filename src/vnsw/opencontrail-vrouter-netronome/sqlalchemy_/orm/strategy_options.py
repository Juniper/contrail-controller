...
class Load(Generative, MapperOption):
    ...
    of the various loader options that are present in ``sqlalchemy_.orm``,
...
def contains_eager(loadopt, attr, alias=None):
    ...
    string name of an alias, an :func:`~sqlalchemy_.sql.expression.alias`
    construct, or an :func:`~sqlalchemy_.orm.aliased` construct. Use this when
...
def defer(loadopt, key):
    ...
    e.g.::
        ...
        from sqlalchemy_.orm import defer
