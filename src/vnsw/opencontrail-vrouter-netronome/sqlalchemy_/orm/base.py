...
# these can be replaced by sqlalchemy_.ext.instrumentation
...
def object_mapper(instance):
    ...
    Raises :class:`sqlalchemy_.orm.exc.UnmappedInstanceError`
    ...
    :class:`sqlalchemy_.exc.NoInspectionAvailable` if the instance is
...
def class_mapper(class_, configure=True):
    ...
    Using the inspection system will raise
    :class:`sqlalchemy_.exc.NoInspectionAvailable` if the class is not mapped.
