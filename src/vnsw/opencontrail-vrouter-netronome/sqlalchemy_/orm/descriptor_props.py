...
@util.langhelpers.dependency_for("sqlalchemy_.orm.properties")
...
class ComparableProperty(DescriptorProperty):
    ...
    def __init__(
        ...
        .. versionchanged:: 0.7
            ...
            the :mod:`~sqlalchemy_.ext.hybrid` extension.  See the example
        ...
        case-insensitive comparison::
            ...
            from sqlalchemy_.orm import comparable_property
            from sqlalchemy_.orm.interfaces import PropComparator
            from sqlalchemy_.sql import func
            from sqlalchemy_ import Integer, String, Column
