...
class Query(object):
    ...
    def label(self, name):
        ...
        Analogous to :meth:`sqlalchemy_.sql.expression.SelectBase.label`.
    ...
    def as_scalar(self):
        ...
        Analogous to :meth:`sqlalchemy_.sql.expression.SelectBase.as_scalar`.
    ...
    def enable_eagerloads(self, value):
        ...
        eager joins regardless of :func:`~sqlalchemy_.orm.joinedload`,
        :func:`~sqlalchemy_.orm.subqueryload` options
    ...
    def yield_per(self, count):
        ...
        .. warning::
            ...
            :meth:`~sqlalchemy_.orm.query.Query.yield_per`.

            Also note that while
            :meth:`~sqlalchemy_.orm.query.Query.yield_per` will set the
            ``stream_results`` execution option to True, currently
            this is only understood by
            :mod:`~sqlalchemy_.dialects.postgresql.psycopg2` dialect
    ...
    def get(self, ident):
        ...
        If not, :class:`~sqlalchemy_.orm.exc.ObjectDeletedError` is raised.
    ...
    def with_hint(self, selectable, text, dialect_name='*'):
        ...
        :meth:`~sqlalchemy_.sql.expression.Select.with_hint`,
    ...
    def execution_options(self, **kwargs):
        ...
        automatically if the :meth:`~sqlalchemy_.orm.query.Query.yield_per()`
        method is used.
    ...
    def having(self, criterion):
        ...
        if criterion is not None and \
            ...
            raise sa_exc.ArgumentError(
                ...
                "sqlalchemy_.sql.ClauseElement or string")
    ...
    def union_all(self, *q):
        ...
        Works the same way as :meth:`~sqlalchemy_.orm.query.Query.union`. See
    ...
    def join(self, *props, **kwargs):
        ...
        **Joins to a Target with an ON Clause**
        ...
        an alias the second time.  We use :func:`~sqlalchemy_.orm.aliased`
        ...
        **Advanced Join Targeting and Adaption**
        ...
        :meth:`~sqlalchemy_.orm.relationship` -driven ON clause to the target
    ...
    def one_or_none(self):
        ...
        no rows.  Raises ``sqlalchemy_.orm.exc.MultipleResultsFound``
    ...
    def one(self):
        ...
        Raises ``sqlalchemy_.orm.exc.NoResultFound`` if the query selects
        no rows.  Raises ``sqlalchemy_.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a query that returns only scalar values
        as opposed to full identity-mapped entities.
    ...
    def exists(self):
        ...
        as a WHERE, use :func:`.literal`::
            ...
            from sqlalchemy_ import literal
    ...
    def count(self):
        ...
        use :attr:`~sqlalchemy_.sql.expression.func`
        expressions in conjunction
        with :meth:`~.Session.query`, i.e.::

            from sqlalchemy_ import func
            ...
            from sqlalchemy_ import distinct
    ...
    def delete(self, synchronize_session='evaluate'):
        ...
        .. warning:: **Additional Caveats for bulk query deletes**
            ...
            * The method does **not** offer in-Python cascading of
              ...
              :class:`~sqlalchemy_.orm.exc.ObjectDeletedError` is
              raised.
    ...
    def update(self, values, synchronize_session='evaluate', update_args=None):
        ...
        :param values: a dictionary with attributes names, or alternatively
         ...
         this requires that the :paramref:`~sqlalchemy_.sql.expression.update.preserve_parameter_order`
