...
Defines the :class:`~sqlalchemy_.orm.mapper.Mapper` class, the central
configurational unit which associates a class with a database table.

This is a semi-private module; the main configurational API of the ORM is
available in :class:`~sqlalchemy_.orm.`.
...
class Mapper(InspectionAttr):
    ...
    :func:`~sqlalchemy_.orm.mapper` function.    For information
    ...
    :mod:`sqlalchemy_.ext.declarative` extension for class
    configuration, which
    ...
    A class which was mapped by the :mod:`sqlalchemy_.ext.declarative`
    ...
    def __init__(self,
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          looks like::
                ...
                from sqlalchemy_.orm import object_mapper
        ...
        :param version_id_col: A :class:`.Column`
           ...
           version id, a
           :class:`~sqlalchemy_.orm.exc.StaleDataError` exception is
           thrown.
    ...
    def identity_key_from_instance(self, instance):
        ...
        :class:`~sqlalchemy_.orm.exc.ObjectDeletedError` is raised.
