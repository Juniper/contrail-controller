...
@util.langhelpers.dependency_for("sqlalchemy_.orm.interfaces")
class MapperExtension(object):
    ...
    :class:`.MapperExtension` or a list of such::
        ...
        from sqlalchemy_.orm.interfaces import MapperExtension
...
class SessionExtension(object):
    ...
    argument::
        ...
        from sqlalchemy_.orm.interfaces import SessionExtension
...
class AttributeExtension(object):
    ...
    others::
        ...
        from sqlalchemy_.orm.interfaces import AttributeExtension
        from sqlalchemy_.orm import mapper, relationship, column_property
