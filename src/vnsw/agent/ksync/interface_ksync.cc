...
InterfaceKSyncEntry::InterfaceKSyncEntry(InterfaceKSyncObject *obj, 
    ...
    sub_type_(entry->sub_type_), layer3_forwarding_(entry->layer3_forwarding_),
    type_(entry->type_), 
...
InterfaceKSyncEntry::InterfaceKSyncEntry(InterfaceKSyncObject *obj, 
    ...
    ksync_obj_(obj), l2_active_(false), layer2_forwarding_(true),
    mac_(), mirror_direction_(Interface::UNKNOWN), 
