...
TEST_F(FlowTest, MaxFlows_1) {
    ...
    ModifyVnMaxFlows("vn3", 3, 0);
    // Disable max-flows for vn5
    ModifyVnMaxFlows("vn5", 5, 0);
    client->WaitForIdle();
...
TEST_F(FlowTest, MaxFlows_3) {
    ...
    ModifyVnMaxFlows("vn3", 3, 10);
    ModifyVnMaxFlows("vn5", 5, 20);

    client->WaitForIdle();

    // Set max-flows=3 for vmi_0 and vmi_5
    AddMaxFlowsVmi("vmi_3", 9, 3);
    AddMaxFlowsVmi("vmi_0", 6, 3);
    ...
    AddMaxFlowsVmi("vmi_3", 9, 0);
    AddMaxFlowsVmi("vmi_0", 6, 0);
    client->WaitForIdle();
...
TEST_F(FlowTest, MaxFlowsPreference) {
    ...
    // Set flow limit to 5 for each vm on compute
    uint32_t vm_flows = agent_->max_vm_flows();
