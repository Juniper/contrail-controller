...
public:
    ...
    virtual void SetUp() {
        ...
        params->set_bgpaas_shift_bits(4);
        client->WaitForIdle();
        ...
        client->WaitForIdle();
        SendBgpServiceConfig("1.1.1.10", 1000, 1, "vnet1",
                             "vrf1", "bgpaas-client",
                             false);
        SendBgpServiceConfig("2.2.2.20", 1000, 2, "vnet2",
                             "vrf2", "bgpaas-client",
                             false);
        SendBgpServiceConfig("3.3.3.30", 1000, 3, "vnet3",
                             "vrf3", "bgpaas-client",
                             false);
        SendBgpServiceConfig("4.4.4.40", 2000, 4, "vnet4",
                             "vrf4", "bgpaas-client",
                             false);
        SendBgpServiceConfig("5.5.5.50", 2000, 5, "vnet5",
                             "vrf5", "bgpaas-client",
                             false);
        SendBgpServiceConfig("6.6.6.60", 2000, 6, "vnet6",
                             "vrf6", "bgpaas-client",
                             false);
        client->WaitForIdle();
    }
