...
TEST_F(FlowTraceFilterTest, Enable_Default_1) {
    ...
    EXPECT_TRUE(filter_v4_->src_addr_ == Ip4Address::from_string("0.0.0.0"));
    EXPECT_TRUE(filter_v4_->src_mask_ == Ip4Address::from_string("0.0.0.0"));
    EXPECT_TRUE(filter_v4_->dst_addr_ == Ip4Address::from_string("0.0.0.0"));
    EXPECT_TRUE(filter_v4_->dst_mask_ == Ip4Address::from_string("0.0.0.0"));
    ...
    EXPECT_TRUE(filter_v6_->src_addr_ == Ip6Address::from_string("::0"));
    EXPECT_TRUE(filter_v6_->src_mask_ == Ip6Address::from_string("::0"));
    EXPECT_TRUE(filter_v6_->dst_addr_ == Ip6Address::from_string("::0"));
    EXPECT_TRUE(filter_v6_->dst_mask_ == Ip6Address::from_string("::0"));
...
TEST_F(FlowTraceFilterTest, Enable_2) {
    filter_v4_->SetFilter(true, Address::INET, "1.1.1.10", 32, "1.1.1.1", 24,
                          6, 6, 0, 1000, 0, 2000);
    EXPECT_TRUE(filter_v4_->enabled_);
    EXPECT_TRUE(filter_v4_->src_addr_ == Ip4Address::from_string("1.1.1.10"));
    EXPECT_TRUE(filter_v4_->src_mask_ ==
                Ip4Address::from_string("255.255.255.255"));
    EXPECT_TRUE(filter_v4_->dst_addr_ == Ip4Address::from_string("1.1.1.0"));
    EXPECT_TRUE(filter_v4_->dst_mask_ ==
                Ip4Address::from_string("255.255.255.0"));
