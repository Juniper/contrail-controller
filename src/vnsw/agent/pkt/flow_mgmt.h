...
private:
    ...
    void UpdateFlowStats(FlowEntryPtr &flow, uint32_t bytes, uint32_t packets,
                         uint32_t oflow_bytes, uint32_t mir_bytes, uint32_t mir_packets, uint32_t mir_oflow_bytes, uint32_t sec_mir_bytes, uint32_t sec_mir_packets,
                         uint32_t sec_mir_oflow_bytes, const boost::uuids::uuid &u);
