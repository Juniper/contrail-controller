...
const std::map<uint16_t, const char*>
    FlowEntry::FlowDropReasonStr = boost::assign::map_list_of
        ...
        ((uint16_t)DROP_OUT_FWAAS_POLICY, "Flow drop OUT FWAAS Policy")
        ((uint16_t)DROP_REVERSE_FWAAS_POLICY,     "Flow drop REVERSE FWAAS Policy")
        ((uint16_t)DROP_REVERSE_OUT_FWAAS_POLICY, "Flow drop REVERSE OUT FWAAS Policy");
