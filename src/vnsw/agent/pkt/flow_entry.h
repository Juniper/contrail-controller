...
struct MatchPolicy {
    ...
    MatchAclParamsList m_aps_l;
    uint32_t aps_action;
    uint32_t rev_aps_action;

    MatchAclParamsList m_out_aps_l;
    uint32_t out_aps_action;
    uint32_t rev_out_aps_action;

    // Summary of SG actions
    uint32_t sg_action_summary;
    uint32_t aps_action_summary;
