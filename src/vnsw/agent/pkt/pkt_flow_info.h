...
public:
    ...
    PktFlowInfo(Agent *a, boost::shared_ptr<PktInfo> info, FlowTable *ftable) :
        ...
        bgp_router_service_src_port_fd(kBgpRouterServiceInvalidFd),
    ...
    void BgpRouterServiceFromVm(const PktInfo *pkt, PktControlInfo *in,
                                PktControlInfo *out);
    void BgpRouterServiceFromFabric(const PktInfo *pkt, PktControlInfo *in,
                                    PktControlInfo *out);
...
public:
    ...
    bool                 bgp_router_service_src_port_fd;
    bool                 bgp_router_service_bind_local_port;
};
