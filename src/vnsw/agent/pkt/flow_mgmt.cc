...
bool InetRouteFlowMgmtTree::OperEntryAdd(const FlowMgmtRequest *req,
    ...
    if (rt_key->plen_ > 0) {
        ...
        if (covering_route != NULL) {
            ret = UpdateCoveringRoute(covering_route, rt_key);
        }
        rt_key->plen_ += 1;
    }
...
bool InetRouteFlowMgmtTree::UpdateCoveringRoute(InetRouteFlowMgmtKey *covering_route,
    ...
    return entry->UpdateCoveringRouteOperEntry(mgr_, covering_route, key);
}

bool InetRouteFlowMgmtEntry::UpdateCoveringRouteOperEntry
