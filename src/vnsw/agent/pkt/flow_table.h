...
private:
    ...
    boost::scoped_ptr<WorkQueue<boost::shared_ptr<FlowDeleteReq> > > delete_queue_;
    ...
    bool FlowDelete(boost::shared_ptr<FlowDeleteReq> req);
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(FlowDeleteReq);
};
