...
def collect_vrouter_node_logs(data):
    ...
    for item in data['provider_config']['vrouter']:
        ...
        port = 8085
        print('Collecting vrouter-agent logs for node : %s' %host)
...
def collect_control_node_logs(data):
    ...
    for item in data['provider_config']['control']:
        ...
        print('Collecting controller logs for control node : %s' %host)
...
def main():
    ...
    try:
        ...
        pass
    try:
        if yaml_data['provider_config']['controller']:
