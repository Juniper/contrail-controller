...
int main(int argc, char *argv[]) {
    ...
    Sandesh::set_slo_logger_appender(var_map["log_file"].as<std::string>(),
                                     var_map["log_file_size"].as<long>(),
                                     var_map["log_files_count"].as<int>(),
                                     var_map["syslog_facility"].as<std::string>(),
                                     slo_destn,
    ...
    Sandesh::set_sample_logger_appender(var_map["log_file"].as<std::string>(),
                                     var_map["log_file_size"].as<long>(),
                                     var_map["log_files_count"].as<int>(),
                                     var_map["syslog_facility"].as<std::string>(),
                                     sample_destn,
    ...
    Sandesh::set_send_2_collector_flags(sample_destn, slo_destn);
