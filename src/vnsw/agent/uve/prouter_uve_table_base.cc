...
void ProuterUveTableBase::ProuterUveEntry::AddLogicalInterface
...
bool ProuterUveTableBase::ProuterUveEntry::DeleteLogicalInterface
                                           (const LogicalInterface *itf) {
    bool deleted = false;
    LogicalInterfaceSet::iterator it = logical_interface_set_.find(itf);
    if (it != logical_interface_set_.end()) {
...
ProuterUveTableBase::ProuterUveEntry *
ProuterUveTableBase::PDEntryToProuterUveEntry(const PhysicalDevice *p) const {
...
void ProuterUveTableBase::FillLogicalInterfaceList
...
void ProuterUveTableBase::SendProuterMsgFromPhyInterface(const Interface *pi) {
...
ProuterUveTableBase::ProuterUveEntry* ProuterUveTableBase::AddHandler
...
void ProuterUveTableBase::DeleteHandler(const PhysicalDevice *p) {
...
void ProuterUveTableBase::AddProuterLogicalInterface
...
void ProuterUveTableBase::DeleteProuterLogicalInterface
    (const PhysicalDevice *p, const LogicalInterface *intf) {
    UveProuterMap::iterator it = uve_prouter_map_.find(p->uuid());
    if (it == uve_prouter_map_.end()) {
        return;
