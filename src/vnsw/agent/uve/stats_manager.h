...
class StatsManager {
 public:
    ...
    void EnqueueEvent(const FlowAceStatsRequest &req);
 ...
 private:
    ...
    void AddFlow(const boost::shared_ptr<FlowAceStatsRequest> &req);
    void DeleteFlow(const boost::shared_ptr<FlowAceStatsRequest> &req);
