...
TEST_F(UveVrouterUveTest, FlowSetupRate) {
    ...
    EXPECT_EQ(3U, stats.get_max_flows_added_per_second());
    EXPECT_EQ(3U, stats.get_min_flows_added_per_second());
    ...
    /* Max and Min expected flows are 2 because, value of 1 is carried forward
     * from previous flow creation time */
    EXPECT_EQ(2U, stats.get_max_flows_added_per_second());
    EXPECT_EQ(2U, stats.get_min_flows_added_per_second());
    ...
    EXPECT_EQ(1U, stats3.get_max_flows_deleted_per_second());
    EXPECT_EQ(1U, stats3.get_min_flows_deleted_per_second());
