...
public:
    ...
    const std::string& huge_page_flow_file() const {
        return huge_page_flow_file_;
    }
    const std::string& huge_page_bridge_file() const {
        return huge_page_bridge_file_;
    }
...
private:
    ...
    std::string huge_page_flow_file_;
    std::string huge_page_bridge_file_;
