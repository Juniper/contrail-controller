...
public:
    ...
    bool resource_mgr_enable () const { return resource_mgr_enable_; }
    ...
    void set_resource_mgr_enable(bool flag) {resource_mgr_enable_ = flag;} 
private:
    bool create_vhost_;
    bool ksync_enable_;
    ...
    std::auto_ptr<ResourceMgrFactory> resource_mgr_factory_;
