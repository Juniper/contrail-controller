...
void AgentParam::ComputeVrWatermark() {
    if (vr_object_high_watermark_ > 100) {
        cout << "Max is 100 updating vrouter objects high watermark to default : 80%\n";
        vr_object_high_watermark_ = 80;
    }
    if (vr_object_high_watermark_ < 0) {
        cout << "Wrong config updating vrouter objects high watermark to default : 80%\n";
        vr_object_high_watermark_ = 80;
    }
}
