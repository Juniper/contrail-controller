...
protected:
    ...
    virtual void SetUp() {
        ...
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-test-setup.xml");
    ...
    virtual void TearDown() {
        ...
        OvsdbTestSetSessionContext(tcp_session_);
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-test-teardown.xml");
        client->WaitForIdle();
    }
...
TEST_F(HaStaleRouteTest, ToRRouteAddDelonBackupToRAgent) {
    ...
    if (entry != NULL) {
        ...
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-add-tor-route.xml");
        client->WaitForIdle();
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-del-tor-route.xml");
        client->WaitForIdle();
...
TEST_F(HaStaleRouteTest, HaStaleRouteDeleteOnVxLanIdChange) {
    ...
    if (entry != NULL) {
        ...
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-vxlan-id-change.xml");
        client->WaitForIdle();
        if (rt_table != NULL) {
            MacAddress mac("00:00:00:00:01:01");
            Ip4Address default_ip;
        ...
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-vxlan-id-revert.xml");
        client->WaitForIdle();
...
TEST_F(HaStaleRouteTest, HaStaleRouteDeleteToRIPChange) {
    ...
    if (entry != NULL) {
        ...
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-tor-ip-change.xml");
        client->WaitForIdle();
        if (rt_table != NULL) {
            MacAddress mac("00:00:00:00:01:01");
            Ip4Address default_ip;
        ...
        LoadAndRun("controller/src/vnsw/agent/ovs_tor_agent/ovsdb_"
                   "client/test/xml/ha-stale-tor-ip-revert.xml");
        client->WaitForIdle();
