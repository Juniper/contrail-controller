...
void TorAgentParam::AddOptions() {
    ...
    tor.add_options()
        ...
        ("TOR.tor_local_mac_cleanup_interval",
         boost_po::value<int>()->default_value(-1),
         "Local MAC cleanup interval in milli seconds");
...
void TorAgentParam::InitFromConfig() {
    ...
    GetValueFromTree<int>(tor_info_.local_mac_cleanup_interval_,
                          "TOR.tor_local_mac_cleanup_interval");
}
...
void TorAgentParam::InitFromArguments() {
    ...
    GetOptValue<int>(vars, tor_info_.keepalive_interval_,
                     "TOR.tor_keepalive_interval");
    GetOptValue<int>(vars, tor_info_.local_mac_cleanup_interval_,
                     "TOR.tor_local_mac_cleanup_interval");
}
