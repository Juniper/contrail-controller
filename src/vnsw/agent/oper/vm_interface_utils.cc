...
bool VmInterface::ExcludeFromFatFlow(Address::Family family,
    ...
    if (family == Address::INET) {
        ...
        if (IsIp4SubnetMember(ll_subnet, sip.to_v4(),
                              agent()->v4_link_local_plen())) {
            return true;
        }
        if (IsIp4SubnetMember(ll_subnet, dip.to_v4(),
                              agent()->v4_link_local_plen())) {
            return true;
        }
        ...
        if (IsIp6SubnetMember(ll6_subnet, sip.to_v6(),
                              agent()->v6_link_local_plen())) {
            return true;
        }
        if (IsIp6SubnetMember(ll6_subnet, dip.to_v6(),
                              agent()->v6_link_local_plen())) {
            return true;
        }
    }
