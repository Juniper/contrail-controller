...
public:
    ...
    VrfAssign(Type type, Interface *interface_)
        : type_(type), interface_(interface_), vrf_(NULL, this) { };
    virtual ~VrfAssign() { };
...
public:
    VlanVrfAssign(Interface *interface_, uint16_t vlan_tag):
        VrfAssign(VLAN, interface_), vlan_tag_(vlan_tag), nh_(NULL) {}
