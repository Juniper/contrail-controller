...
void ServiceInstance::StartNetworkNamespace() {
    ...
    /*
     * TODO(safchain) check there is something in cmd
     */

    cmd_str << cmd;
    cmd_str << " start ";
    cmd_str << " --service_instance_id " << uuid_;
    cmd_str << " --instance_id " << instance_id_;
    cmd_str << " --vmi_inside " << vmi_inside_;
    cmd_str << " --vmi_outside " << vmi_outside_;
...
void ServiceInstance::RestartNetworkNamespace() {
 ...
 */
ServiceInstanceData::StrTypeToIntMap ServiceInstanceData::service_type_map_ = InitServiceTypeMap();
ServiceInstanceData::StrTypeToIntMap ServiceInstanceData::virtualization_type_map_ = InitVirtualizationTypeMap();
