...
public:
    ...
    bool IpamAssociated() const;
    bool ipam_associated() const {return ipam_associated_;}
    void set_ipam_associated(bool ipam_associated) {
        ipam_associated_ = ipam_associated;}
