...
class NamespaceTaskFdTest : public ::testing::Test {
public:
    virtual void SetUp() {
        ...
        task_ = new NamespaceTask(cmd_str.str(), 1, &evm);
    }
...
TEST_F(NamespaceTaskFdTest, TestCloseTaskFds) {
    task_pid = StartTask();
