...
void IFMapDependencyManager::Initialize(Agent *agent) {
    ...
    ReactionMap react_si = map_list_of<string, PropagateList>
            ("service-instance-service-template", list_of("self").convert_to_container<PropagateList>())
            ("virtual-machine-service-instance", list_of("self").convert_to_container<PropagateList>())
    ...
    ReactionMap react_vm = map_list_of<string, PropagateList>
            ("self", list_of("virtual-machine-service-instance").convert_to_container<PropagateList>())
            ("virtual-machine-virtual-machine-interface",
             list_of("virtual-machine-service-instance").convert_to_container<PropagateList>())
    ...
    ReactionMap react_vmi = map_list_of<string, PropagateList>
            ("self", list_of("virtual-machine-interface-virtual-machine")
                            ("logical-interface-virtual-machine-interface").convert_to_container<PropagateList>())
            ("instance-ip-virtual-machine-interface",
             list_of("virtual-machine-interface-virtual-machine").convert_to_container<PropagateList>())
    ...
    ReactionMap react_subnet = map_list_of<string, PropagateList>
            ("self", list_of("virtual-network-network-ipam").convert_to_container<PropagateList>())
            ("virtual-network-network-ipam", list_of("nil").convert_to_container<PropagateList>());
