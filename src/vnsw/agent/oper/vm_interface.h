...
public:
    ...
    VmInterface(const boost::uuids::uuid &uuid) :
        ...
        parent_(NULL), config_dhcp_options_(), sg_list_(), floating_ip_list_(),
    ...
    VmInterface(const boost::uuids::uuid &uuid, const std::string &name,
        ...
        vlan_id_(vlan_id), parent_(parent), config_dhcp_options_(), sg_list_(),
    ...
    const ConfigDhcpOptions &config_dhcp_options() const { return config_dhcp_options_; }
...
struct VmInterfaceConfigData : public VmInterfaceData {
    VmInterfaceConfigData() :
        ...
        config_dhcp_options_(), mirror_direction_(Interface::UNKNOWN), sg_list_(), 
        floating_ip_list_(), service_vlan_list_(), static_route_list_() {
    }
