...
public:
    ...
    void set_nat_src_ip(const IpAddress &src_ip);

    IpAddress nat_dst_ip();
    void set_nat_dst_ip(const IpAddress &dst_ip);
...
private:
    ...
    static const Ip4Address kZeroIp4;
    ...
    IpAddress nat_src_ip_;
    IpAddress nat_dst_ip_;
    bool active_;
