...
void 
Inet4UnicastAgentRouteTable::AddRemoteVmRoute(const Peer *peer, 
                                              const string &vm_vrf,
...
Inet4UnicastAgentRouteTable::AddRemoteVmRoute(const Peer *peer, 
                                     ...
                                     const string &dest_vn_name, 
                                     bool local_ecmp_nh) {
    CompositeNH::CreateCompositeNH(vm_vrf, vm_addr, 
                                   local_ecmp_nh, comp_nh_list);
