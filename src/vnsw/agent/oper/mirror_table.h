...
public:
    ...
    typedef std::map<std::string , MirrorEntryList> UnresolvedEntryList;
    typedef std::pair<std::string , MirrorEntryList> UnresolvedEntry;
...
private:
    ...
    UnresolvedEntryList unresolved_entry_list_;
