...
public:
    ...
    void DelLocalVmRoute(const Peer *peer, const std::string &vrf_name,
                         ...
                         const Ip6Address &old_v6_addr, uint32_t ethernet_tag);
...
public:
    ...
    EvpnPeer *evpn_peer() {return evpn_peer_ref_.get();}
    EvpnPeer::EvpnPeerRef evpn_peer_ref() {return evpn_peer_ref_;}
    void CreateEvpnPeer();
