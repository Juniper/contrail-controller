...
public:
    MulticastGroupObject(const std::string &vrf_name, 
        ...
        evpn_mpls_label_(0), vxlan_id_(0), bridge_forwarding_(true),
    ...
    void SetBridgeForwarding(bool enable) {bridge_forwarding_ = enable;};
    bool CanUnsubscribe() const {return (deleted_ || !bridge_forwarding_);}
