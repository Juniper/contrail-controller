...
bool VrfEntry::DeleteTimeout() {
    ...
    num_routes = rt_table_db_[Agent::INET4_UNICAST]->Size() +
                rt_table_db_[Agent::INET4_MPLS]->Size() +
                rt_table_db_[Agent::INET4_MULTICAST]->Size() +
                rt_table_db_[Agent::EVPN]->Size() +
                rt_table_db_[Agent::BRIDGE]->Size() +
                rt_table_db_[Agent::INET6_UNICAST]->Size();
    if (num_routes) {
