...
public:
    ...
    void GlobalCfgChangeWalkDone(DBTable::DBTableWalkRef walker,
                                 DBTableBase *tbl);
    uint32_t ResyncNotificationSeqNo() {return resync_notification_seqno_;}
...
private:
    ...
    uint32_t resync_notification_seqno_;
};
