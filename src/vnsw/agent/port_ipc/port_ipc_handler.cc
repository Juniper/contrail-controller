...
// Utility methods
/////////////////////////////////////////////////////////////////////////////
static bool GetStringMember(const RAPIDJSON_NAMESPACE::Value &d, const char *member,
...
static bool GetUint32Member(const RAPIDJSON_NAMESPACE::Value &d, const char *member,
...
static bool GetUuidMember(const RAPIDJSON_NAMESPACE::Value &d, const char *member,
...
bool PortIpcHandler::AddPortArrayFromJson(const RAPIDJSON_NAMESPACE::Value &d,
                                          const string &json,
                                          VmiSubscribeEntryPtrList &req_list,
                                          bool check_port,
                                          string &err_msg) {
    for (size_t i = 0; i < d.Size(); i++) {
        const RAPIDJSON_NAMESPACE::Value& elem = d[i];
...
(const RAPIDJSON_NAMESPACE::Value &d, const std::string &json, bool check_port,
...
bool PortIpcHandler::AddVmiUuidEntry(PortSubscribeEntryPtr entry_ref,
                                     const RAPIDJSON_NAMESPACE::Value &d,
...
bool PortIpcHandler::WriteJsonToFile(const RAPIDJSON_NAMESPACE::Value &v,
...
void PortIpcHandler::AddMember(const char *key, const char *value,
        RAPIDJSON_NAMESPACE::Document *doc) const {
    RAPIDJSON_NAMESPACE::Document::AllocatorType &a = doc->GetAllocator();
    RAPIDJSON_NAMESPACE::Value v;
    RAPIDJSON_NAMESPACE::Value vk;
...
(const RAPIDJSON_NAMESPACE::Value &d, VirtualGatewayConfig::Subnet *entry) const {
...
(const RAPIDJSON_NAMESPACE::Value &d, VirtualGatewayConfig::SubnetList *list) const {
    for (size_t i = 0; i < d.Size(); i++) {
        const RAPIDJSON_NAMESPACE::Value& elem = d[i];
        if (!elem.IsObject()) {
            return false;
...
bool PortIpcHandler::HasAllGatewayFields(const RAPIDJSON_NAMESPACE::Value &d,
...
bool PortIpcHandler::BuildGateway(const RAPIDJSON_NAMESPACE::Value &d,
