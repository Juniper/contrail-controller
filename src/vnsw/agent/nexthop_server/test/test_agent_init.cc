...
#define VNSW_NEXTHOP_SERVER_CONFIG_FILE "controller/src/vnsw/agent/nexthop_server/test/vnswa_cfg.ini"
...
int main(int argc, char **argv) {
    GETUSERARGS();
    client = TestInit(VNSW_NEXTHOP_SERVER_CONFIG_FILE, ksync_init);
