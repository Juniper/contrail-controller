...
RouteKState::RouteKState(KRouteResp *obj, const std::string &resp_ctx,
                         vr_route_req &req, int id, int family_id, sandesh_op::type op_code, int marker_size) :
                         KState(resp_ctx, obj), family_id_(family_id), op_code_(op_code), prefix_(marker_size, 0) {
