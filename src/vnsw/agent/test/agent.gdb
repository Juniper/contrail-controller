...
define vrf_entry_format
    ...
    printf "%p    %-20s    idx=%-4d    ref_count=%-4d   flags=%-4d rt_db=%p mcrt_db=%p bridge_db=%p v6_rt_db=%p\n", $__vrf,\
           ...
           $__vrf->rt_table_db_[Agent::BRIDGE], $__vrf->rt_table_db_[Agent::INET6_UNICAST],
end
