...
TEST_F(Test, walk_all_routes_wih_no_vrf) {
    ...
    SetupEnvironment(0);
    walker()->StartVrfWalk();
    VerifyNotifications(13, 2, 1, (Agent::ROUTE_TABLE_MAX - 1) * 2);
...
TEST_F(Test, walk_all_routes_with_2_vrf) {
    ...
    SetupEnvironment(2);
    walker()->StartVrfWalk();
    VerifyNotifications(43, 4, 1, ((Agent::ROUTE_TABLE_MAX - 1) * 4));
    EXPECT_TRUE(walker()->walk_task_context_mismatch_ == false);
    walker()->walk_task_context_mismatch_ = true;
    DeleteEnvironment(2);
}
...
TEST_F(Test, walk_all_routes_with_3_vrf) {
    ...
    SetupEnvironment(3);
    walker()->StartVrfWalk();
    VerifyNotifications(58, 5, 1, ((Agent::ROUTE_TABLE_MAX - 1) * 5));
    EXPECT_TRUE(walker()->walk_task_context_mismatch_ == false);
    walker()->walk_task_context_mismatch_ = true;
    DeleteEnvironment(3);
}
