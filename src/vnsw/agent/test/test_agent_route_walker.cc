...
TEST_F(AgentRouteWalkerTest, walk_all_routes_wih_no_vrf) {
    ...
    SetupEnvironment(0);
    StartVrfWalk();
    VerifyNotifications(10, 2, 1, (Agent::ROUTE_TABLE_MAX - 1) * 2);
...
TEST_F(AgentRouteWalkerTest, walk_all_routes_wih_1_vrf) {
    ...
    SetupEnvironment(1);
    StartVrfWalk();
    VerifyNotifications(23, 3, 1, ((Agent::ROUTE_TABLE_MAX - 1) * 3));
    EXPECT_TRUE(walk_task_context_mismatch_ == false);
    walk_task_context_mismatch_ = true;
    DeleteEnvironment(1);
}
...
TEST_F(AgentRouteWalkerTest, walk_all_routes_with_2_vrf) {
    ...
    SetupEnvironment(2);
    StartVrfWalk();
    VerifyNotifications(36, 4, 1, ((Agent::ROUTE_TABLE_MAX - 1) * 4));
    EXPECT_TRUE(walk_task_context_mismatch_ == false);
    walk_task_context_mismatch_ = true;
    DeleteEnvironment(2);
}
...
TEST_F(AgentRouteWalkerTest, walk_all_routes_with_3_vrf) {
    ...
    SetupEnvironment(3);
    StartVrfWalk();
    VerifyNotifications(49, 5, 1, ((Agent::ROUTE_TABLE_MAX - 1) * 5));
    EXPECT_TRUE(walk_task_context_mismatch_ == false);
    walk_task_context_mismatch_ = true;
    DeleteEnvironment(3);
}
