...
private:
    ...
    bool FindSloMatchRule(const SessionSloRuleMap &map,
                          const std::string &match_uuid);
    bool MatchSloForSession(const SessionStatsInfo &stats_info, const FlowEntry *fe,
                            const std::string &match_uuid);
    void BuildSloList(const SessionStatsInfo &stats_info,const FlowEntry *fe,
...
public:
    ...
    bool UpdateSessionSloStateRuleRefCount(const std::string &uuid);
    SessionSloState() {}
    ~SessionSloState() {
