...
FlowExportInfo::FlowExportInfo() :
    ...
    intf_in_(AgentKey::ADD_DEL_CHANGE, nil_uuid(), ""), peer_vrouter_(),
    tunnel_type_(TunnelType::INVALID), underlay_source_port_(0),
    underlay_sport_exported_(false), exported_(false), fip_(0),
...
FlowExportInfo::FlowExportInfo(FlowEntry *fe, uint64_t setup_time) :
    ...
    intf_in_(fe->data().intf_in), peer_vrouter_(fe->peer_vrouter()),
