...
public:
    ...
    uint64_t session_global_slo_logging_drop() const {
        return session_global_slo_logging_drop_;
    }
    uint64_t session_slo_logging_drop() const {
        return session_slo_logging_drop_;
    }
...
private:
    ...
    tbb::atomic<uint64_t> session_global_slo_logging_drop_;
    tbb::atomic<uint64_t> session_slo_logging_drop_;
    Timer* timer_;
