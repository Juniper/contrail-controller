...
public:
    //TODO: can be moved to ksync restore manager?
...
public:
    InterfaceKSyncRestoreData(KSyncDBObject *obj, KInterfaceInfo *intfInfo);
    ~InterfaceKSyncRestoreData();
    virtual const std::string ToString() { return "";}
    KInterfaceInfo *GetIntfEntry() { return intfInfo_;}
private:
    KInterfaceInfo *intfInfo_;
};

class InterfaceKSyncRestoreEndData : public KSyncRestoreData {
public:
    InterfaceKSyncRestoreEndData(KSyncDBObject *obj);
    ~InterfaceKSyncRestoreEndData();
    virtual const std::string ToString() { return 
                    "InterfaceKSyncRestoreEndData";}
};
