        ...
        case HealthCheckTable::UPDATE_SERVICE:
            {
                ...
                if (it != session_map_.end()) {
                    ...
                    /* EnqueueForceDelete will remove old_ptr from DiagTable and
                     * frees it */
...
void SegmentHealthCheckPktStats::HandleRequest() const {
    ...
    const DiagProto::DiagStatsMap &stats = proto->stats();
    DiagProto::DiagStatsMap::const_iterator it = stats.begin();
    while (it != stats.end()) {
