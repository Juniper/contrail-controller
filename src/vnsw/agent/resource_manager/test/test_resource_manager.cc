...
protected:
    ...
    void SandeshReadWriteProcess() {
        ...
        ResourceManager *mgr = agent->resource_manager_factory()->GetResourceManager(
                ResourceManagerFactory::MPLS_TYPE);
        ResourceReq req;
        MplsData *mplsdata = new MplsData(); 
        mplsdata->mpls_label = 11;
        mplsdata->data = "data";
        MplsKey *rkey = new MplsKey();
        rkey->mpls_resource_key = 10;
    ...
    void SandeshReadProcess() {
        ...
        while (it != mplsdata.end()) {
            ...
            std::cout<<"==================="<<"\n";
            std::cout<<"Key"<<key->mpls_resource_key<<"\n";
