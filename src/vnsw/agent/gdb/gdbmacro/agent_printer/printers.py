...
class FlowEntryPrinter:
    ...
    def to_string (self):
        if self.val['stats_']['setup_time'] != self.val['stats_']['last_modified_time']:
            return 'Diff Packets %d Flags %d SetupTime %d ModifiedTime %d' % (self.val['stats_']['packets'], self.val['flags_'], self.val['stats_']['setup_time'], self.val['stats_']['last_modified_time'])
        return 'Packets %d Flags %d SetupTime %d ModifiedTime %d' % (self.val['stats_']['packets'], self.val['flags_'], self.val['stats_']['setup_time'], self.val['stats_']['last_modified_time'])
