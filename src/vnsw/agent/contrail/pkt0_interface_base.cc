...
void Pkt0Socket::CreateMockAgent(const std::string& guid)
{
    sSocketDir = "/tmp/" + guid + sSocketDir ;
    sAgentSocketPath = "/tmp/" + guid + sAgentSocketPath;
    sVrouterSocketPath = "/tmp/" + guid + sVrouterSocketPath;
}
