...
string Pkt0Socket::kAgentSocketPath = "/var/run/vrouter/agent_pkt0";
string Pkt0Socket::kVrouterSocketPath = "/var/run/vrouter/dpdk_pkt0";
...
void Pkt0Socket::MockAgent()
{
    ...
    kSocketDir =  "/tmp/"+ stemp.str()+ Pkt0Socket::kSocketDir ;
    kAgentSocketPath  = "/tmp/"+ stemp.str()+ Pkt0Socket::kAgentSocketPath ;
    kVrouterSocketPath  = "/tmp/"+ stemp.str()+ Pkt0Socket::kVrouterSocketPath ;
}
...
void Pkt0Socket::CreateUnixSocket() {
   ...
   boost::filesystem::create_directories(kSocketDir);
