...
void Pkt0Socket::CreateMockAgent()
{
    ...
    sSocketDir =  "/tmp/" + std::string(getenv("LOGNAME"))+"/"+ pidstr + Pkt0Socket::sSocketDir ;
    sAgentSocketPath  = "/tmp/" + std::string(getenv("LOGNAME"))+"/"+ pidstr + Pkt0Socket::sAgentSocketPath ;
    sVrouterSocketPath  = "/tmp/" + std::string(getenv("LOGNAME"))+"/"+ pidstr + Pkt0Socket::sVrouterSocketPath ;
}
...
void Pkt0Socket::CreateUnixSocket() {
    ...
    //The create_directories does not require for the parent
