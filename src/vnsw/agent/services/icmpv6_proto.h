...
#define IPV6_ALL_ROUTERS_ADDRESS "FF01:0:0:0:0:0:0:2"
#define PKT0_LINKLOCAL_ADDRESS "FE80::5678:9ABC:5678:9ABC"
...
public:
    static const uint32_t kRouterAdvertTimeout = 5000; // milli seconds
