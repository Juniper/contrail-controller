...
void InterfaceIgmpStatsReq::HandleRequest() const {
    ...
    rx_badpacket_stats.igmp_membership_query =
        stats.rx_badpacket[IGMP_MEMBERSHIP_QUERY];
    rx_badpacket_stats.igmp_v1_membership_report =
        stats.rx_badpacket[IGMP_V1_MEMBERSHIP_REPORT];
    ...
    rx_badpacket_stats.igmp_v2_membership_report =
        stats.rx_badpacket[IGMP_V2_MEMBERSHIP_REPORT];
    rx_badpacket_stats.igmp_group_leave = stats.rx_badpacket[IGMP_GROUP_LEAVE];
    rx_badpacket_stats.igmp_mtrace_response =
        stats.rx_badpacket[IGMP_MTRACE_RESPONSE];
    rx_badpacket_stats.igmp_mtrace_request =
        stats.rx_badpacket[IGMP_MTRACE_REQUEST]; rx_badpacket_stats.igmp_dwr =
        stats.rx_badpacket[IGMP_DWR];
    rx_badpacket_stats.igmp_v3_membership_report =
        stats.rx_badpacket[IGMP_V3_MEMBERSHIP_REPORT];
    ...
    rx_okpacket_stats.igmp_membership_query =
        stats.rx_okpacket[IGMP_MEMBERSHIP_QUERY];
    rx_okpacket_stats.igmp_v1_membership_report =
        stats.rx_okpacket[IGMP_V1_MEMBERSHIP_REPORT];
    ...
    rx_okpacket_stats.igmp_v2_membership_report =
        stats.rx_okpacket[IGMP_V2_MEMBERSHIP_REPORT];
    rx_okpacket_stats.igmp_group_leave = stats.rx_okpacket[IGMP_GROUP_LEAVE];
    rx_okpacket_stats.igmp_mtrace_response =
        stats.rx_okpacket[IGMP_MTRACE_RESPONSE];
    rx_okpacket_stats.igmp_mtrace_request =
        stats.rx_okpacket[IGMP_MTRACE_REQUEST]; rx_okpacket_stats.igmp_dwr =
        stats.rx_okpacket[IGMP_DWR]; rx_okpacket_stats.igmp_v3_membership_report
        = stats.rx_okpacket[IGMP_V3_MEMBERSHIP_REPORT];
