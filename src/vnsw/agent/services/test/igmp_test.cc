...
TEST_F(IgmpTest, PrintPackets) {
    ...
    igmp_gs[0].group = inet_addr("239.1.1.10");
    ...
    igmp_gs[0].group = inet_addr("239.1.1.10");
    igmp_gs[0].group = inet_addr("239.1.1.11");
    igmp_gs[0].group = inet_addr("239.1.1.12");
    ...
    igmp_gs[0].sources[0] = inet_addr("100.1.1.10");
    igmp_gs[0].sources[0] = inet_addr("100.1.1.20");
    igmp_gs[0].sources[0] = inet_addr("100.1.1.30");

    igmp_gs[1].group = inet_addr("239.2.1.10");
    igmp_gs[1].record_type = 1;
    igmp_gs[1].source_count = 4;
    igmp_gs[1].sources[0] = inet_addr("100.2.1.10");
    igmp_gs[1].sources[0] = inet_addr("100.2.1.20");
    igmp_gs[1].sources[0] = inet_addr("100.2.1.30");
    igmp_gs[1].sources[0] = inet_addr("100.2.1.40");

    igmp_gs[2].group = inet_addr("239.3.0.10");
    igmp_gs[2].record_type = 1;
    igmp_gs[2].source_count = 5;
    igmp_gs[2].sources[0] = inet_addr("100.3.1.10");
    igmp_gs[2].sources[0] = inet_addr("100.3.1.20");
    igmp_gs[2].sources[0] = inet_addr("100.3.1.30");
    igmp_gs[2].sources[0] = inet_addr("100.3.1.40");
    igmp_gs[2].sources[0] = inet_addr("100.3.1.50");
