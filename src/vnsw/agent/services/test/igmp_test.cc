...
extern uint32_t igmp_sg_add_count;
extern uint32_t igmp_sg_del_count;
extern uint32_t igmp_host_update_count;
...
public:
    ...
    void WaitForSgCount(uint32_t *counter, uint32_t ex_count) {
