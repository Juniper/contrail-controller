        ...
        if (conn) {
            switch(request->GetMethod()) {
                case HTTP_GET: {
                    ...
                    METADATA_TRACE(Trace, "GET for VM : " << vm_ip
                                   << " URL : " << uri);
                    break;
                }
                ...
                case HTTP_POST: {
                    ...
                    boost::bind(&MetadataProxy::HandleMetadataResponse,
                                this, conn, HttpSessionPtr(session), _1, _2));
                    METADATA_TRACE(Trace, "POST for VM : " << vm_ip
                                   << " URL : " << uri);
                    break;
                }
                ...
                case HTTP_PUT: {
                    ...
                    boost::bind(&MetadataProxy::HandleMetadataResponse,
                                this, conn, HttpSessionPtr(session), _1, _2));
                    METADATA_TRACE(Trace, "PUT for VM : " << vm_ip
                                   << " URL : " << uri);
                    break;
                }
                ...
                case HTTP_DELETE: {
                    ...
                    boost::bind(&MetadataProxy::HandleMetadataResponse,
                                this, conn, HttpSessionPtr(session), _1, _2));
                    METADATA_TRACE(Trace, "Delete for VM : " << vm_ip
                                   << " URL : " << uri);
                    break;
                }
