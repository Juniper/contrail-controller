...
void Agent::SetAgentTaskPolicy() {
    ...
    const char *resource_backup_task_exclude_list[] = {
        "timer::TimerTask"
    };

    SetTaskPolicyOne(KAgentResourceBackUpTask, resource_backup_task_exclude_list,
                     sizeof(resource_backup_task_exclude_list) / sizeof(char *));
}
