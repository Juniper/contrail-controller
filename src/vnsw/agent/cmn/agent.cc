...
const uint16_t Agent::kDefaultUnicastStaleTimer = (2 *60);
const uint16_t Agent::kDefaultMulticastStaleTimer = (5 *60);
const uint16_t Agent::kDefaultConfigCleanupTimeout = (15 *60);
