...
#ifdef _WIN32
const std::string Agent::config_file_ = "C:\ProgramData\Contrail\etc\contrail\contrail-vrouter-agent.conf";
const std::string Agent::log_file_ = "C:\ProgramData\Contrail\var\log\contrail\vrouter.log";
#else
