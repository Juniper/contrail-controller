...
public:
    ...
    void set_prev_flow_created(uint64_t ct) { prev_flow_created_ = ct; }
    void set_prev_flow_aged(uint64_t ct) { prev_flow_aged_ = ct; }
    void set_prev_flow_add_time(uint64_t t) { prev_flow_add_time_ = t; }
    void set_prev_flow_delete_time(uint64_t t) { prev_flow_delete_time_ = t; }
