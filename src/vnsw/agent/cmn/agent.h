...
public:
   ...
   void set_service_instance_table(ServiceInstanceTable *table) {
    ...
    ResourceMgrFactory *resource_mgr_factory() const ;
    void set_resource_mgr_factory(ResourceMgrFactory *resource_mgr_factory); 
...
private:
    ...
    ResourceMgrFactory *resource_mgr_factory_;
