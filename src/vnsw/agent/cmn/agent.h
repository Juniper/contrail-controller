...
public:
    ...
    static const uint16_t kDefaultUnicastStaleTimer = (2 * 60);
    static const uint16_t kDefaultMulticastStaleTimer = (5 * 60);
    static const uint16_t kDefaultConfigCleanupTimeout = (15 * 60);
