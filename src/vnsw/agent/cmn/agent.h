...
void intrusive_ptr_add_back_ref(const IntrusiveReferer ref, const VrfEntry* p);
void intrusive_ptr_del_back_ref(const IntrusiveReferer ref, const VrfEntry* p);
