...
void AgentParam::ParseDefaultSection() { 
    ...
    if (optional<unsigned int> log_local_opt =
        tree_.get_optional<unsigned int>("DEFAULT.log_local") &&
        log_local_opt.get()) {
        log_local_ = true;
    } else {
        log_local_ = false;
    ...
    if (optional<unsigned int> debug_opt =
        tree_.get_optional<unsigned int>("DEFAULT.debug") &&
        debug_opt.get()) {
        debug_ = true;
    } else {
        debug_ = false;
    ...
    if (optional<unsigned int> log_flow_opt =
        tree_.get_optional<unsigned int>("DEFAULT.log_flow") &&
        log_flow_opt.get()) {
        log_flow_ = true;
    } else {
        log_flow_ = false;
