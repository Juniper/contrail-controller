...
class NetnsManager(object):
    ...
    def __init__(self, vm_uuid, nic_left, nic_right, other_nics=None,
                 ...
                 custom_attr_cfg_file=None, loadbalancer_id=None):
        ...
        self.update = update
        self.gw_ip = gw_ip
        self.custom_attr_cfg_file = custom_attr_cfg_file
...
class VRouterNetns(object):
    ...
    def _parse_args(self, args_str):
        ...
        create_parser.add_argument(
            ...
            help=("Loadbalancer"))
        create_parser.add_argument(
            "--custom-attr-cfg-file",
            default=None,
            help=("Custom Attributes config file for lbaas"))
    ...
    def create(self):
        ...
        netns_mgr = NetnsManager(netns_name, nic_left, nic_right,
                             ...
                             custom_attr_cfg_file=self.args.custom_attr_cfg_file)
