...
TEST_P(IFMapVmUuidMapperTestWithParam1, ConfigThenSubscribe) {
    ...
    EXPECT_EQ(3U, vm_uuid_mapper_->UuidMapperCount());
    EXPECT_EQ(3U, vm_uuid_mapper_->NodeUuidMapCount());
    ...
    EXPECT_EQ(3U, vm_uuid_mapper_->UuidMapperCount());
    EXPECT_EQ(3U, vm_uuid_mapper_->NodeUuidMapCount());
    EXPECT_EQ(0U, vm_uuid_mapper_->PendingVmRegCount());
    TASK_UTIL_EXPECT_EQ(3U, c1.NodeKeyCount("virtual-machine"));

    TASK_UTIL_EXPECT_EQ(3U, c1.NodeKeyCount("virtual-machine-interface"));
    TASK_UTIL_EXPECT_EQ(1U, c1.NodeKeyCount("virtual-network"));
...
TEST_P(IFMapVmUuidMapperTestWithParam1, VmSubUnsubWithDeletedNode) {
    ...
    server_->ProcessVmSubscribe(
        ...
        "93e76278-1990-4905-a472-8e9188f41b2c", true, 2);
    task_util::WaitForIdle();
    TASK_UTIL_EXPECT_EQ(1U, vm_uuid_mapper_->PendingVmRegCount());
    TASK_UTIL_EXPECT_TRUE(vm_uuid_mapper_->VmNodeExists(
                              "93e76278-1990-4905-a472-8e9188f41b2c"));
    string vr_name;
    TASK_UTIL_EXPECT_TRUE(
    ...
    task_util::WaitForIdle();
    TASK_UTIL_EXPECT_EQ(0U, vm_uuid_mapper_->PendingVmRegCount());
    TASK_UTIL_EXPECT_TRUE(vm_uuid_mapper_->VmNodeExists(
                              "93e76278-1990-4905-a472-8e9188f41b2c"));
...
TEST_F(IFMapVmUuidMapperTest , ShowIFMapNodeToUuidReq) {
    ...
    task_util::WaitForIdle();
    EXPECT_EQ(2U, vm_uuid_mapper_->UuidMapperCount());
    EXPECT_EQ(2U, vm_uuid_mapper_->NodeUuidMapCount());
    EXPECT_EQ(1U, vm_uuid_mapper_->PendingVmRegCount());
...
TEST_F(IFMapVmUuidMapperTest , ShowIFMapPendingVmRegOneShot) {
    ...
    EXPECT_EQ(0U, vm_uuid_mapper_->UuidMapperCount());
    EXPECT_EQ(0U, vm_uuid_mapper_->NodeUuidMapCount());
    EXPECT_EQ(3U, vm_uuid_mapper_->PendingVmRegCount());
...
TEST_P(IFMapVmUuidMapperTestWithParam1, CfgSubUnsub) {
    ...
    TASK_UTIL_EXPECT_EQ(2U, c1.NodeKeyCount("virtual-machine"));

    TASK_UTIL_EXPECT_EQ(1U, c1.NodeKeyCount("virtual-network"));
    TASK_UTIL_EXPECT_EQ(2U, c1.NodeKeyCount("virtual-machine-interface"));

    server_->ProcessVmSubscribe(
        "default-global-system-config:a1s27.contrail.juniper.net",
        "93e76278-1990-4905-a472-8e9188f41b2c", false, 2);
    TASK_UTIL_EXPECT_EQ(1U, c1.NodeKeyCount("virtual-machine"));
    TASK_UTIL_EXPECT_EQ(1U, c1.NodeKeyCount("virtual-network"));
    TASK_UTIL_EXPECT_EQ(1U, c1.NodeKeyCount("virtual-machine-interface"));
    server_->ProcessVmSubscribe(
        "default-global-system-config:a1s27.contrail.juniper.net",
        "43d086ab-52c4-4a1f-8c3d-63b321e36e8a", false, 3);
    task_util::WaitForIdle();
    TASK_UTIL_EXPECT_EQ(0U, c1.NodeKeyCount("virtual-network"));
    TASK_UTIL_EXPECT_EQ(0U, c1.NodeKeyCount("virtual-machine"));
    TASK_UTIL_EXPECT_EQ(0U, c1.NodeKeyCount("virtual-machine-interface"));
    EXPECT_EQ(3U, vm_uuid_mapper_->UuidMapperCount());
    EXPECT_EQ(3U, vm_uuid_mapper_->NodeUuidMapCount());
}
...
TEST_P(IFMapVmUuidMapperTestWithParam2, SubCfgaddCfgdelUnsub) {
    ...
    EXPECT_EQ(0U, vm_uuid_mapper_->UuidMapperCount());
    EXPECT_EQ(0U, vm_uuid_mapper_->NodeUuidMapCount());
    TASK_UTIL_EXPECT_EQ(3U, vm_uuid_mapper_->PendingVmRegCount());
    ...
    TASK_UTIL_EXPECT_EQ(3U, vm_uuid_mapper_->UuidMapperCount());
    TASK_UTIL_EXPECT_EQ(3U, vm_uuid_mapper_->NodeUuidMapCount());
    TASK_UTIL_EXPECT_EQ(0U, vm_uuid_mapper_->PendingVmRegCount());
    c1.PrintNodes();
    c1.PrintLinks();
    ...
    TASK_UTIL_EXPECT_EQ(0U, vm_uuid_mapper_->UuidMapperCount());
    TASK_UTIL_EXPECT_EQ(0U, vm_uuid_mapper_->NodeUuidMapCount());
    TASK_UTIL_EXPECT_EQ(0U, vm_uuid_mapper_->PendingVmRegCount());
}
