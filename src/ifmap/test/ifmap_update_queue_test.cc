...
TEST_F(IFMapUpdateQueueTest, Basic) {
    ...
    EXPECT_EQ(u1->get_sequence(), 2);
    EXPECT_EQ(u2->get_sequence(), 3);
    EXPECT_EQ(u3->get_sequence(), 4);
    EXPECT_EQ(u4->get_sequence(), 5);
    ...
    marker = queue_->GetMarker(1);
    EXPECT_EQ(marker->get_sequence(), 3);
    EXPECT_EQ(queue_->tail_marker()->get_sequence(), 1);
    rem_bs.Reset(rem_bs);
    ...
    marker = queue_->GetMarker(2);
    EXPECT_EQ(marker->get_sequence(), 4);
    EXPECT_EQ(queue_->tail_marker()->get_sequence(), 1);
    rem_bs.Reset(rem_bs);
    ASSERT_TRUE(rem_bs.empty());
    ...
    marker = queue_->GetMarker(3);
    EXPECT_EQ(marker->get_sequence(), 5);
    rem_bs.Reset(rem_bs);
    ASSERT_TRUE(rem_bs.empty());
    ...
    EXPECT_EQ(queue_->tail_marker()->get_sequence(), 6);
    ...
    ASSERT_TRUE(rem_bs.empty());
    marker = queue_->GetMarker(1);
    EXPECT_EQ(marker->get_sequence(), 6);
    marker = queue_->GetMarker(2);
    EXPECT_EQ(marker->get_sequence(), 6);
    marker = queue_->GetMarker(3);
    EXPECT_EQ(marker->get_sequence(), 6);
...
TEST_F(IFMapUpdateQueueTest, MarkerMerge) {
    ...
    EXPECT_EQ(marker->get_sequence(), 3);
    marker = queue_->GetMarker(2);
    EXPECT_EQ(marker->get_sequence(), 4); // should get the next higher value
    rem_bs.Reset(rem_bs);
    ASSERT_TRUE(rem_bs.empty());
    ...
    EXPECT_EQ(marker->get_sequence(), 4);
    EXPECT_EQ(queue_->GetMarker(2)->get_sequence(), 4);
...
TEST_F(IFMapUpdateQueueTest, MoveMarkerBefore) {
    ...
    marker = queue_->GetMarker(1);
    EXPECT_EQ(marker->get_sequence(), 1);
