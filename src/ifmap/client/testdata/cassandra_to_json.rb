...
# LOG_DISABLE=1 CONFIG_JSON_PARSER_TEST_DATA_FILE=/cs-shared/ananth/db_dumps/att_contrail_db.json CONFIG_JSON_PARSER_TEST_INTROSPECT=5910 controller/src/ifmap/client/testdata/cassandra_to_json.rb
# LOG_DISABLE=1 CONFIG_JSON_PARSER_TEST_DATA_FILE=/cs-shared/ananth/db_dumps/sb_tb1_10.87.28.249.json CONFIG_JSON_PARSER_TEST_INTROSPECT=5910 controller/src/ifmap/client/testdata/cassandra_to_json.rb
# LOG_DISABLE=1 CONFIG_JSON_PARSER_TEST_DATA_FILE=/cs-shared/ananth/db_dumps/workday.json CONFIG_JSON_PARSER_TEST_INTROSPECT=5910 controller/src/ifmap/client/testdata/cassandra_to_json.rb
