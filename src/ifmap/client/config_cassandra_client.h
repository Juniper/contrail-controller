...
protected:
    ...
    virtual bool ReadUuidTableRow(const vector<string> &bulk_read_list);
...
private:
    ...
    bool BunchReadReq(int worker_id, UUIDProcessList &req_list, bool list_empty,
                      int &num_req_handled);
