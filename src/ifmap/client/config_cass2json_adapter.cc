...
ConfigCass2JsonAdapter::ConfigCass2JsonAdapter(const CassDataVec &cdvec)
...
bool ConfigCass2JsonAdapter::AddOneEntry(const CassDataVec &cdvec, int i) {
...
bool ConfigCass2JsonAdapter::CreateJsonString(const CassDataVec &cdvec) {
