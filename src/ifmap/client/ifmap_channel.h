...
public:
    ...
    void set_start_stale_cleanup(bool value) {
        start_stale_cleanup_ = value;
    }
    bool start_stale_cleanup() { return start_stale_cleanup_; }
...
private:
    ...
    tbb::atomic<bool> start_stale_cleanup_;
