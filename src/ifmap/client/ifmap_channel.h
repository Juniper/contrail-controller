...
private:
    ...
    tbb::atomic<uint64_t> sequence_number_;
    tbb::atomic<uint64_t> recv_msg_cnt_;
    tbb::atomic<uint64_t> sent_msg_cnt_;
    tbb::atomic<uint64_t> stale_timer_cnt_;
    tbb::atomic<uint64_t> stale_timer_updt_cnt_;
    tbb::atomic<uint64_t> eor_timer_cnt_;
    tbb::atomic<uint64_t> eor_timer_updt_cnt_;
    tbb::atomic<uint64_t> reconnect_attempts_;
