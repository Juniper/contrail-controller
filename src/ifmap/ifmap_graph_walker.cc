    ...
    traversal_white_list_->include_vertex = map_list_of<std::string, std::set<std::string> >
        ("virtual-router",
         list_of("physical-router-virtual-router")
                ...
                ("virtual-router-virtual-machine-interface").convert_to_container<std::set<std::string> >())
        ("virtual-router-network-ipam", list_of("virtual-router-network-ipam").convert_to_container<std::set<std::string> >())
        ("virtual-machine",
         list_of("virtual-machine-service-instance")
                ("virtual-machine-interface-virtual-machine")
                ("virtual-machine-tag").convert_to_container<std::set<std::string> >())
        ("control-node-zone", std::set<std::string>())
        ("bgp-router",
         list_of("instance-bgp-router")
                ("physical-router-bgp-router")
                ("bgp-router-control-node-zone").convert_to_container<std::set<std::string> >())
        ("bgp-as-a-service",
         list_of("bgpaas-bgp-router")
                ("bgpaas-health-check")
                ("bgpaas-control-node-zone").convert_to_container<std::set<std::string> >())
        ("bgpaas-control-node-zone", list_of("bgpaas-control-node-zone").convert_to_container<std::set<std::string> >())
        ("global-system-config",
         list_of("global-system-config-global-vrouter-config")
                ...
                ("qos-config-global-system-config").convert_to_container<std::set<std::string> >())
        ("provider-attachment", std::set<std::string>())
        ("service-instance", list_of("service-instance-service-template")
                                    ("service-instance-port-tuple").convert_to_container<std::set<std::string> >())
        ("global-vrouter-config",
          list_of("application-policy-set-global-vrouter-config")
                 ("global-vrouter-config-security-logging-object").convert_to_container<std::set<std::string> >())
        ("virtual-machine-interface",
         list_of("virtual-machine-virtual-machine-interface")
                ...
                ("virtual-machine-interface-bgp-router").convert_to_container<std::set<std::string> >())
        ("virtual-machine-interface-bridge-domain",
         list_of("virtual-machine-interface-bridge-domain").convert_to_container<std::set<std::string> >())
        ("security-group", list_of("security-group-access-control-list").convert_to_container<std::set<std::string> >())
        ("physical-router",
         list_of("physical-router-physical-interface")
         ("physical-router-logical-interface")
         ("physical-router-virtual-network").convert_to_container<std::set<std::string> >())
        ("service-template", list_of("domain-service-template").convert_to_container<std::set<std::string> >())
        ("instance-ip", list_of("instance-ip-virtual-network").convert_to_container<std::set<std::string> >())
        ("virtual-network",
         ...
         ("virtual-network-multicast-policy").convert_to_container<std::set<std::string> >())
        ("floating-ip", list_of("floating-ip-pool-floating-ip")
         ("instance-ip-floating-ip").convert_to_container<std::set<std::string> >())
        ("alias-ip", list_of("alias-ip-pool-alias-ip").convert_to_container<std::set<std::string> >())
        ("customer-attachment", std::set<std::string>())
        ("virtual-machine-interface-routing-instance",
         list_of("virtual-machine-interface-routing-instance").convert_to_container<std::set<std::string> >())
        ("physical-interface", list_of("physical-interface-logical-interface")
                                      ("virtual-port-group-physical-interface").convert_to_container<std::set<std::string> >())
        ("virtual-port-group-physical-interface",
         list_of("virtual-port-group-physical-interface").convert_to_container<std::set<std::string> >())
        ("virtual-port-group",
         list_of("virtual-port-group-virtual-machine-interface")
                ("virtual-port-group-physical-interface").convert_to_container<std::set<std::string> >())
        ("domain", list_of("domain-namespace")("domain-virtual-DNS").convert_to_container<std::set<std::string> >())
        ("floating-ip-pool", list_of("virtual-network-floating-ip-pool").convert_to_container<std::set<std::string> >())
        ("alias-ip-pool", list_of("virtual-network-alias-ip-pool").convert_to_container<std::set<std::string> >())
        ("logical-interface", list_of("logical-interface-virtual-machine-interface").convert_to_container<std::set<std::string> >())
        ("logical-router-virtual-network", list_of("logical-router-virtual-network").convert_to_container<std::set<std::string> >())
        ("logical-router", list_of("logical-router-virtual-network")
                                  ("logical-router-interface").convert_to_container<std::set<std::string> >())
        ("virtual-network-network-ipam", list_of("virtual-network-network-ipam").convert_to_container<std::set<std::string> >())
        ("access-control-list", std::set<std::string>())
        ("routing-instance", std::set<std::string>())
        ("namespace", std::set<std::string>())
        ("virtual-DNS", list_of("virtual-DNS-virtual-DNS-record").convert_to_container<std::set<std::string> >())
        ("network-ipam", list_of("network-ipam-virtual-DNS").convert_to_container<std::set<std::string> >())
        ...
        ("forwarding-class", list_of("forwarding-class-qos-queue").convert_to_container<std::set<std::string> >())
        ("global-qos-config",
         list_of("global-qos-config-forwarding-class")
         ("global-qos-config-qos-queue")
         ("global-qos-config-qos-config").convert_to_container<std::set<std::string> >())
        ...
        ("security-logging-object",
         list_of("virtual-network-security-logging-object")
                ...
                ("security-logging-object-security-group").convert_to_container<std::set<std::string> >())
        ("tag", list_of("application-policy-set-tag").convert_to_container<std::set<std::string> >())
        ("application-policy-set", list_of("application-policy-set-firewall-policy")
                                          ("policy-management-application-policy-set").convert_to_container<std::set<std::string> >())
        ("application-policy-set-firewall-policy",
                                   list_of("application-policy-set-firewall-policy").convert_to_container<std::set<std::string> >())
        ("firewall-policy", list_of("firewall-policy-firewall-rule")
                                   ("firewall-policy-security-logging-object").convert_to_container<std::set<std::string> >())
        ("firewall-policy-firewall-rule",
                            list_of("firewall-policy-firewall-rule").convert_to_container<std::set<std::string> >())
        ("firewall-policy-security-logging-object",
                            list_of("firewall-policy-security-logging-object").convert_to_container<std::set<std::string> >())
        ("firewall-rule", list_of("firewall-rule-tag")
                                 ("firewall-rule-service-group")
                                 ("firewall-rule-address-group")
                                 ("firewall-rule-security-logging-object").convert_to_container<std::set<std::string> >())
        ("firewall-rule-security-logging-object",
                            list_of("firewall-rule-security-logging-object").convert_to_container<std::set<std::string> >())
        ("service-group", std::set<std::string>())
        ("address-group", list_of("address-group-tag").convert_to_container<std::set<std::string> >())
        ("project", list_of("project-tag")
                           ("project-logical-router").convert_to_container<std::set<std::string> >())
        ("port-tuple", list_of("service-instance-port-tuple")
                              ("port-tuple-interface").convert_to_container<std::set<std::string> >())
        ("policy-management", std::set<std::string>())
        ("multicast-policy", list_of("virtual-network-multicast-policy").convert_to_container<std::set<std::string> >()).convert_to_container<VertexEdgeMap>();
}
