...
import (
	...
	cc "github.com/Juniper/contrail-controller/src/go/pkg/command"
	vc "github.com/Juniper/contrail-controller/src/go/pkg/vcenter"
)
...
func getContrailCommandData(inputJSON jobManagerInput) cc.ContrailCommand {
...
func createContrailCommandNodes(ccData cc.ContrailCommand, hosts []vc.EsxiHost) {
