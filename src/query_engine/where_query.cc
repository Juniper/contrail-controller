...
bool QueryColumn2CassColumn(const std::string& name, std::string *cass_name) {
        ...
        for (contrail_rapidjson::SizeType j = 0; j < json_or_node.Size(); j++)
        {
            ...
            if (m_query->is_session_query(m_query->table())) {
                                ...
                                SessionRecordFields::SESSION_SPORT])
                {
                    ...
                    std::string columnN;
                    if (!QueryColumn2CassColumn(name, &columnN)) {
        ...
        if (isSession) {
            ...
            }
            {
                ...
                if ((direction_ing == 0 && dip_match) ||
                    ...
                    std::string columnN;
                    if (!QueryColumn2CassColumn("ip", &columnN)) {
                        QE_INVALIDARG_ERROR(0);
                    }
                ...
                if ((direction_ing == 0 && dvn_match) ||
                    ...
                    std::string columnN;
                    if (!QueryColumn2CassColumn("vn", &columnN)) {
                        QE_INVALIDARG_ERROR(0);
                    }
                ...
                if ((direction_ing == 0 && svn_match) ||
                    ...
                    std::string columnN;
                    if (!QueryColumn2CassColumn("remote_vn", &columnN)) {
                        QE_INVALIDARG_ERROR(0);
                    }
