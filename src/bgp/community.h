...
public:
    ...
    static bool is_origin_vn(const ExtCommunityValue &val) {
        ...
        //
        return (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_EXPERIMENTAL) &&
               (val[1] == BGP_EXTENDED_COMMUNITY_EXPERIMENTAL_ORIGIN_VN);
    }
    ...
    static bool is_default_gateway(const ExtCommunityValue &val) {
        ...
        //
        return (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_OPAQUE) &&
               (val[1] == BGP_EXTENDED_COMMUNITY_OPAQUE_DEFAULT_GATEWAY);
    }
    ...
    static bool is_es_import(const ExtCommunityValue &val) {
        ...
        //
        return (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_EVPN) &&
               (val[1] == BGP_EXTENDED_COMMUNITY_EVPN_ES_IMPORT);
    }
    ...
    static bool is_esi_label(const ExtCommunityValue &val) {
        ...
        //
        return (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_EVPN) &&
               (val[1] == BGP_EXTENDED_COMMUNITY_EVPN_ESI_MPLS_LABEL);
    }
    ...
    static bool is_mac_mobility(const ExtCommunityValue &val) {
        ...
        //
        return (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_EVPN) &&
               (val[1] == BGP_EXTENDED_COMMUNITY_EVPN_MAC_MOBILITY);
    }
    ...
    static bool is_route_target(const ExtCommunityValue &val) {
        ...
        //
        return ((val[0] == BGP_EXTENDED_COMMUNITY_TYPE_TWO_OCTET_AS ||
                (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_FOUR_OCTET_AS) ||
                (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_IPV4_ADDRESS)) &&
                (val[1] == BGP_EXTENDED_COMMUNITY_SUBTYPE_ROUTE_TARGET));
    }
    ...
    static bool is_security_group(const ExtCommunityValue &val) {
        ...
        //
        return (val[0] == BGP_EXTENDED_COMMUNITY_TYPE_EXPERIMENTAL) &&
               (val[1] == BGP_EXTENDED_COMMUNITY_EXPERIMENTAL_SG_ID);
    }
