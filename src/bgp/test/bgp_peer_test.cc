...
public:
    ...
    virtual bool IsStartingUp() const { return starting_up_; }
...
TEST_P(BgpPeerParamTest, SendEndOfRib) {
    ...
    if (time(NULL) - rtarget_table_last_updated_ <
...
INSTANTIATE_TEST_CASE_P(BgpPeerTestWithParams, BgpPeerParamTest,
    testing::Combine(::testing::Values(
            0,
            BgpGlobalSystemConfig::kEndOfRibTime * 0.10/2,
            BgpGlobalSystemConfig::kEndOfRibTime * 0.10,
        ...
        ::testing::Values(
            time(NULL),
            time(NULL) - 0.10 * BgpGlobalSystemConfig::kEndOfRibTime,
            time(NULL) - 0.50 * BgpGlobalSystemConfig::kEndOfRibTime,
            time(NULL) - 1.00 * BgpGlobalSystemConfig::kEndOfRibTime
        ),
        ::testing::Bool()));
