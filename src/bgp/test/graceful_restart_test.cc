...
protected:
    ...
    bool AttemptGRHelperMode(BgpPeerTest *peer, bool notification, int code,
                             int subcode) const;
...
bool GracefulRestartTest::AttemptGRHelperMode(BgpPeerTest *peer,
                                              bool notification, int code,
                                              int subcode) const {
    if (code == BgpProto::Notification::Cease &&
            subcode == BgpProto::Notification::AdminShutdown)
        return true;
    return peer->AttemptGRHelperModeDefault(notification, code, subcode);
}
