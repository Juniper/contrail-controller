...
public:
    ...
    bool non_graceful() const { return non_graceful_; }
    void set_non_graceful(bool non_graceful) { non_graceful_ = non_graceful; }
...
public:
    virtual void SetUp() {
        ...
        peer_close_->set_non_graceful(std::tr1::get<5>(GetParam()));
    }
    ...
    void TriggerEvent() {
        ...
        case PeerCloseManagerTest::CLOSE:
            close_manager_->Close(peer_close_->non_graceful());
            break;
