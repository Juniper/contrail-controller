...
protected:
    ...
    void Configure(as4_t cn1_asn, as4_t cn2_asn, as4_t mx_asn,
                   as4_t cn1_local_asn = 0, as4_t cn2_local_asn = 0,
                   as4_t mx_local_asn = 0) {
        if (cn1_local_asn == 0)
    ...
    void UpdateASN(as4_t cn1_asn, as4_t cn2_asn, as4_t mx_asn,
                   as4_t cn1_local_asn = 0, as4_t cn2_local_asn = 0,
                   as4_t mx_local_asn = 0) {
        if (cn1_local_asn == 0)
            cn1_local_asn = cn1_asn;
    ...
    void UpdateIdentifier(as4_t cn1_asn, as4_t cn2_asn, as4_t mx_asn,
        as4_t cn1_local_asn, as4_t cn2_local_asn, as4_t mx_local_asn) {
        char config[4096];
...
TEST_F(BgpXmppRTargetTest, HTTPIntrospect1) {
    ...
    vector<string> cn2_result = list_of("target:1:1001")("target:1:1002")
        ...
        ("target:64496:4")("target:64496:5")("target:192.168.0.1:0")
...
TEST_F(BgpXmppRTargetTest, ASNUpdate) {
    ...
    TASK_UTIL_EXPECT_EQ(6, RTargetRouteCount(cn1_.get()));
    TASK_UTIL_EXPECT_EQ(6, RTargetRouteCount(cn2_.get()));
    TASK_UTIL_EXPECT_EQ(6, RTargetRouteCount(mx_.get()));
