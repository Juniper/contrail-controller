...
static bool connected_rt_is_inetvpn;
...
protected:
    ...
    ServiceChainTest()
        : bgp_server_(new BgpServer(&evm_)),
          ...
          connected_rt_is_inetvpn_(connected_rt_is_inetvpn) {
    ...
    virtual void SetUp() {
        ...
        inet_service_chain_mgr_ = bgp_server_->service_chain_mgr(family_);
...
TYPED_TEST(ServiceChainTest, Basic) {
    ...
    // Add More specific
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100);

    // Check for aggregated route
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.1.0", 24));
    ...
    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red");

    // Delete More specific
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
...
TYPED_TEST(ServiceChainTest, IgnoreNonInetServiceChainAdd1) {
    vector<string> instance_names = list_of("blue")("blue-i1")("red-i2")("red");
    multimap<string, string> connections =
        map_list_of("blue", "blue-i1") ("red-i2", "red");
    this->NetworkConfig(instance_names, connections);
    ...
    // Add More specifics
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.2.1", 32), 100);

    // Check for aggregated routes
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.2.0", 24));

    // Add Connected
    this->AddConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.4.5"));

    // this->Verify that service chain is on pending list.
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red");
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.2.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.2.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red");

    // Delete More specifics
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.2.1", 32));

    // Delete connected route
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}

TYPED_TEST(ServiceChainTest, IgnoreNonInetServiceChainAdd2) {
    vector<string> instance_names = list_of("blue")("blue-i1")("red-i2")("red");
    multimap<string, string> connections =
        map_list_of("blue", "blue-i1") ("red-i2", "red");
    this->NetworkConfig(instance_names, connections);
...
TYPED_TEST(ServiceChainTest, IgnoreNonInetSubnets) {
    vector<string> instance_names = list_of("blue")("blue-i1")("red-i2")("red");
    multimap<string, string> connections =
        map_list_of("blue", "blue-i1") ("red-i2", "red");
    this->NetworkConfig(instance_names, connections);
...
TYPED_TEST(ServiceChainTest, MoreSpecificAddDelete) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.34", 32), 100);

    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));

    // Add different more specific
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.2.34", 32), 100);

    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));

    // Delete More specific & connected
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.2.34", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.34", 32));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
TYPED_TEST(ServiceChainTest, ServiceChainWithExistingRouteEntries) {
    ...
    // Add More specific & connected
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.2", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.3", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.4", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.2.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.2.2", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.2.3", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.2.4", 32), 100);
    this->AddConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.4.5"));
    ...
    // Delete More specific & connected
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.2", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.3", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.4", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.2.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.2.2", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.2.3", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.2.4", 32));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
TYPED_TEST(ServiceChainTest, UpdateNexthop) {
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("3.4.5.6"), "red");
...
TYPED_TEST(ServiceChainTest, UpdateLabel) {
    ...
    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red", 16);
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red", 32);
...
TYPED_TEST(ServiceChainTest, UpdateChain) {
    ...
    // Add More specific
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.169.2.1", 32), 100);
    ...
    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.169.2.0", 24));
    ...
    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.0.0", 16));
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.169.2.0", 24));
    ...
    // Delete More specific & connected
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.169.2.1", 32));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
TYPED_TEST(ServiceChainTest, PeerUpdate) {
    ...
    // Check for aggregated route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.0.5"), "red");

    this->AddConnectedRoute(this->peers_[1], this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.1.5"));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.1.5"), "red");
    ...
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.2.5"), "red");
...
// 5. this->Verify aggregate route exists and has only one path
// 6. this->Verify ext connected route exists and has only one path
// 7. Remove one of the connected routes
// 8. this->Verify aggregate route exists and still has one path
// 9. this->Verify ext connected route exists and still has one path
//
TYPED_TEST(ServiceChainTest, DuplicateForwardingPaths) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24), 100);
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red");

    // Delete connected route from this->peers_[0]
    this->DeleteConnectedRoute(this->peers_[0], this->BuildPrefix("1.1.2.3", 32));
    ...
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24));
...
TYPED_TEST(ServiceChainTest, EcmpPaths) {
    ...
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), path_ids, "red");
...
TYPED_TEST(ServiceChainTest, EcmpPathDelete) {
    ...
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.3.5"), "red");
...
// 6. this->Verify aggregate route exists and has only two paths
// 7. this->Verify ext connected route exists and has only two paths
//
TYPED_TEST(ServiceChainTest, EcmpWithDuplicateForwardingPaths) {
    ...
    // Check for ExtConnect route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), path_ids, "red");

    // Delete connected routes from this->peers_[0] and this->peers_[2]
    this->DeleteConnectedRoute(this->peers_[0], this->BuildPrefix("1.1.2.3", 32));
    this->DeleteConnectedRoute(this->peers_[2], this->BuildPrefix("1.1.2.3", 32));
...
// 4. this->Verify that ext connect route 192.168.1.0/24 is not added
...
TYPED_TEST(ServiceChainTest, IgnoreAggregateRoute) {
    ...
    // Add MX leaked route
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.0", 24), 100);
    ...
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.0", 24));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
// 2. Add connected route
// 3. Add MX leaked route 192.168.1.0/24
// 4. this->Verify that ext connect route 192.168.1.0/24 is added
//
...
// 4. this->Verify that ext connect route 10.1.1.0/24 is added
// 5. Remove connected route
// 6. this->Verify that ext connect route is removed
...
TYPED_TEST(ServiceChainTest, ExtConnectRoute) {
    ...
    // Check for ExtConnect route
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("10.1.1.0", 24));
...
// 8. this->Verify that ext connect route 10.1.1.0/24 is added
//
TYPED_TEST(ServiceChainTest, ExtConnectRouteNoAdvertiseCommunity) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24), 100, commlist);
...
// 8. this->Verify that aggregate route 192.168.1.0/24 is added
// 7. this->Verify that ext connect route 10.1.1.0/24 is added
// 8. this->Verify that non-OriginVn route 20.1.1.0/24 is not added
//
TYPED_TEST(ServiceChainTest, ExtConnectRouteOriginVnOnly) {
    ...
    this->AddInetRoute(NULL, "green", this->BuildPrefix("20.1.1.0", 24), 100);
    ...
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("20.1.1.0", 24));

    // Delete ExtRoute, More specific, non-OriginVn and connected route
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24));
    this->DeleteInetRoute(NULL, "green", this->BuildPrefix("20.1.1.0", 24));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
TYPED_TEST(ServiceChainTest, ExtConnectRouteOriginVnUnresolved1) {
    ...
    this->AddInetVpnRoute(NULL, instances, this->BuildPrefix("10.1.1.0", 24), 100);

    // this->Verify that MX leaked route is present in red
    this->VerifyInetRouteExists("red", this->BuildPrefix("10.1.1.0", 24));

    // this->Verify that ExtConnect route is present in blue
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red");

    // Delete ExtRoute and connected route
    this->DeleteInetVpnRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
// 2. Add connected route
// 3. Add MX leaked route 10.1.1.0/24 with unresolved OriginVn
// 4. this->Verify that ext connect route 10.1.1.0/24 is not added
//
TYPED_TEST(ServiceChainTest, ExtConnectRouteOriginVnUnresolved2) {
    ...
    // this->Verify that ExtConnect route is not present in blue
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("10.1.1.0", 24));

    // Delete ExtRoute and connected route
    this->DeleteInetVpnRoute(NULL, "green", this->BuildPrefix("10.1.1.0", 24));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
// 4. this->Verify that Aggregate route 192.168.1.0/24 is added 
//    this->Verify that ext connect route 192.168.0.0/16 is added
//
TYPED_TEST(ServiceChainTest, ExtConnectRouteCoveringSubnetPrefix) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.0.0", 16), 100);

    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100);

    // Check for ExtConnect route
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.0.0", 16));
    // Check for Aggregate route
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.1.0", 24));
    ...
    // Check for ExtConnect route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.0.0", 16));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.0.0", 16), this->BuildNextHopAddress("2.3.4.5"), "red");
    ...
    // Delete ExtRoute, More specific and connected route
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.0.0", 16));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
// 3. Add VM route and connected route
// 4. this->Verify that Aggregate route is added with connected route nexthop
//    this->Verify that MX added ext connect route is treated as more specific itself
//
TYPED_TEST(ServiceChainTest, ExtConnectRouteWithinSubnetPrefix) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.252", 30), 100);

    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100);

    // Check for ExtConnect route
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.1.252", 30));
    ...
    // Delete ExtRoute, More specific and connected route
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.252", 30));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
// 5. this->Verify aggregate route(192.168.1.0/24) & ExtConnect route 192.168.1.252/30
...
// 7. this->Verify ext connect route 192.168.1.252/30 and 192.168.1.1/32 is added and
...
// 10. this->Verify 10.1.1.1/32 is added as ext connect route
//     this->Verify 192.168.0.0/16 is added as ext connect route
//     this->Verify 192.168.1.0/24 is added as aggregate route
//     this->Verify 192.168.1.1/32 is removed as ext connecting route
//     this->Verify 192.168.1.250/30 is removed as ext connecting route
//
TYPED_TEST(ServiceChainTest, ExtConnectRouteServiceChainUpdate) {
    ...
    // Check for ExtConnect route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.252", 30));
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.1", 32));
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.1", 32), 100);
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.1", 32));
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.0.0", 16)),
    ...
    // Check for removal of ExtConnect route it is now more specific
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.1.1", 32));

    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.252", 30));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.0.0", 16));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.1.1", 32));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
TYPED_TEST(ServiceChainTest, ExtConnectedEcmpPaths) {
    ...
    // Add MX leaked route 
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.10.1.0", 24), 100);

    // Add Connected
    this->AddConnectedRoute(this->peers_[0], this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.0.5"));

    // Check for external connected route 
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.10.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.10.1.0", 24), this->BuildNextHopAddress("2.3.0.5"), "red");

    // Add Connected
    this->AddConnectedRoute(this->peers_[1], this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.1.5"));
    vector<string> path_ids = list_of(this->BuildNextHopAddress("2.3.0.5"))(this->BuildNextHopAddress("2.3.1.5"));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.10.1.0", 24), path_ids, "red");

    this->DeleteConnectedRoute(this->peers_[1], this->BuildPrefix("1.1.2.3", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.10.1.0", 24), this->BuildNextHopAddress("2.3.0.5"), "red");

    // Delete MX route
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.10.1.0", 24));
...
TYPED_TEST(ServiceChainTest, ExtConnectedMoreSpecificEcmpPaths) {
    ...
    // Check for ExtConnect route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.0.5"), "red");

    // Connected path is infeasible
    this->AddConnectedRoute(this->peers_[0], this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.0.5"),
        BgpPath::AsPathLooped);

    // this->Verify that Aggregate route and ExtConnect route is gone
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.1.0", 24));
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("10.1.1.0", 24));
    ...
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.1.0", 24), this->BuildNextHopAddress("2.3.1.5"), "red");
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.1.5"), "red");
...
TYPED_TEST(ServiceChainTest, ServiceChainRouteSGID) {
    ...
    // Add Ext connect route
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24), 100, vector<uint32_t>(),
        sgid_list_ext);
    ...
    // Add more specific
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.1", 32), 100, vector<uint32_t>(),
        sgid_list_more_specific_1);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.1.2", 32), 100, vector<uint32_t>(),
        sgid_list_more_specific_2);

    // Check for More specific routes leaked in src instance
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.1", 32));
    this->VerifyInetRouteAttributes(
        "blue", this->BuildPrefix("192.168.1.1", 32), this->BuildNextHopAddress("2.3.0.5"), "red", sgid_list_more_specific_1);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.1.2", 32));
    this->VerifyInetRouteAttributes(
...
TYPED_TEST(ServiceChainTest, ValidateTunnelEncapExtRoute) {
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red", encap);
...
TYPED_TEST(ServiceChainTest, ValidateSiteOfOriginExtRoute) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24), 100, soo1);
    ...
    // Check for service chain route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red", soo1);

    // Update Ext connect route
    SiteOfOrigin soo2 = SiteOfOrigin::FromString("soo:65001:200");
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.0", 24), 100, soo2);

    // Check for service chain route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.1.0", 24), this->BuildNextHopAddress("2.3.4.5"), "red", soo2);
...
// 6. this->Verify that service chain route has communities
// 7. Change ext connected route to not have communities
// 8. this->Verify that service chain route doesn't have communities
//
...
TYPED_TEST(ServiceChainTest, DeleteConnectedWithExtConnectRoute) {
    ...
    // Add Ext connect route
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.2", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.1.3", 32), 100);
    ...
    // Check for ExtConnect route
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.1", 32));
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.2", 32));
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.1.3", 32));

    this->DisableServiceChainQ();
    this->AddConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32), 200, this->BuildNextHopAddress("2.3.4.5"));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.1.1", 32));

    this->VerifyInetRouteIsDeleted("red", this->BuildPrefix("10.1.1.1", 32));
    ...
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("10.1.1.1", 32));

    // Delete ExtRoute, More specific and connected route
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.1.2", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.1.3", 32));
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));
}
...
TYPED_TEST(ServiceChainTest, DeleteEntryReuse) {
    ...
    for (vector<string>::iterator it = routes_to_play.begin();
        ...
        this->AddInetRoute(NULL, "red", *it, 100);
    ...
    for (vector<string>::iterator it = routes_to_play.begin();
         it != routes_to_play.end(); it++) {
        this->VerifyInetRouteExists("blue", *it);
    }
    this->DisableServiceChainQ();
    for (vector<string>::iterator it = routes_to_play.begin();
         it != routes_to_play.end(); it++)
        this->DeleteInetRoute(NULL, "red", *it);
    this->DeleteConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32));

    for (vector<string>::iterator it = routes_to_play.begin();
         it != routes_to_play.end(); it++) {
        this->VerifyInetRouteIsDeleted("red", *it);
    }
...
TYPED_TEST(ServiceChainTest, EntryAfterStop) {
    ...
    for (vector<string>::iterator it = routes_to_play.begin();
         it != routes_to_play.end(); it++)
        this->AddInetRoute(NULL, "red", *it, 200);
    this->AddConnectedRoute(NULL, this->BuildPrefix("1.1.2.3", 32), 100, this->BuildNextHopAddress("2.3.4.5"));
...
TYPED_TEST(ServiceChainTest, TransitNetworkRemoteVMRoutes) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.3.101", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.3.102", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.3.103", 32), 100);
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.3.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.3.0", 24), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);

    // Delete more specific routes and connected routes
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.3.101", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.3.102", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.3.103", 32));
...
TYPED_TEST(ServiceChainTest, TransitNetworkLocalVMRoutes) {
    ...
    this->AddInetRoute(NULL, "core", this->BuildPrefix("192.168.2.101", 32), 100);
    this->AddInetRoute(NULL, "core", this->BuildPrefix("192.168.2.102", 32), 100);
    this->AddInetRoute(NULL, "core", this->BuildPrefix("192.168.2.103", 32), 100);
    ...
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.2.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.2.0", 24), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);

    // Delete more specific routes and connected routes
    this->DeleteInetRoute(NULL, "core", this->BuildPrefix("192.168.2.101", 32));
    this->DeleteInetRoute(NULL, "core", this->BuildPrefix("192.168.2.102", 32));
    this->DeleteInetRoute(NULL, "core", this->BuildPrefix("192.168.2.103", 32));
    this->DeleteConnectedRoute(1, NULL, this->BuildPrefix("192.168.1.253", 32));
}
...
TYPED_TEST(ServiceChainTest, TransitNetworkRemoteExtConnectRoute) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.3.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.3.2", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.3.3", 32), 100);
    ...
    vector<string> origin_vn_path = list_of("core-vn")("red-vn");
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.3.1", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.3.1", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.3.2", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.3.2", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.3.3", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.3.3", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);

    // Delete Ext connect routes and connected routes
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.3.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.3.2", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.3.3", 32));
    this->DeleteConnectedRoute(1, NULL, this->BuildPrefix("192.168.1.253", 32));
    this->DeleteConnectedRoute(2, NULL, this->BuildPrefix("192.168.2.253", 32));
}
...
TYPED_TEST(ServiceChainTest, TransitNetworkLocalExtConnectRoute) {
    ...
    this->AddInetRoute(NULL, "core", this->BuildPrefix("10.1.2.1", 32), 100);
    this->AddInetRoute(NULL, "core", this->BuildPrefix("10.1.2.2", 32), 100);
    this->AddInetRoute(NULL, "core", this->BuildPrefix("10.1.2.3", 32), 100);
    ...
    // Check for ExtConnect route in blue
    vector<string> origin_vn_path = list_of("core-vn");
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.2.1", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.2.1", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.2.2", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.2.2", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.2.3", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.2.3", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path);

    // Delete Ext connect routes and connected routes
    this->DeleteInetRoute(NULL, "core", this->BuildPrefix("10.1.2.1", 32));
    this->DeleteInetRoute(NULL, "core", this->BuildPrefix("10.1.2.2", 32));
    this->DeleteInetRoute(NULL, "core", this->BuildPrefix("10.1.2.3", 32));
    this->DeleteConnectedRoute(1, NULL, this->BuildPrefix("192.168.1.253", 32));
}
...
TYPED_TEST(ServiceChainTest, TransitNetworkAddDeleteConnectedRoute1) {
    ...
    // Check for Aggregate route in blue
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("192.168.3.0", 24));

    // Check for ExtConnect routes in blue
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("10.1.3.1", 32));
    this->VerifyInetRouteNoExists("blue", this->BuildPrefix("10.1.3.2", 32));
...
TYPED_TEST(ServiceChainTest, TransitNetworkMultipleNetworks) {
    ...
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.3.101", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("192.168.3.102", 32), 100);
    this->AddInetRoute(NULL, "green", this->BuildPrefix("192.168.4.101", 32), 100);
    this->AddInetRoute(NULL, "green", this->BuildPrefix("192.168.4.102", 32), 100);

    // Add Ext connect routes to red and green
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.3.1", 32), 100);
    this->AddInetRoute(NULL, "red", this->BuildPrefix("10.1.3.2", 32), 100);
    this->AddInetRoute(NULL, "green", this->BuildPrefix("10.1.4.1", 32), 100);
    this->AddInetRoute(NULL, "green", this->BuildPrefix("10.1.4.2", 32), 100);
    ...
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.3.0", 24), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path_red);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("192.168.4.0", 24));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("192.168.4.0", 24), this->BuildHostAddress("20.1.1.1"), "core-vn",
    ...
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.3.2", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path_red);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.4.1", 32));
    this->VerifyInetRouteAttributes( "blue", this->BuildPrefix("10.1.4.1", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path_green);
    this->VerifyInetRouteExists("blue", this->BuildPrefix("10.1.4.2", 32));
    this->VerifyInetRouteAttributes("blue", this->BuildPrefix("10.1.4.2", 32), this->BuildHostAddress("20.1.1.1"), "core-vn",
        origin_vn_path_green);

    // Delete Ext connect routes and connected routes
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.3.101", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("192.168.3.102", 32));
    this->DeleteInetRoute(NULL, "green", this->BuildPrefix("192.168.4.101", 32));
    this->DeleteInetRoute(NULL, "green", this->BuildPrefix("192.168.4.102", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.3.1", 32));
    this->DeleteInetRoute(NULL, "red", this->BuildPrefix("10.1.3.2", 32));
    this->DeleteInetRoute(NULL, "green", this->BuildPrefix("10.1.4.1", 32));
    this->DeleteInetRoute(NULL, "green", this->BuildPrefix("10.1.4.2", 32));
    this->DeleteConnectedRoute(1, NULL, this->BuildPrefix("192.168.1.253", 32));
    this->DeleteConnectedRoute(2, NULL, this->BuildPrefix("192.168.2.253", 32));
...
TYPED_TEST(ServiceChainTest, TransitNetworkOriginVnLoop) {
    ...
    this->VerifyInetRouteExists("core", this->BuildPrefix("192.168.3.0", 24));
    this->VerifyInetRouteAttributes("core", this->BuildPrefix("192.168.3.0", 24), this->BuildHostAddress("20.1.1.2"), "red-vn",
        origin_vn_path);

    // Check for ExtConnect routes in core
    this->VerifyInetRouteExists("core", this->BuildPrefix("10.1.3.1", 32));
    this->VerifyInetRouteAttributes("core", this->BuildPrefix("10.1.3.1", 32), this->BuildHostAddress("20.1.1.2"), "red-vn",
        origin_vn_path);
    this->VerifyInetRouteExists("core", this->BuildPrefix("10.1.3.2", 32));
    this->VerifyInetRouteAttributes("core", this->BuildPrefix("10.1.3.2", 32), this->BuildHostAddress("20.1.1.2"), "red-vn",
        origin_vn_path);
...
static void process_command_line_args(int argc, const char **argv) {
    ...
    desc.add_options()
        ...
        ("address-family", value<string>()->default_value("inet"),
             "set address family (inet/inetvpn)")
    ...
    if (vm.count("address-family")) {
        connected_rt_is_inetvpn =
            (vm["address-family"].as<string>() == "inetvpn");
    }
}
