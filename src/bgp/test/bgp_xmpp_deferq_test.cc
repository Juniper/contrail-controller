...
TEST_F(BgpXmppUnitTest, BasicDelayedInput_3) {
    ...
    sprintf(wait_time_env, "DB_WALKER_WAIT_USECS=%d", 10);
    putenv(wait_time_env);

    char walk_iter_count[80];
    sprintf(walk_iter_count, "DB_ITERATION_TO_YIELD=%d", 1);
    putenv(walk_iter_count);
    ...
    sprintf(wait_time_env, "DB_WALKER_WAIT_USECS=");
    putenv(wait_time_env);
    sprintf(walk_iter_count, "DB_ITERATION_TO_YIELD=");
    putenv(walk_iter_count);
}
