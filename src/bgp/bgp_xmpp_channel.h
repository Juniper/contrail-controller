...
public:
    ...
    struct ChannelStats {
        ChannelStats() { memset(this, 0, sizeof(*this)); }
         tbb::atomic<int64_t> instance_subscribe;
         tbb::atomic<int64_t> instance_unsubscribe;
         tbb::atomic<int64_t> table_subscribe;
         tbb::atomic<int64_t> table_subscribe_complete;
         tbb::atomic<int64_t> table_unsubscribe;
         tbb::atomic<int64_t> table_unsubscribe_complete;
    };
    ...
    struct ErrorStats {
        ...
        uint64_t get_inet6_rx_bad_afi_safi_count() const;
         ...
         tbb::atomic<int64_t> inet6_rx_bad_xml_token_count;
         tbb::atomic<int64_t> inet6_rx_bad_prefix_count;
         tbb::atomic<int64_t> inet6_rx_bad_nexthop_count;
         tbb::atomic<int64_t> inet6_rx_bad_afi_safi_count;
    };
