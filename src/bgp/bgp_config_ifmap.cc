...
bool BgpIfmapGlobalSystemConfig::Update(BgpIfmapConfigManager *manager,
    ...
    if (data_.route_distinguisher_cluster_seed()
	!= (uint32_t)system->route_distinguisher_cluster_seed()) {
      data_.set_route_distinguisher_cluster_seed(system->route_distinguisher_cluster_seed());
      changed |= true;
    }
