...
RibExportPolicy::RibExportPolicy(BgpProto::BgpPeerType type, Encoding encoding,
    as_t as_number, bool as_override, bool llgr, bool as4, int affinity,
...
RibExportPolicy::RibExportPolicy(BgpProto::BgpPeerType type, Encoding encoding,
    as_t as_number, bool as_override, bool llgr, bool as4, IpAddress nexthop,
    int affinity, uint32_t cluster_id,
...
bool RibExportPolicy::operator<(const RibExportPolicy &rhs) const {
    ...
    BOOL_KEY_COMPARE(local_as_number, rhs.local_as_number);
