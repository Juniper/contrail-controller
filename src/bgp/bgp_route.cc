...
static void FillEdgeForwardingInfo(const EdgeForwarding *edge_forwarding,
    ...
    std::vector<EdgeForwardingSpec::Edge *> edge_list =
	edge_forwarding->edge_forwarding().edge_list;
    for (std::vector<EdgeForwardingSpec::Edge *>::const_iterator it =
...
static void FillEdgeDiscoveryInfo(const EdgeDiscovery *edge_discovery,
    ...
    std::vector<EdgeDiscoverySpec::Edge *> edge_list = edge_discovery->edge_discovery().edge_list;
    int idx = 0;
    for (std::vector<EdgeDiscoverySpec::Edge *>::const_iterator it =
	    edge_list.begin();
