...
void MvpnTable::CreateTreeManager() {
...
void MvpnTable::DestroyTreeManager() {
    assert(tree_manager_);
...
McastTreeManager *MvpnTable::GetTreeManager() {
    return tree_manager_;
}

const McastTreeManager *MvpnTable::GetTreeManager() const {
    return tree_manager_;
}
