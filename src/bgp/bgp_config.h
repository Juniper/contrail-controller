...
public:
    ...
    BgpGlobalSystemConfig() :
            ...
            route_distinguisher_cluster_seed_(0) {
    }
    ~BgpGlobalSystemConfig() { }
    ...
    uint32_t route_distinguisher_cluster_seed() const {
      return route_distinguisher_cluster_seed_;
    }
    void set_route_distinguisher_cluster_seed(uint32_t seed) {
      route_distinguisher_cluster_seed_ = seed;
    }
...
private:
    ...
    uint32_t route_distinguisher_cluster_seed_;
