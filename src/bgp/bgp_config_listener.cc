...
void BgpConfigListener::DependencyTrackerInit() {
    ...
    ReactionMap bgp_peering_react = map_list_of<string, PropagateList>
        ("bgp-peering", list_of("self").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap bgp_router_react = map_list_of<string, PropagateList>
        ...
        ("bgp-router-sub-cluster", list_of("self").convert_to_container<PropagateList>())
        ("instance-bgp-router", list_of("bgp-peering").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap connection_react = map_list_of<string, PropagateList>
        ...
        ("connection", list_of("connection").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    policy->insert(make_pair("connection", connection_react));
    
    ReactionMap rt_instance_react = map_list_of<string, PropagateList>
        ("self", list_of("instance-bgp-router").convert_to_container<PropagateList>())
        ("instance-target", list_of("self")("connection").convert_to_container<PropagateList>())
        ("connection", list_of("self").convert_to_container<PropagateList>())
        ("virtual-network-routing-instance", list_of("self").convert_to_container<PropagateList>())
        ("routing-policy-routing-instance", list_of("self").convert_to_container<PropagateList>())
        ("route-aggregate-routing-instance", list_of("self").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap routing_policy_assoc_react = map_list_of<string, PropagateList>
        ("self", list_of("routing-policy-routing-instance").convert_to_container<PropagateList>())
        ("routing-policy-routing-instance",
         list_of("routing-policy-routing-instance").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap routing_policy_react = map_list_of<string, PropagateList>
        ("self", list_of("routing-policy-routing-instance").convert_to_container<PropagateList>())
        ("routing-policy-routing-instance", list_of("self").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap virtual_network_react = map_list_of<string, PropagateList>
        ("self", list_of("virtual-network-routing-instance").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap route_aggregate_react = map_list_of<string, PropagateList>
        ("self", list_of("route-aggregate-routing-instance").convert_to_container<PropagateList>()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
    ...
    ReactionMap global_config_react = map_list_of<string, PropagateList>
        ("self", PropagateList()).convert_to_container<IFMapDependencyTracker::ReactionMap>();
