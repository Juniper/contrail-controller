...
uint32_t BgpPeer::get_rx_keepalive() const {
...
uint32_t BgpPeer::get_tx_keepalive() const {
...
uint32_t BgpPeer::get_rx_notification() const {
...
uint32_t BgpPeer::get_rx_end_of_rib() const {
...
uint32_t BgpPeer::get_tx_end_of_rib() const {
...
uint32_t BgpPeer::get_rx_route_reach() const {
    return peer_stats_->update_stats_[0].reach;
}

uint32_t BgpPeer::get_tx_route_reach() const {
...
uint32_t BgpPeer::get_rx_route_unreach() const {
    return peer_stats_->update_stats_[0].unreach;
}

uint32_t BgpPeer::get_tx_route_unreach() const {
    return peer_stats_->update_stats_[1].unreach;
}

uint32_t BgpPeer::get_rx_route_total() const {
    return peer_stats_->update_stats_[0].reach +
        peer_stats_->update_stats_[0].unreach +
        peer_stats_->update_stats_[0].end_of_rib;
}

uint32_t BgpPeer::get_tx_route_total() const {
    return peer_stats_->update_stats_[1].reach +
...
uint32_t BgpPeer::get_connect_error() const {
    return peer_stats_->error_stats_.connect_error;
}

uint32_t BgpPeer::get_connect_timer_expired() const {
    return peer_stats_->error_stats_.connect_timer;
}

uint32_t BgpPeer::get_hold_timer_expired() const {
    return peer_stats_->error_stats_.hold_timer;
}

uint32_t BgpPeer::get_open_error() const {
    return peer_stats_->error_stats_.open_error;
}

uint32_t BgpPeer::get_update_error() const {
