...
void LoadBalance::LoadBalanceAttribute::encode(
    ...
    item.load_balance_fields.l2_source_address = l2_source_address;
    item.load_balance_fields.l2_destination_address = l2_destination_address;
    item.load_balance_fields.l3_source_address = l3_source_address;
    item.load_balance_fields.l3_destination_address = l3_destination_address;
    item.load_balance_fields.l4_protocol = l4_protocol;
    item.load_balance_fields.l4_source_port = l4_source_port;
    item.load_balance_fields.l4_destination_port = l4_destination_port;
...
LoadBalance::LoadBalance(const autogen::LoadBalanceType &item) {
    ...
    attr.l2_source_address = item.load_balance_fields.l2_source_address;
    attr.l2_destination_address =
        item.load_balance_fields.l2_destination_address;
    attr.l3_source_address = item.load_balance_fields.l3_source_address;
    attr.l3_destination_address =
        item.load_balance_fields.l3_destination_address;
    attr.l4_protocol = item.load_balance_fields.l4_protocol;
    attr.l4_source_port = item.load_balance_fields.l4_source_port;
    attr.l4_destination_port = item.load_balance_fields.l4_destination_port;
