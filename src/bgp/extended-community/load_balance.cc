...
const LoadBalance::LoadBalanceAttribute
    LoadBalance::LoadBalanceAttribute::kLoadBalanceAttributeDefault =
...
const bool LoadBalance::LoadBalanceAttribute::IsDefault() const {
    return *this == kLoadBalanceAttributeDefault;
}
...
const bool LoadBalance::IsDefault() const {
    return ToAttribute() == LoadBalanceAttribute::kLoadBalanceAttributeDefault;
}
