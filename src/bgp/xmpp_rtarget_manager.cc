...
XmppRTargetManager::XmppRTargetManager(BgpXmppChannel *bgp_xmpp_channel) :
...
void XmppRTargetManager::Enqueue(DBRequest *req) const {
...
int XmppRTargetManager::local_autonomous_system() const {
