...
public:
    ...
    void FillShowInfo(ShowRtGroup *info) const;
    void FillShowPeerInfo(ShowRtGroup *info) const;
    void FillShowSummaryInfo(ShowRtGroup *info) const;
...
private:
    ...
    void FillShowInfoCommon(
        ShowRtGroup *info, bool fill_peers, bool fill_routes) const;
