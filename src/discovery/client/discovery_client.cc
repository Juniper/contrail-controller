...
bool DiscoveryServiceClient::ParseDiscoveryServerSslConfig(
                      bool discovery_server_ssl,
                      std::string discovery_server_cert,
                      std::string discovery_server_key,
                      std::string discovery_server_cacert,
                      SslConfig *ssl_cfg) {
    ssl_cfg->enabled = discovery_server_ssl;
    ssl_cfg->cert = discovery_server_cert;
    ssl_cfg->key = discovery_server_key;
    ssl_cfg->cacert = discovery_server_cacert;
