...
class EventManager:
    ...
    def populate_osd_total_stats(self, osdname, osd_stats, prev_osd_latency):
        ...
        res2 = self.populate_osd_latency_stats(osdname,
                                               osd_stats,
                                               prev_osd_latency)
        if res2 is None:
            return False
    ...
    def compute_read_latency(self, arr, line, index, osd_stats,
        ...
        if avgcount != 0:
            # op_flag = 1 indicates subop_r_latency
            if op_flag == 1:
            ...
            # op_flag = 2 indicates op_r_latency
            if op_flag == 2:
                osd_stats.op_r_latency += ((sum_rlatency * 1000) - \
    ...
    def compute_write_latency(self, arr, line, index, osd_stats,
        ...
        # multiplied by 1000 to convert seconds to milliseconds
        if avgcount != 0:
            # op_flag = 1 indicates subop_w_latency
            if op_flag == 1:
            ...
            # op_flag = 2 indicates op_w_latency
            if op_flag == 2:
                osd_stats.op_w_latency += ((sum_wlatency * 1000) - \
